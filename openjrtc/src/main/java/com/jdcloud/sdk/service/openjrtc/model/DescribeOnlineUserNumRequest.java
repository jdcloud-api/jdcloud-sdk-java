 ...
 */
public class DescribeOnlineUserNumRequest extends JdcloudRequest implements java.io.Serializable {
  ...
  endTime：房间使用截止时间 UTC (必填)
    ...
    */
     ...
     * @param pageNumber
     */
    public DescribeOnlineUserNumRequest pageNumber(Integer pageNumber) {
        this.pageNumber = pageNumber;
        return this;
    }
     ...
     * @param pageSize
     */
    public DescribeOnlineUserNumRequest pageSize(Integer pageSize) {
        this.pageSize = pageSize;
        return this;
    }
