 ...
 */
public class DescribeStreamInfosByUserRoomIdRequest extends JdcloudRequest implements java.io.Serializable {
...
- endTime[eq]   用户推流结束时间-UTC时间  startTime,endTime同时指定时生效
     ...
     * @param pageNumber
     */
    public DescribeStreamInfosByUserRoomIdRequest pageNumber(Integer pageNumber) {
        this.pageNumber = pageNumber;
        return this;
    }
     ...
     * @param pageSize
     */
    public DescribeStreamInfosByUserRoomIdRequest pageSize(Integer pageSize) {
        this.pageSize = pageSize;
        return this;
    }
     ...
     * @param userRoomId
     */
    public DescribeStreamInfosByUserRoomIdRequest userRoomId(String userRoomId) {
        this.userRoomId = userRoomId;
        return this;
    }
...
- endTime[eq]   用户推流结束时间-UTC时间  startTime,endTime同时指定时生效
     ...
     * @param appId
     */
    public DescribeStreamInfosByUserRoomIdRequest appId(String appId) {
        this.appId = appId;
        return this;
    }
