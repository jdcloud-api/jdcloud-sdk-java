...
public class RoomUserNumInfos  implements java.io.Serializable {
     ...
     * 分页内容
     */
    private List<UserNumInfoObj> content;
     ...
     * @return
     */
    public List<UserNumInfoObj> getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(List<UserNumInfoObj> content) {
     ...
     * @param content
     */
    public RoomUserNumInfos content(List<UserNumInfoObj> content) {
        this.content = content;
        return this;
    }
     ...
     * @param content
     */
    public void addContent(UserNumInfoObj content) {
