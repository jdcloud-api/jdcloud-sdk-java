 ...
 */
class DescribeStreamRecordsByStreamIdExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/describeStreamRecordsByStreamId/{appId}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeStreamRecordsByStreamIdResponse.class;
    }
}
