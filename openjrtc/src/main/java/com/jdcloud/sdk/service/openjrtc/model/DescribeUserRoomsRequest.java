 ...
 */
public class DescribeUserRoomsRequest extends JdcloudRequest implements java.io.Serializable {
  ...
  - endTime[eq] 按房间注册时间段查询-UTC时间   startTime,endTime同时有值时生效
     ...
     * @param pageNumber
     */
    public DescribeUserRoomsRequest pageNumber(Integer pageNumber) {
        this.pageNumber = pageNumber;
        return this;
    }
     ...
     * @param pageSize
     */
    public DescribeUserRoomsRequest pageSize(Integer pageSize) {
        this.pageSize = pageSize;
        return this;
    }
  ...
  - endTime[eq] 按房间注册时间段查询-UTC时间   startTime,endTime同时有值时生效
     ...
     * @param appId
     */
    public DescribeUserRoomsRequest appId(String appId) {
        this.appId = appId;
        return this;
    }
