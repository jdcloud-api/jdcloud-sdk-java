 ...
 * 查询统计数据并进行汇总加和
 */
public class QueryStatisticsDataGroupSumResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param startTime
     */
    public QueryStatisticsDataGroupSumResult startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public QueryStatisticsDataGroupSumResult endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     * @param domain
     */
    public QueryStatisticsDataGroupSumResult domain(String domain) {
        this.domain = domain;
        return this;
    }
