 ...
 * 查询Url改写配置
 */
public class QueryUrlRuleResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param domain
     */
    public QueryUrlRuleResult domain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @param beforeRegex
     */
    public QueryUrlRuleResult beforeRegex(String beforeRegex) {
        this.beforeRegex = beforeRegex;
        return this;
    }
     ...
     * @param afterRegex
     */
    public QueryUrlRuleResult afterRegex(String afterRegex) {
        this.afterRegex = afterRegex;
        return this;
    }
