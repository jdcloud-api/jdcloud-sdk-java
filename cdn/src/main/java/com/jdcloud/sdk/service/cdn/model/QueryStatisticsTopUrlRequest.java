...
public class QueryStatisticsTopUrlRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param startTime
     */
    public QueryStatisticsTopUrlRequest startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public QueryStatisticsTopUrlRequest endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     * @param domain
     */
    public QueryStatisticsTopUrlRequest domain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @param subDomain
     */
    public QueryStatisticsTopUrlRequest subDomain(String subDomain) {
        this.subDomain = subDomain;
        return this;
    }
     ...
     * @param size
     */
    public QueryStatisticsTopUrlRequest size(Integer size) {
        this.size = size;
        return this;
    }
     ...
     * @param topBy
     */
    public QueryStatisticsTopUrlRequest topBy(String topBy) {
        this.topBy = topBy;
        return this;
    }
