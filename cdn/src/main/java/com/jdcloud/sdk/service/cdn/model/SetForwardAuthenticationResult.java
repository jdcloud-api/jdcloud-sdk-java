 ...
 * 设置转推鉴权信息
 */
public class SetForwardAuthenticationResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param ignoreQueryString
     */
    public SetForwardAuthenticationResult ignoreQueryString(String ignoreQueryString) {
        this.ignoreQueryString = ignoreQueryString;
        return this;
    }
     ...
     * @param pushIpWhiteList
     */
    public SetForwardAuthenticationResult pushIpWhiteList(String pushIpWhiteList) {
        this.pushIpWhiteList = pushIpWhiteList;
        return this;
    }
     ...
     * @param publishNormalTimeout
     */
    public SetForwardAuthenticationResult publishNormalTimeout(Integer publishNormalTimeout) {
        this.publishNormalTimeout = publishNormalTimeout;
        return this;
    }
     ...
     * @param notifyCustomUrl
     */
    public SetForwardAuthenticationResult notifyCustomUrl(String notifyCustomUrl) {
        this.notifyCustomUrl = notifyCustomUrl;
        return this;
    }
     ...
     * @param notifyCustomAuthKey
     */
    public SetForwardAuthenticationResult notifyCustomAuthKey(String notifyCustomAuthKey) {
        this.notifyCustomAuthKey = notifyCustomAuthKey;
        return this;
    }
     ...
     * @param forwardAccessKeyType
     */
    public SetForwardAuthenticationResult forwardAccessKeyType(Integer forwardAccessKeyType) {
        this.forwardAccessKeyType = forwardAccessKeyType;
        return this;
    }
     ...
     * @param forwardPrivateKey
     */
    public SetForwardAuthenticationResult forwardPrivateKey(String forwardPrivateKey) {
        this.forwardPrivateKey = forwardPrivateKey;
        return this;
    }
     ...
     * @param originAccessKeyType
     */
    public SetForwardAuthenticationResult originAccessKeyType(Integer originAccessKeyType) {
        this.originAccessKeyType = originAccessKeyType;
        return this;
    }
     ...
     * @param originPrivateKey
     */
    public SetForwardAuthenticationResult originPrivateKey(String originPrivateKey) {
        this.originPrivateKey = originPrivateKey;
        return this;
    }
