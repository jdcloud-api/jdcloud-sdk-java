 ...
 * 设置回源IP类型
 */
public class ConfigBackSourceIpVersionRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param backSourceIpVersion
     */
    public ConfigBackSourceIpVersionRequest backSourceIpVersion(String backSourceIpVersion) {
        this.backSourceIpVersion = backSourceIpVersion;
        return this;
    }
     ...
     * @param domain
     */
    public ConfigBackSourceIpVersionRequest domain(String domain) {
        this.domain = domain;
        return this;
    }
