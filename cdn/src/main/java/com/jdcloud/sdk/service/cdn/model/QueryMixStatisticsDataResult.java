...
public class QueryMixStatisticsDataResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param startTime
     */
    public QueryMixStatisticsDataResult startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public QueryMixStatisticsDataResult endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     * @param domain
     */
    public QueryMixStatisticsDataResult domain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @param statistics
     */
    public QueryMixStatisticsDataResult statistics(List<StatisticsDataItem> statistics) {
        this.statistics = statistics;
        return this;
    }
