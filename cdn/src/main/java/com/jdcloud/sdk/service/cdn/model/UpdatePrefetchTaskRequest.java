 ...
 * 更新预热任务接口
 */
public class UpdatePrefetchTaskRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param url
     */
    public UpdatePrefetchTaskRequest url(String url) {
        this.url = url;
        return this;
    }
     ...
     * @param region
     */
    public UpdatePrefetchTaskRequest region(String region) {
        this.region = region;
        return this;
    }
     ...
     * @param isp
     */
    public UpdatePrefetchTaskRequest isp(String isp) {
        this.isp = isp;
        return this;
    }
     ...
     * @param copyNum
     */
    public UpdatePrefetchTaskRequest copyNum(Integer copyNum) {
        this.copyNum = copyNum;
        return this;
    }
