 ...
 * 分地域运营商带宽查询接口
 */
public class QueryBandWithAreaRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param startTime
     */
    public QueryBandWithAreaRequest startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public QueryBandWithAreaRequest endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     * @param domain
     */
    public QueryBandWithAreaRequest domain(String domain) {
        this.domain = domain;
        return this;
    }
     ...
     * @param area
     */
    public QueryBandWithAreaRequest area(String area) {
        this.area = area;
        return this;
    }
     ...
     * @param isp
     */
    public QueryBandWithAreaRequest isp(String isp) {
        this.isp = isp;
        return this;
    }
     ...
     * @param period
     */
    public QueryBandWithAreaRequest period(String period) {
        this.period = period;
        return this;
    }
