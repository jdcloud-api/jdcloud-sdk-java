 ...
 * 多path回源配置
 */
public class ConfigBackSourcePathRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param domain
     */
    public ConfigBackSourcePathRequest domain(String domain) {
        this.domain = domain;
        return this;
    }
