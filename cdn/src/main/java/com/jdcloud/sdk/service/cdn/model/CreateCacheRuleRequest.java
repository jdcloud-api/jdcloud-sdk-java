 ...
 * 添加缓存规则
 */
public class CreateCacheRuleRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param weight
     */
    public CreateCacheRuleRequest weight(Integer weight) {
        this.weight = weight;
        return this;
    }
     ...
     * @param ttl
     */
    public CreateCacheRuleRequest ttl(Long ttl) {
        this.ttl = ttl;
        return this;
    }
     ...
     * @param contents
     */
    public CreateCacheRuleRequest contents(String contents) {
        this.contents = contents;
        return this;
    }
     ...
     * @param cacheType
     */
    public CreateCacheRuleRequest cacheType(Integer cacheType) {
        this.cacheType = cacheType;
        return this;
    }
     ...
     * @param domain
     */
    public CreateCacheRuleRequest domain(String domain) {
        this.domain = domain;
        return this;
    }
