 ...
 */
public class QueryDefaultHttpHeaderKeyResult extends JdcloudResult implements java.io.Serializable {
    ...
    /**
     * add item to reqDefaultHttpHeaderKey
     *
     * @param reqDefaultHttpHeaderKey
     */
    public void addReqDefaultHttpHeaderKey(String reqDefaultHttpHeaderKey) {
        if (this.reqDefaultHttpHeaderKey == null) {
            this.reqDefaultHttpHeaderKey = new ArrayList<>();
        }
        this.reqDefaultHttpHeaderKey.add(reqDefaultHttpHeaderKey);
    }

    /**
     * add item to respDefaultHttpHeaderKey
     *
     * @param respDefaultHttpHeaderKey
     */
    public void addRespDefaultHttpHeaderKey(String respDefaultHttpHeaderKey) {
