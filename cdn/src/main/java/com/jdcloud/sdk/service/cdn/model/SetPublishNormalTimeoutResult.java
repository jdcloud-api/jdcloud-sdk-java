 ...
 * 设置推流中断超时时间
 */
public class SetPublishNormalTimeoutResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param ignoreQueryString
     */
    public SetPublishNormalTimeoutResult ignoreQueryString(String ignoreQueryString) {
        this.ignoreQueryString = ignoreQueryString;
        return this;
    }
     ...
     * @param pushIpWhiteList
     */
    public SetPublishNormalTimeoutResult pushIpWhiteList(String pushIpWhiteList) {
        this.pushIpWhiteList = pushIpWhiteList;
        return this;
    }
     ...
     * @param publishNormalTimeout
     */
    public SetPublishNormalTimeoutResult publishNormalTimeout(Integer publishNormalTimeout) {
        this.publishNormalTimeout = publishNormalTimeout;
        return this;
    }
     ...
     * @param notifyCustomUrl
     */
    public SetPublishNormalTimeoutResult notifyCustomUrl(String notifyCustomUrl) {
        this.notifyCustomUrl = notifyCustomUrl;
        return this;
    }
     ...
     * @param notifyCustomAuthKey
     */
    public SetPublishNormalTimeoutResult notifyCustomAuthKey(String notifyCustomAuthKey) {
        this.notifyCustomAuthKey = notifyCustomAuthKey;
        return this;
    }
     ...
     * @param forwardAccessKeyType
     */
    public SetPublishNormalTimeoutResult forwardAccessKeyType(Integer forwardAccessKeyType) {
        this.forwardAccessKeyType = forwardAccessKeyType;
        return this;
    }
     ...
     * @param forwardPrivateKey
     */
    public SetPublishNormalTimeoutResult forwardPrivateKey(String forwardPrivateKey) {
        this.forwardPrivateKey = forwardPrivateKey;
        return this;
    }
     ...
     * @param originAccessKeyType
     */
    public SetPublishNormalTimeoutResult originAccessKeyType(Integer originAccessKeyType) {
        this.originAccessKeyType = originAccessKeyType;
        return this;
    }
     ...
     * @param originPrivateKey
     */
    public SetPublishNormalTimeoutResult originPrivateKey(String originPrivateKey) {
        this.originPrivateKey = originPrivateKey;
        return this;
    }
