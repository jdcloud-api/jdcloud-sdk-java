 ...
 * 设置封禁
 */
public class CreateForbiddenInfoRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param forbiddenType
     */
    public CreateForbiddenInfoRequest forbiddenType(String forbiddenType) {
        this.forbiddenType = forbiddenType;
        return this;
    }
     ...
     * @param forbiddenDomain
     */
    public CreateForbiddenInfoRequest forbiddenDomain(String forbiddenDomain) {
        this.forbiddenDomain = forbiddenDomain;
        return this;
    }
     ...
     * @param forbiddenUrl
     */
    public CreateForbiddenInfoRequest forbiddenUrl(String forbiddenUrl) {
        this.forbiddenUrl = forbiddenUrl;
        return this;
    }
     ...
     * @param reason
     */
    public CreateForbiddenInfoRequest reason(String reason) {
        this.reason = reason;
        return this;
    }
     ...
     * @param linkOther
     */
    public CreateForbiddenInfoRequest linkOther(String linkOther) {
        this.linkOther = linkOther;
        return this;
    }
     ...
     * @param shareCacheDomainFlag
     */
    public CreateForbiddenInfoRequest shareCacheDomainFlag(String shareCacheDomainFlag) {
        this.shareCacheDomainFlag = shareCacheDomainFlag;
        return this;
    }
     ...
     * @param token
     */
    public CreateForbiddenInfoRequest token(String token) {
        this.token = token;
        return this;
    }
