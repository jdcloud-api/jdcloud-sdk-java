 ...
 * 设置推流中断通知方式
 */
public class SetStreamNotifyInfoResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param ignoreQueryString
     */
    public SetStreamNotifyInfoResult ignoreQueryString(String ignoreQueryString) {
        this.ignoreQueryString = ignoreQueryString;
        return this;
    }
     ...
     * @param pushIpWhiteList
     */
    public SetStreamNotifyInfoResult pushIpWhiteList(String pushIpWhiteList) {
        this.pushIpWhiteList = pushIpWhiteList;
        return this;
    }
     ...
     * @param publishNormalTimeout
     */
    public SetStreamNotifyInfoResult publishNormalTimeout(Integer publishNormalTimeout) {
        this.publishNormalTimeout = publishNormalTimeout;
        return this;
    }
     ...
     * @param notifyCustomUrl
     */
    public SetStreamNotifyInfoResult notifyCustomUrl(String notifyCustomUrl) {
        this.notifyCustomUrl = notifyCustomUrl;
        return this;
    }
     ...
     * @param notifyCustomAuthKey
     */
    public SetStreamNotifyInfoResult notifyCustomAuthKey(String notifyCustomAuthKey) {
        this.notifyCustomAuthKey = notifyCustomAuthKey;
        return this;
    }
     ...
     * @param forwardAccessKeyType
     */
    public SetStreamNotifyInfoResult forwardAccessKeyType(Integer forwardAccessKeyType) {
        this.forwardAccessKeyType = forwardAccessKeyType;
        return this;
    }
     ...
     * @param forwardPrivateKey
     */
    public SetStreamNotifyInfoResult forwardPrivateKey(String forwardPrivateKey) {
        this.forwardPrivateKey = forwardPrivateKey;
        return this;
    }
     ...
     * @param originAccessKeyType
     */
    public SetStreamNotifyInfoResult originAccessKeyType(Integer originAccessKeyType) {
        this.originAccessKeyType = originAccessKeyType;
        return this;
    }
     ...
     * @param originPrivateKey
     */
    public SetStreamNotifyInfoResult originPrivateKey(String originPrivateKey) {
        this.originPrivateKey = originPrivateKey;
        return this;
    }
