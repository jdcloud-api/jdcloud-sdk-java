 ...
 * 设置IP白名单
 */
public class SetPushIpWhiteListResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param ignoreQueryString
     */
    public SetPushIpWhiteListResult ignoreQueryString(String ignoreQueryString) {
        this.ignoreQueryString = ignoreQueryString;
        return this;
    }
     ...
     * @param pushIpWhiteList
     */
    public SetPushIpWhiteListResult pushIpWhiteList(String pushIpWhiteList) {
        this.pushIpWhiteList = pushIpWhiteList;
        return this;
    }
     ...
     * @param publishNormalTimeout
     */
    public SetPushIpWhiteListResult publishNormalTimeout(Integer publishNormalTimeout) {
        this.publishNormalTimeout = publishNormalTimeout;
        return this;
    }
     ...
     * @param notifyCustomUrl
     */
    public SetPushIpWhiteListResult notifyCustomUrl(String notifyCustomUrl) {
        this.notifyCustomUrl = notifyCustomUrl;
        return this;
    }
     ...
     * @param notifyCustomAuthKey
     */
    public SetPushIpWhiteListResult notifyCustomAuthKey(String notifyCustomAuthKey) {
        this.notifyCustomAuthKey = notifyCustomAuthKey;
        return this;
    }
     ...
     * @param forwardAccessKeyType
     */
    public SetPushIpWhiteListResult forwardAccessKeyType(Integer forwardAccessKeyType) {
        this.forwardAccessKeyType = forwardAccessKeyType;
        return this;
    }
     ...
     * @param forwardPrivateKey
     */
    public SetPushIpWhiteListResult forwardPrivateKey(String forwardPrivateKey) {
        this.forwardPrivateKey = forwardPrivateKey;
        return this;
    }
     ...
     * @param originAccessKeyType
     */
    public SetPushIpWhiteListResult originAccessKeyType(Integer originAccessKeyType) {
        this.originAccessKeyType = originAccessKeyType;
        return this;
    }
     ...
     * @param originPrivateKey
     */
    public SetPushIpWhiteListResult originPrivateKey(String originPrivateKey) {
        this.originPrivateKey = originPrivateKey;
        return this;
    }
