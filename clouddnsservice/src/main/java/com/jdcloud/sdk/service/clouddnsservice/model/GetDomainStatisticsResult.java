 ...
 * 查看域名的查询流量
 */
public class GetDomainStatisticsResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param time
     */
    public GetDomainStatisticsResult time(List<Integer> time) {
        this.time = time;
        return this;
    }
     ...
     * @param traffic
     */
    public GetDomainStatisticsResult traffic(List<Integer> traffic) {
        this.traffic = traffic;
        return this;
    }
