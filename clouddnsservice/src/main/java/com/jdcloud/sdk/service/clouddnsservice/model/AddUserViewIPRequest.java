...
import com.jdcloud.sdk.service.clouddnsservice.model.AddViewIP;
...
public class AddUserViewIPRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param req
     */
    public AddUserViewIPRequest req(AddViewIP req) {
        this.req = req;
        return this;
    }
     ...
     * @param regionId
     */
    public AddUserViewIPRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
