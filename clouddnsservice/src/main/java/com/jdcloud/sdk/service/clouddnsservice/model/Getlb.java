 ...
 * getlb
 */
public class Getlb  implements java.io.Serializable {
...
false: 按权重分配负载
     ...
     * @param record
     */
    public Getlb record(String record) {
        this.record = record;
        return this;
    }
     ...
     * @param viewName
     */
    public Getlb viewName(String viewName) {
        this.viewName = viewName;
        return this;
    }
     ...
     * @param viewValue
     */
    public Getlb viewValue(Integer viewValue) {
        this.viewValue = viewValue;
        return this;
    }
     ...
     * @param items
     */
    public Getlb items(List<HostRRlb> items) {
        this.items = items;
        return this;
    }
