 ...
 */
class EnableSubUserAccessKeyExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/subUser/{subUser}/accessKey/{accessKey}:enable";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return EnableSubUserAccessKeyResponse.class;
    }
}
