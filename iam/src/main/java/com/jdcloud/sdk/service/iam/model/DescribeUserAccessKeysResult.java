...
import com.jdcloud.sdk.service.iam.model.UserAccessKey;
...
public class DescribeUserAccessKeysResult extends JdcloudResult implements java.io.Serializable {
    ...
    /**
     * add item to userAccessKeys
     *
     * @param userAccessKey
     */
    public void addUserAccessKey(UserAccessKey userAccessKey) {
        if (this.userAccessKeys == null) {
            this.userAccessKeys = new ArrayList<>();
        }
