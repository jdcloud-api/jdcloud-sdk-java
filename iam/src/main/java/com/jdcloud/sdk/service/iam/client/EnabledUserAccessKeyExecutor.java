 ...
 */
class EnabledUserAccessKeyExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/userAccessKey/{accessKey}:enabled";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return EnabledUserAccessKeyResponse.class;
    }
}
