 ...
 * 禁用子用户的AccessKey
 */
class DisableSubUserAccessKeyExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/subUser/{subUser}/accessKey/{accessKey}:disable";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DisableSubUserAccessKeyResponse.class;
    }
}
