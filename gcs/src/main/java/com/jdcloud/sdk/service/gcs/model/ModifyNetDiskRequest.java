 ...
 * 修改网盘，当前仅支持开通网盘
 */
public class ModifyNetDiskRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param clientToken
     */
    public ModifyNetDiskRequest clientToken(String clientToken) {
        this.clientToken = clientToken;
        return this;
    }
     ...
     * @param az
     */
    public ModifyNetDiskRequest az(String az) {
        this.az = az;
        return this;
    }
     ...
     * @param regionId
     */
    public ModifyNetDiskRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
