 ...
 * 转码输出配置
 */
public class TranscodeOutputParam  implements java.io.Serializable {
     ...
     * 输出集合，必须参数，非空集
     */
    private TranscodeOutputObject output;
     ...
     * @return
     */
    public TranscodeOutputObject getOutput() {
        return output;
    }
     ...
     * @param output
     */
    public void setOutput(TranscodeOutputObject output) {
        this.output = output;
    }
     ...
     * @return TranscodeOutputParam
     */
    public TranscodeOutputParam accessKey(String accessKey) {
        this.accessKey = accessKey;
        return this;
    }
     ...
     * @return TranscodeOutputParam
     */
    public TranscodeOutputParam secretKey(String secretKey) {
        this.secretKey = secretKey;
        return this;
    }
     ...
     * @return TranscodeOutputParam
     */
    public TranscodeOutputParam endpoint(String endpoint) {
        this.endpoint = endpoint;
        return this;
    }
     ...
     * @return TranscodeOutputParam
     */
    public TranscodeOutputParam bucket(String bucket) {
        this.bucket = bucket;
        return this;
    }
     ...
     * set 输出集合，必须参数，非空集
     *
     * @param output 输出集合，必须参数，非空集
     * @return TranscodeOutputParam
     */
    public TranscodeOutputParam output(TranscodeOutputObject output) {
        this.output = output;
        return this;
    }
