 ...
 */
class ModifyServerlessClusterExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/serverless-clusters/{clusterId}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ModifyServerlessClusterResponse.class;
    }
}
