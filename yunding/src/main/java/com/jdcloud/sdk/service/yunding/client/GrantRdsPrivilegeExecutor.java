 ...
 */
class GrantRdsPrivilegeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/ydRdsInstances/{instanceId}/accounts/{accountName}:grantPrivilege";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return GrantRdsPrivilegeResponse.class;
    }
}
