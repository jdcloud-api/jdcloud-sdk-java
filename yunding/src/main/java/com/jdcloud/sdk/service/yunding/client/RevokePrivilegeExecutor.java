 ...
 */
class RevokePrivilegeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/ydRdsInstances/{instanceId}/accounts/{accountName}:revokePrivilege";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return RevokePrivilegeResponse.class;
    }
}
