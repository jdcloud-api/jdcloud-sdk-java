 ...
 * 查看主域名的解析次数
 */
public class DescribeDomainQueryCountResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param time
     */
    public DescribeDomainQueryCountResult time(List<Long> time) {
        this.time = time;
        return this;
    }
     ...
     * @param traffic
     */
    public DescribeDomainQueryCountResult traffic(List<Long> traffic) {
        this.traffic = traffic;
        return this;
    }
