...
import com.jdcloud.sdk.service.domainservice.model.DomainAdded;
...
public class CreateDomainResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param data
     */
    public CreateDomainResult data(DomainAdded data) {
        this.data = data;
        return this;
    }
     ...
     * @param order
     */
    public CreateDomainResult order(String order) {
        this.order = order;
        return this;
    }
