 ...
 * 启用、禁用可用性监控任务
 */
public class ProbeTaskEnableRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param enabled
     */
    public ProbeTaskEnableRequest enabled(Boolean enabled) {
        this.enabled = enabled;
        return this;
    }
     ...
     * @param taskId
     */
    public ProbeTaskEnableRequest taskId(List<String> taskId) {
        this.taskId = taskId;
        return this;
    }
