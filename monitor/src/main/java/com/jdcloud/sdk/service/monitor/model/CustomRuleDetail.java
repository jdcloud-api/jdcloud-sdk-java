 ...
 * customRuleDetail
 */
public class CustomRuleDetail  implements java.io.Serializable {
     ...
     * @param calculateUnit
     */
    public CustomRuleDetail calculateUnit(String calculateUnit) {
        this.calculateUnit = calculateUnit;
        return this;
    }
     ...
     * @param calculation
     */
    public CustomRuleDetail calculation(String calculation) {
        this.calculation = calculation;
        return this;
    }
     ...
     * @param metric
     */
    public CustomRuleDetail metric(String metric) {
        this.metric = metric;
        return this;
    }
     ...
     * @param metricName
     */
    public CustomRuleDetail metricName(String metricName) {
        this.metricName = metricName;
        return this;
    }
     ...
     * @param noticeLevel
     */
    public CustomRuleDetail noticeLevel(NoticeLevel noticeLevel) {
        this.noticeLevel = noticeLevel;
        return this;
    }
     ...
     * @param operation
     */
    public CustomRuleDetail operation(String operation) {
        this.operation = operation;
        return this;
    }
     ...
     * @param period
     */
    public CustomRuleDetail period(Long period) {
        this.period = period;
        return this;
    }
     ...
     * @param threshold
     */
    public CustomRuleDetail threshold(Double threshold) {
        this.threshold = threshold;
        return this;
    }
     ...
     * @param times
     */
    public CustomRuleDetail times(Long times) {
        this.times = times;
        return this;
    }
