...
public class RuleDetail  implements java.io.Serializable {
     ...
     * @param calculateUnit
     */
    public RuleDetail calculateUnit(String calculateUnit) {
        this.calculateUnit = calculateUnit;
        return this;
    }
     ...
     * @param calculation
     */
    public RuleDetail calculation(String calculation) {
        this.calculation = calculation;
        return this;
    }
     ...
     * @param downSample
     */
    public RuleDetail downSample(String downSample) {
        this.downSample = downSample;
        return this;
    }
     ...
     * @param metric
     */
    public RuleDetail metric(String metric) {
        this.metric = metric;
        return this;
    }
     ...
     * @param metricName
     */
    public RuleDetail metricName(String metricName) {
        this.metricName = metricName;
        return this;
    }
     ...
     * @param noticeLevel
     */
    public RuleDetail noticeLevel(NoticeLevel noticeLevel) {
        this.noticeLevel = noticeLevel;
        return this;
    }
     ...
     * @param operation
     */
    public RuleDetail operation(String operation) {
        this.operation = operation;
        return this;
    }
     ...
     * @param period
     */
    public RuleDetail period(Long period) {
        this.period = period;
        return this;
    }
     ...
     * @param threshold
     */
    public RuleDetail threshold(Double threshold) {
        this.threshold = threshold;
        return this;
    }
     ...
     * @param times
     */
    public RuleDetail times(Long times) {
        this.times = times;
        return this;
    }
