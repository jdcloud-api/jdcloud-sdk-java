 ...
 */
public class DescribeSqlserverBlockProcessOut  implements java.io.Serializable {
     ...
     * @param list
     */
    public DescribeSqlserverBlockProcessOut list(List<LastDownsampleRespItem> list) {
        this.list = list;
        return this;
    }
