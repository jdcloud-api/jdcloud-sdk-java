...
public class LastDownsampleRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    /**
     * get 资源的类型，取值vm, lb, ip, database 等。可用的serviceCode请使用describeServices接口查询
     *
     * @return
     */
    ...
    /**
     * set 资源的类型，取值vm, lb, ip, database 等。可用的serviceCode请使用describeServices接口查询
     *
     * @param serviceCode
     */
    ...
    /**
     * get 资源的维度。serviceCode下可用的dimension请使用describeServices接口查询
     *
     * @return
     */
    ...
    /**
     * set 资源的维度。serviceCode下可用的dimension请使用describeServices接口查询
     *
     * @param dimension
     */
