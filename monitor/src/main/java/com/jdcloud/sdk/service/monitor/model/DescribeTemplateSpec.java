 ...
 */
public class DescribeTemplateSpec  implements java.io.Serializable {
...
datasourceType-数据源类型，精确匹配，支持多个（云监控:cloudmonitor，hawkeye:hawkeye，deeplog:deeplog）
     ...
     * @param filters
     */
    public DescribeTemplateSpec filters(List<Filter> filters) {
        this.filters = filters;
        return this;
    }
...
in: query
     ...
     * @param pageNumber
     */
    public DescribeTemplateSpec pageNumber(Long pageNumber) {
        this.pageNumber = pageNumber;
        return this;
    }
...
in: query
     ...
     * @param pageSize
     */
    public DescribeTemplateSpec pageSize(Long pageSize) {
        this.pageSize = pageSize;
        return this;
    }
     ...
     * @param templateType
     */
    public DescribeTemplateSpec templateType(Long templateType) {
        this.templateType = templateType;
        return this;
    }
