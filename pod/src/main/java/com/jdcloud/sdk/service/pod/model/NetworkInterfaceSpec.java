...
public class NetworkInterfaceSpec  implements java.io.Serializable {
    ...
    /**
     * 指定分配的ipv6地址，不能与ipv6AddressCount同时指定
     */
    ...
    */
    ...
    /**
     * get 指定分配的ipv6地址，不能与ipv6AddressCount同时指定
     *
     * @return
     */
    ...
    /**
     * set 指定分配的ipv6地址，不能与ipv6AddressCount同时指定
     *
     * @param ipv6Address
     */
    ...
    */
     ...
     * @param ipv6AddressCount
     */
    public NetworkInterfaceSpec ipv6AddressCount(Integer ipv6AddressCount) {
        this.ipv6AddressCount = ipv6AddressCount;
        return this;
    }
     ...
     * @param ipv6Address
     */
    public NetworkInterfaceSpec ipv6Address(String ipv6Address) {
        this.ipv6Address = ipv6Address;
        return this;
    }
