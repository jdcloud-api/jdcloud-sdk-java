 ...
 */
public class ConfigFileVolumeSourceSpec  implements java.io.Serializable {
     ...
     * @param name
     */
    public ConfigFileVolumeSourceSpec name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param defaultMode
     */
    public ConfigFileVolumeSourceSpec defaultMode(String defaultMode) {
        this.defaultMode = defaultMode;
        return this;
    }
     ...
     * @param fileToPath
     */
    public void addFileToPath(ConfigFileToPathSpec fileToPath) {
