 ...
 * 修改目录属性
 */
class UranusCatalogUpdateExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusCatalogUpdate";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusCatalogUpdateResponse.class;
    }
}
