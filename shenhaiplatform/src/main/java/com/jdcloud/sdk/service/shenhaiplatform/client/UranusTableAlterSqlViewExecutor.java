 ...
 * 发布，保存发布，更新发布等等
 */
class UranusTableAlterSqlViewExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableAlterSqlView";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableAlterSqlViewResponse.class;
    }
}
