 ...
 * 工作流详情
 */
class UranusTaskFlowDetailExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowDetail";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowDetailResponse.class;
    }
}
