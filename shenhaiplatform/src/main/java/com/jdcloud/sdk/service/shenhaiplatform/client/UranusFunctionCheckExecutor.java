 ...
 * 判断目录/函数是否存在
 */
class UranusFunctionCheckExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusFunctionCheck";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusFunctionCheckResponse.class;
    }
}
