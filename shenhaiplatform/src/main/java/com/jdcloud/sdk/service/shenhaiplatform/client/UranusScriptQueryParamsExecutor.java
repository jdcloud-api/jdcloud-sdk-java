 ...
 * 查询脚本参数或任务参数
 */
class UranusScriptQueryParamsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptQueryParams";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptQueryParamsResponse.class;
    }
}
