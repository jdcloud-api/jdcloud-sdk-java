 ...
 * 列出所有根目录(只包含根目录)
 */
class UranusResourceListRootExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceListRoot";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceListRootResponse.class;
    }
}
