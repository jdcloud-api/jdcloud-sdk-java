 ...
 * 目录下工作流列表
 */
class UranusTaskFlowQueryListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowQueryList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowQueryListResponse.class;
    }
}
