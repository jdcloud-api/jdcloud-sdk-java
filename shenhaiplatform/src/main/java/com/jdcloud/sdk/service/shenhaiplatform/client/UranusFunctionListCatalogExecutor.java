 ...
 * 获取所有分类目录
 */
class UranusFunctionListCatalogExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusFunctionListCatalog";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusFunctionListCatalogResponse.class;
    }
}
