 ...
 * 工作流-发布一
 */
class UranusTaskPublishOneExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskPublishOne";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskPublishOneResponse.class;
    }
}
