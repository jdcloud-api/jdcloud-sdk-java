 ...
 * 删除文件夹
 */
class UranusWorkFlowDirDeleteExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusWorkFlowDirDelete";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusWorkFlowDirDeleteResponse.class;
    }
}
