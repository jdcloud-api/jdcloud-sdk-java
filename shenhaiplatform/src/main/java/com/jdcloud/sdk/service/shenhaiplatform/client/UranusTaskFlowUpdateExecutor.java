 ...
 * 工作流更新
 */
class UranusTaskFlowUpdateExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowUpdate";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowUpdateResponse.class;
    }
}
