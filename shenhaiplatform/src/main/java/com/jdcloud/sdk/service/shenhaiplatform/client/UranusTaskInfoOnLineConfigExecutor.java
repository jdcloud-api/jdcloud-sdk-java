 ...
 * 使用线上配置
 */
class UranusTaskInfoOnLineConfigExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoOnLineConfig";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoOnLineConfigResponse.class;
    }
}
