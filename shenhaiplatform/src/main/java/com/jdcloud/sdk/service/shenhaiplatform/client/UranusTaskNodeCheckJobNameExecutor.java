 ...
 * 任务单节点-校验作业名称
 */
class UranusTaskNodeCheckJobNameExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskNodeCheckJobName";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskNodeCheckJobNameResponse.class;
    }
}
