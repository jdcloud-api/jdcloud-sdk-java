 ...
 * 数据预览
 */
class UranusDataLoadPreviewExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusDataLoadPreview";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusDataLoadPreviewResponse.class;
    }
}
