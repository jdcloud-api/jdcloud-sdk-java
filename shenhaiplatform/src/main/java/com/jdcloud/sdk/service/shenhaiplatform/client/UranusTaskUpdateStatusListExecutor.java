 ...
 * 批量任务单节点-上下线更新
 */
class UranusTaskUpdateStatusListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskUpdateStatusList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskUpdateStatusListResponse.class;
    }
}
