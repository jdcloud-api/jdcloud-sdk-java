 ...
 * 执行脚本
 */
class UranusScriptStartersExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptStarters";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptStartersResponse.class;
    }
}
