 ...
 * 任务单节点-新建
 */
class UranusTaskNodeSaveExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskNodeSave";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskNodeSaveResponse.class;
    }
}
