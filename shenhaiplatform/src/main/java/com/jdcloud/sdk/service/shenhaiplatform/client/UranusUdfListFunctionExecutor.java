 ...
 * 查询函数接口
 */
class UranusUdfListFunctionExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusUdfListFunction";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusUdfListFunctionResponse.class;
    }
}
