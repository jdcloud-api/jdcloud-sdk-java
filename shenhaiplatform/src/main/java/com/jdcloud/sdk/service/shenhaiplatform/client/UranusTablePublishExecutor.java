 ...
 * 发布，保存发布，更新发布等等
 */
class UranusTablePublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTablePublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTablePublishResponse.class;
    }
}
