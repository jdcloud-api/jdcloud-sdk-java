 ...
 * 任务重新发布
 */
class UranusTaskInfoRePublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoRePublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoRePublishResponse.class;
    }
}
