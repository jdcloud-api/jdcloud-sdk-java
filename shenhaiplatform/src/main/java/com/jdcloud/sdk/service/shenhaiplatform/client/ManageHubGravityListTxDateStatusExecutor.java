 ...
 * 分页查询作业数据日期状态列表
 */
class ManageHubGravityListTxDateStatusExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/manageHubGravityListTxDateStatus";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ManageHubGravityListTxDateStatusResponse.class;
    }
}
