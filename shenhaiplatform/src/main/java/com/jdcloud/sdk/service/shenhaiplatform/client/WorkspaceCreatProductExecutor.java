 ...
 * 工作空间开通接口
 */
class WorkspaceCreatProductExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/workspaceCreatProduct";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return WorkspaceCreatProductResponse.class;
    }
}
