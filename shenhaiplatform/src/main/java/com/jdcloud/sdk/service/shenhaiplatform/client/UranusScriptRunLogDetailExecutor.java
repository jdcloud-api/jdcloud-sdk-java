 ...
 * 获得脚本运行记录详情
 */
class UranusScriptRunLogDetailExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptRunLogDetail";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptRunLogDetailResponse.class;
    }
}
