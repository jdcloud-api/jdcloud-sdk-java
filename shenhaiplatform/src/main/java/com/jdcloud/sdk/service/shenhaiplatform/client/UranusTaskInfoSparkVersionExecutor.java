 ...
 * 获取spark版本
 */
class UranusTaskInfoSparkVersionExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoSparkVersion";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoSparkVersionResponse.class;
    }
}
