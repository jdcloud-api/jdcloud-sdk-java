 ...
 * 任务单节点-删除
 */
class UranusTaskNodeDeleteExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskNodeDelete";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskNodeDeleteResponse.class;
    }
}
