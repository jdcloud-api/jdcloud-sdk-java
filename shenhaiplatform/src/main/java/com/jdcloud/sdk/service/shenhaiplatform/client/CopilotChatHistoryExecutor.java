 ...
 * 获取历史对话列表
 */
class CopilotChatHistoryExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/copilotChatHistory";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return CopilotChatHistoryResponse.class;
    }
}
