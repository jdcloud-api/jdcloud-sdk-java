 ...
 * 流程画布-节点管理列表
 */
class UranusTaskNodeListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskNodeList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskNodeListResponse.class;
    }
}
