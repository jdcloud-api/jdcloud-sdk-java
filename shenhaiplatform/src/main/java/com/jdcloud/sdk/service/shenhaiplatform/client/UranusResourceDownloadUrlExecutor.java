 ...
 * 获取资源下载链接
 */
class UranusResourceDownloadUrlExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceDownloadUrl";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceDownloadUrlResponse.class;
    }
}
