 ...
 * pageVoJobInfoVo
 */
public class PageVoJobInfoVo  implements java.io.Serializable {
    ...
    * @param list
    */
    public void setList(List<JobInfoVo> list) {
        this.list = list;
    }
    ...
    */
     ...
     * @param list
     */
    public void addList(JobInfoVo list) {
        if (this.list == null) {
