 ...
 * 任务保存
 */
class UranusTaskInfoSaveExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoSave";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoSaveResponse.class;
    }
}
