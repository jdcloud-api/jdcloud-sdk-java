 ...
 * 停止查询
 */
class UranusExtraRunnerStopExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusExtraRunnerStop";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusExtraRunnerStopResponse.class;
    }
}
