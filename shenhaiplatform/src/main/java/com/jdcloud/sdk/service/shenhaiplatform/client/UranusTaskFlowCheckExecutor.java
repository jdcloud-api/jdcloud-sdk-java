 ...
 * 检查工作流名称
 */
class UranusTaskFlowCheckExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowCheck";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowCheckResponse.class;
    }
}
