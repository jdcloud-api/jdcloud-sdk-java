 ...
 * 获取临时查询运行日志
 */
class UranusTaskExtraRunnerLogExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskExtraRunnerLog";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskExtraRunnerLogResponse.class;
    }
}
