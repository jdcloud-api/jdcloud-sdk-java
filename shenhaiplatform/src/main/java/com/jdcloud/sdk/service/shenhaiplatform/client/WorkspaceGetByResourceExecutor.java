 ...
 * 获取资源组code被绑定的工作空间
 */
class WorkspaceGetByResourceExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/workspaceGetByResource";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return WorkspaceGetByResourceResponse.class;
    }
}
