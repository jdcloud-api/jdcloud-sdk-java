 ...
 */
class CopilotUtteranceRecommendExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/copilotUtteranceRecommend";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return CopilotUtteranceRecommendResponse.class;
    }
}
