 ...
 */
class JtlasWarehouseQueryTablesUnderSpecifiedUserExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/jtlasWarehouseQueryTablesUnderSpecifiedUser";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return JtlasWarehouseQueryTablesUnderSpecifiedUserResponse.class;
    }
}
