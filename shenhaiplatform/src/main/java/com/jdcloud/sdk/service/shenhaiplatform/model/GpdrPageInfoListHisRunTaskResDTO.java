 ...
 * 返回结果对象
 */
public class GpdrPageInfoListHisRunTaskResDTO  implements java.io.Serializable {
    ...
    private List<GpdrListHisRunTaskResDTO> list;
    /**
     * pageNum
     */
    ...
    * @return
    */
    public List<GpdrListHisRunTaskResDTO> getList() {
        return list;
    }
    ...
    * @param list
    */
    public void setList(List<GpdrListHisRunTaskResDTO> list) {
        this.list = list;
    }
    ...
    */
     ...
     * @param list
     */
    public void addList(GpdrListHisRunTaskResDTO list) {
        if (this.list == null) {
