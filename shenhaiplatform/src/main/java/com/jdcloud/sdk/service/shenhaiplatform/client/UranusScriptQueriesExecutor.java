 ...
 * 获得脚本详情
 */
class UranusScriptQueriesExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptQueries";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptQueriesResponse.class;
    }
}
