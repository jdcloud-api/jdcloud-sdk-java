 ...
 * 任务节点保存-多节点关系
 */
class UranusTaskAddRelationExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskAddRelation";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskAddRelationResponse.class;
    }
}
