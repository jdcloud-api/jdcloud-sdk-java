 ...
 * 任务节点详情-多节点关系
 */
class UranusTaskGetRelationExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskGetRelation";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskGetRelationResponse.class;
    }
}
