 ...
 * 脚本运行列表
 */
class UranusScriptRunLogListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptRunLogList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptRunLogListResponse.class;
    }
}
