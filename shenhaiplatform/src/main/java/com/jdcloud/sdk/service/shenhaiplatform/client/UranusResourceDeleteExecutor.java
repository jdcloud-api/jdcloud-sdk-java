 ...
 * 删除资源
 */
class UranusResourceDeleteExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceDelete";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceDeleteResponse.class;
    }
}
