 ...
 * 任务发布
 */
class UranusTaskInfoPublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoPublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoPublishResponse.class;
    }
}
