 ...
 * 一键重跑
 */
class ManageHubGravityOneClickRerunExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/manageHubGravityOneClickRerun";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ManageHubGravityOneClickRerunResponse.class;
    }
}
