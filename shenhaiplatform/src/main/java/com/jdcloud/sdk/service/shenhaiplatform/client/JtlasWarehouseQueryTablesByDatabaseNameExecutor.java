 ...
 */
class JtlasWarehouseQueryTablesByDatabaseNameExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/jtlasWarehouseQueryTablesByDatabaseName";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return JtlasWarehouseQueryTablesByDatabaseNameResponse.class;
    }
}
