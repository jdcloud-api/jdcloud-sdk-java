 ...
 * 工作空间删除
 */
class UranusWorkSpaceDownExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusWorkSpaceDown";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusWorkSpaceDownResponse.class;
    }
}
