 ...
 * 目录根据companyCode查询目录
 */
class UranusCatalogQueryListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusCatalogQueryList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusCatalogQueryListResponse.class;
    }
}
