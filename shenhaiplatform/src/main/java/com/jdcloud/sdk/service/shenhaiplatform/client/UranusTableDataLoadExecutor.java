 ...
 * 数据上传
 */
class UranusTableDataLoadExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableDataLoad";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableDataLoadResponse.class;
    }
}
