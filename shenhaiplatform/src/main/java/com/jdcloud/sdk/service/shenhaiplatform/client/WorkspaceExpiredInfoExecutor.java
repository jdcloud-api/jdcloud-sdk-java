 ...
 * 判断当前租户的产品是否已过期
 */
class WorkspaceExpiredInfoExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/workspaceExpiredInfo";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return WorkspaceExpiredInfoResponse.class;
    }
}
