 ...
 * 获取工作空间绑定的云仓项目
 */
class WorkspaceGetProjectExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/workspaceGetProject";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return WorkspaceGetProjectResponse.class;
    }
}
