 ...
 * 工作空间绑定云仓项目
 */
class WorkspaceBundleProjectExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/workspaceBundleProject";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return WorkspaceBundleProjectResponse.class;
    }
}
