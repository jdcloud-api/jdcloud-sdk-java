 ...
 * 获取资源状态
 */
class UranusResourceStatusExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceStatus";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceStatusResponse.class;
    }
}
