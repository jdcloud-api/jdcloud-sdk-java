 ...
 * 查询授权表
 */
class UranusTableCheckTableNameExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableCheckTableName";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableCheckTableNameResponse.class;
    }
}
