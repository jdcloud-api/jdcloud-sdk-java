 ...
 * 查询计算任务日志
 */
class ManageHubGravityJobLogExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/manageHubGravityJobLog";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ManageHubGravityJobLogResponse.class;
    }
}
