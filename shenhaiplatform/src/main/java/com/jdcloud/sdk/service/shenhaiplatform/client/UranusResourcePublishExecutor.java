 ...
 * 发布资源
 */
class UranusResourcePublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourcePublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourcePublishResponse.class;
    }
}
