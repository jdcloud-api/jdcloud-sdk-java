 ...
 * 获得脚本运行的内容
 */
class UranusScriptRunLogContentExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptRunLogContent";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptRunLogContentResponse.class;
    }
}
