 ...
 * 任务预发布
 */
class UranusTaskInfoPrePublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoPrePublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoPrePublishResponse.class;
    }
}
