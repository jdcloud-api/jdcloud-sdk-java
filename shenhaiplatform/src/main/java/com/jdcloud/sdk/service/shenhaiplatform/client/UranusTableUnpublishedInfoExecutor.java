 ...
 * 查询未发布的表变更信息
 */
class UranusTableUnpublishedInfoExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableUnpublishedInfo";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableUnpublishedInfoResponse.class;
    }
}
