 ...
 * 更新用户默认表来源
 */
class UranusTableDefaultSourceExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableDefaultSource";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableDefaultSourceResponse.class;
    }
}
