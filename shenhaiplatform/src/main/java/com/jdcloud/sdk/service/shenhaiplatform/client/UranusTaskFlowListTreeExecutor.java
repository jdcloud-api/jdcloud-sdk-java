 ...
 * 工作流目录树
 */
class UranusTaskFlowListTreeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowListTree";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowListTreeResponse.class;
    }
}
