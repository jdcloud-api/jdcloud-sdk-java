 ...
 * 分页查询发布包列表
 */
class DescribePublishPkgsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/describePublishPkgs";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribePublishPkgsResponse.class;
    }
}
