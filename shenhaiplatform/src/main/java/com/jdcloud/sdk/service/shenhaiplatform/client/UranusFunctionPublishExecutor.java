 ...
 * 发布函数到发布中心
 */
class UranusFunctionPublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusFunctionPublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusFunctionPublishResponse.class;
    }
}
