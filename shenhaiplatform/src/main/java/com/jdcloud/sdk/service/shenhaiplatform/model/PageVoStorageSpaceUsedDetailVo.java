 ...
 */
public class PageVoStorageSpaceUsedDetailVo  implements java.io.Serializable {
    ...
    private List<JcwSpaceUsedDetailVo> list;
    ...
    * @return
    */
    public List<JcwSpaceUsedDetailVo> getList() {
        return list;
    }
    ...
    * @param list
    */
    public void setList(List<JcwSpaceUsedDetailVo> list) {
        this.list = list;
    }
    ...
    */
     ...
     * @param list
     */
    public void addList(JcwSpaceUsedDetailVo list) {
        if (this.list == null) {
