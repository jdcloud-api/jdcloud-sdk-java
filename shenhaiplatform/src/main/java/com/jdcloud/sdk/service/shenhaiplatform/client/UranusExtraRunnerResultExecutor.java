 ...
 * 获取查询结果
 */
class UranusExtraRunnerResultExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusExtraRunnerResult";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusExtraRunnerResultResponse.class;
    }
}
