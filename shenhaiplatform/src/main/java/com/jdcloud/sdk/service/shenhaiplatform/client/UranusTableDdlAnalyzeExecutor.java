 ...
 * DDL语句解析
 */
class UranusTableDdlAnalyzeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableDdlAnalyze";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableDdlAnalyzeResponse.class;
    }
}
