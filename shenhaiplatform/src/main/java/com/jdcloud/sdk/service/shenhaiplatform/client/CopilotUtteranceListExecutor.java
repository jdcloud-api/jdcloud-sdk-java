 ...
 * 获取指定对话中的发言记录
 */
class CopilotUtteranceListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/copilotUtteranceList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return CopilotUtteranceListResponse.class;
    }
}
