 ...
 * 新建资源（包含资源目录和资源文件）
 */
class UranusResourceCreateExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceCreate";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceCreateResponse.class;
    }
}
