 ...
 * 发布对象信息细节查看
 */
class DescribePublishObjExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/describePublishObj";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribePublishObjResponse.class;
    }
}
