 ...
 * 查询表来源列表并标识默认项
 */
class UranusTableSourcesExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableSources";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableSourcesResponse.class;
    }
}
