 ...
 * 完成并关闭资源上传
 */
class UranusResourceCloseFileExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceCloseFile";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceCloseFileResponse.class;
    }
}
