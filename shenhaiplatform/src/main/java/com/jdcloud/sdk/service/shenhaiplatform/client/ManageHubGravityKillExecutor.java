 ...
 * 终止作业
 */
class ManageHubGravityKillExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/manageHubGravityKill";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ManageHubGravityKillResponse.class;
    }
}
