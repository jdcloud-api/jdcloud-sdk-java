 ...
 * 任务节点版本查看
 */
class UranusTaskInfoHistoryListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoHistoryList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoHistoryListResponse.class;
    }
}
