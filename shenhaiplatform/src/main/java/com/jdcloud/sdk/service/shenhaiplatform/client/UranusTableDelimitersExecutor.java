 ...
 * 表分隔符信息
 */
class UranusTableDelimitersExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTableDelimiters";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTableDelimitersResponse.class;
    }
}
