 ...
 * 脚本内容更新
 */
class UranusScriptSaveContentExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptSaveContent";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptSaveContentResponse.class;
    }
}
