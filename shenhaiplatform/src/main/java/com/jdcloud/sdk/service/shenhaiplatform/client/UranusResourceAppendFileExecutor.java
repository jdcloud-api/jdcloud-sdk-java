 ...
 * 上传资源
 */
class UranusResourceAppendFileExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceAppendFile";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceAppendFileResponse.class;
    }
}
