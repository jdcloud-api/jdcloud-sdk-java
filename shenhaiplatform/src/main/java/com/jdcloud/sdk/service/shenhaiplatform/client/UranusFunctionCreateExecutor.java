 ...
 * 新建函数
 */
class UranusFunctionCreateExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusFunctionCreate";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusFunctionCreateResponse.class;
    }
}
