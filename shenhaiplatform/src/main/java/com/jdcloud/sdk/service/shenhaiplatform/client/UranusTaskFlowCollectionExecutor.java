 ...
 * 工作流收藏和取消收藏
 */
class UranusTaskFlowCollectionExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowCollection";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowCollectionResponse.class;
    }
}
