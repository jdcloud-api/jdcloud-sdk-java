...
import com.jdcloud.sdk.service.shenhaiplatform.model.GpmnJobSpendTimeRankingVo;
import com.jdcloud.sdk.service.JdcloudResult;

/**
 * 统计作业耗时排名
 */
public class GravityParticleJobMonitorJobSpendTimeRankingResult extends JdcloudResult implements java.io.Serializable {
    ...
    private List<GpmnJobSpendTimeRankingVo> result;
    /**
     * 返回状态码
     */
    private String code;
    ...
    * @return
    */
    public List<GpmnJobSpendTimeRankingVo> getResult() {
        return result;
    }
    ...
    * @param result
    */
    public void setResult(List<GpmnJobSpendTimeRankingVo> result) {
        this.result = result;
    }
    ...
    */
     ...
     * @param result
     */
    public void addResult(GpmnJobSpendTimeRankingVo result) {
        if (this.result == null) {
