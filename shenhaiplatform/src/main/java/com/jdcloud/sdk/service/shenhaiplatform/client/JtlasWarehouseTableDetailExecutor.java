 ...
 * 根据租户/项目空间/表名称查询表详情
 */
class JtlasWarehouseTableDetailExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/jtlasWarehouseTableDetail";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return JtlasWarehouseTableDetailResponse.class;
    }
}
