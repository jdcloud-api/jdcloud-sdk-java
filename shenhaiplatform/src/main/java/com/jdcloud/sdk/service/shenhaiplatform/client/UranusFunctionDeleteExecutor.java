 ...
 * 删除函数
 */
class UranusFunctionDeleteExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusFunctionDelete";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusFunctionDeleteResponse.class;
    }
}
