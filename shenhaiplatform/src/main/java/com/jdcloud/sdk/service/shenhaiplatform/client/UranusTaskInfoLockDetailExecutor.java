 ...
 * 抢锁时获取任务信息
 */
class UranusTaskInfoLockDetailExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoLockDetail";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoLockDetailResponse.class;
    }
}
