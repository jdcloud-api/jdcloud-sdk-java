 ...
 * 停止发言，用于终止模型回复生成
 */
class CopilotUtteranceStopExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/copilotUtteranceStop";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return CopilotUtteranceStopResponse.class;
    }
}
