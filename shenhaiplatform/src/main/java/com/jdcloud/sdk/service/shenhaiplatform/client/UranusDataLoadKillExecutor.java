 ...
 * 终止数据上传任务
 */
class UranusDataLoadKillExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusDataLoadKill";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusDataLoadKillResponse.class;
    }
}
