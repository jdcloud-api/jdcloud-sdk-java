 ...
 * sql语法检测
 */
class UranusScriptSyntaxCheckExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptSyntaxCheck";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptSyntaxCheckResponse.class;
    }
}
