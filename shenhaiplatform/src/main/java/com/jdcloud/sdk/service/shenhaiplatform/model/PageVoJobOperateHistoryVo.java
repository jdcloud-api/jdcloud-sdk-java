 ...
 */
public class PageVoJobOperateHistoryVo  implements java.io.Serializable {
    ...
    private List<JobOperateHistoryVo> list;
    ...
    * @return
    */
    public List<JobOperateHistoryVo> getList() {
        return list;
    }
    ...
    * @param list
    */
    public void setList(List<JobOperateHistoryVo> list) {
        this.list = list;
    }
    ...
    */
     ...
     * @param list
     */
    public void addList(JobOperateHistoryVo list) {
        if (this.list == null) {
