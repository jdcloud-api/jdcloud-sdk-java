 ...
 * 建表的列类型查询
 */
class UranusDictTableCodeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusDictTableCode";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusDictTableCodeResponse.class;
    }
}
