 ...
 * 更新资源
 */
class UranusResourceUpdateExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusResourceUpdate";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusResourceUpdateResponse.class;
    }
}
