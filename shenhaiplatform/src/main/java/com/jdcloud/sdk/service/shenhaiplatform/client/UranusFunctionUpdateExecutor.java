 ...
 * 更新函数
 */
class UranusFunctionUpdateExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusFunctionUpdate";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusFunctionUpdateResponse.class;
    }
}
