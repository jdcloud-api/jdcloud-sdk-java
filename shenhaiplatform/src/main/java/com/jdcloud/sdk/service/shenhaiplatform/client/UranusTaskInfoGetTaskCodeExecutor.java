 ...
 * 获取taskCode
 */
class UranusTaskInfoGetTaskCodeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskInfoGetTaskCode";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskInfoGetTaskCodeResponse.class;
    }
}
