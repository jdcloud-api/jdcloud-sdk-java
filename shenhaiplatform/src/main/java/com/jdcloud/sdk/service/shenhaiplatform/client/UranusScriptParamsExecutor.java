 ...
 * 脚本参数保存/更新
 */
class UranusScriptParamsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusScriptParams";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusScriptParamsResponse.class;
    }
}
