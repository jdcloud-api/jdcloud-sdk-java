 ...
 * 执行查询
 */
class UranusExtraRunnerStartExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusExtraRunnerStart";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusExtraRunnerStartResponse.class;
    }
}
