 ...
 * 根据父目录CODE删除目录
 */
class UranusCatalogDeleteExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusCatalogDelete";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusCatalogDeleteResponse.class;
    }
}
