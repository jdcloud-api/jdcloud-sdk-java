 ...
 * 同步工作空间续费消息
 */
class WorkspaceSyncRechargeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/workspaceSyncRecharge";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return WorkspaceSyncRechargeResponse.class;
    }
}
