 ...
 */
class JtlasWarehouseFuzzyQueryTablesByTableNameExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/jtlasWarehouseFuzzyQueryTablesByTableName";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return JtlasWarehouseFuzzyQueryTablesByTableNameResponse.class;
    }
}
