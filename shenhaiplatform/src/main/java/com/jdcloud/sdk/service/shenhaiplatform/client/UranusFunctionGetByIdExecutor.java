 ...
 * 根据函数id查询函数
 */
class UranusFunctionGetByIdExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusFunctionGetById";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusFunctionGetByIdResponse.class;
    }
}
