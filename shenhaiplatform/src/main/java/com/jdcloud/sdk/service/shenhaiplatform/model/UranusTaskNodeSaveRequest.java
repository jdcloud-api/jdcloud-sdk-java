 ...
 * 任务单节点-新建
 */
public class UranusTaskNodeSaveRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param taskName
     */
    public UranusTaskNodeSaveRequest taskName(String taskName) {
        this.taskName = taskName;
        return this;
    }
    ...
    * @param childrenCode
    */
    public UranusTaskNodeSaveRequest childrenCode(List<String> childrenCode) {
        this.childrenCode = childrenCode;
        return this;
    }
    ...
    * @param parentCode
    */
    public UranusTaskNodeSaveRequest parentCode(List<String> parentCode) {
        this.parentCode = parentCode;
        return this;
    }
     ...
     * @param taskDesc
     */
    public UranusTaskNodeSaveRequest taskDesc(String taskDesc) {
        this.taskDesc = taskDesc;
        return this;
    }
     ...
     * @param taskNodeId
     */
    public UranusTaskNodeSaveRequest taskNodeId(Integer taskNodeId) {
        this.taskNodeId = taskNodeId;
        return this;
    }
     ...
     * @param taskCode
     */
    public UranusTaskNodeSaveRequest taskCode(String taskCode) {
        this.taskCode = taskCode;
        return this;
    }
     ...
     * @param manager
     */
    public UranusTaskNodeSaveRequest manager(String manager) {
        this.manager = manager;
        return this;
    }
     ...
     * @param taskData
     */
    public UranusTaskNodeSaveRequest taskData(String taskData) {
        this.taskData = taskData;
        return this;
    }
     ...
     * @param nodeName
     */
    public UranusTaskNodeSaveRequest nodeName(String nodeName) {
        this.nodeName = nodeName;
        return this;
    }
     ...
     * @param nodeTypeName
     */
    public UranusTaskNodeSaveRequest nodeTypeName(String nodeTypeName) {
        this.nodeTypeName = nodeTypeName;
        return this;
    }
     ...
     * @param nodeIcon
     */
    public UranusTaskNodeSaveRequest nodeIcon(String nodeIcon) {
        this.nodeIcon = nodeIcon;
        return this;
    }
     ...
     * @param flowCode
     */
    public UranusTaskNodeSaveRequest flowCode(String flowCode) {
        this.flowCode = flowCode;
        return this;
    }
     ...
     * @param fileCode
     */
    public UranusTaskNodeSaveRequest fileCode(String fileCode) {
        this.fileCode = fileCode;
        return this;
    }
     ...
     * @param jobName
     */
    public UranusTaskNodeSaveRequest jobName(String jobName) {
        this.jobName = jobName;
        return this;
    }
     ...
     * @param isUranus
     */
    public UranusTaskNodeSaveRequest isUranus(Integer isUranus) {
        this.isUranus = isUranus;
        return this;
    }
     ...
     * @param isCurrentFlow
     */
    public UranusTaskNodeSaveRequest isCurrentFlow(Integer isCurrentFlow) {
        this.isCurrentFlow = isCurrentFlow;
        return this;
    }
    ...
    * @param parent
    */
    public UranusTaskNodeSaveRequest parent(List<UranusTaskNodeSaveReq> parent) {
        this.parent = parent;
        return this;
    }
     ...
     * @param haveChildren
     */
    public UranusTaskNodeSaveRequest haveChildren(Integer haveChildren) {
        this.haveChildren = haveChildren;
        return this;
    }
     ...
     * @param cooperator
     */
    public UranusTaskNodeSaveRequest cooperator(String cooperator) {
        this.cooperator = cooperator;
        return this;
    }
     ...
     * @param regionId
     */
    public UranusTaskNodeSaveRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param appName
     */
    public UranusTaskNodeSaveRequest appName(String appName) {
        this.appName = appName;
        return this;
    }
