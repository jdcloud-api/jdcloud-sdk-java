 ...
 * 任务节点输出参数查询
 */
class UranusTaskExportParamListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskExportParamList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskExportParamListResponse.class;
    }
}
