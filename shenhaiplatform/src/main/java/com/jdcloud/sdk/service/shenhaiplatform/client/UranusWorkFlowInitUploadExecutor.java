 ...
 * 分片上传初始化
 */
class UranusWorkFlowInitUploadExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusWorkFlowInitUpload";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusWorkFlowInitUploadResponse.class;
    }
}
