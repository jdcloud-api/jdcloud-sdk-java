 ...
 * 工作流删除
 */
class UranusTaskFlowDeleteExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowDelete";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowDeleteResponse.class;
    }
}
