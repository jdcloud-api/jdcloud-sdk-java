 ...
 * 工作流新建
 */
class UranusTaskFlowSaveExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskFlowSave";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskFlowSaveResponse.class;
    }
}
