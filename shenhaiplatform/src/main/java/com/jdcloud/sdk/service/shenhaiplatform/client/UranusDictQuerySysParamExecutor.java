 ...
 * 查询系统参数
 */
class UranusDictQuerySysParamExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusDictQuerySysParam";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusDictQuerySysParamResponse.class;
    }
}
