 ...
 */
class JtlasWarehouseQueryTablePrivilegesExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/jtlasWarehouseQueryTablePrivileges";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return JtlasWarehouseQueryTablePrivilegesResponse.class;
    }
}
