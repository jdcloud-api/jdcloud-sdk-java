 ...
 */
class UranusTaskNodeBatchImportExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskNodeBatchImport";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskNodeBatchImportResponse.class;
    }
}
