 ...
 * 发布包详情查询
 */
class DescribePublishPkgExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/describePublishPkg";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribePublishPkgResponse.class;
    }
}
