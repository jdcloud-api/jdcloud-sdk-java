 ...
 * 工作流画布-作业预发布
 */
class UranusTaskPagePublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskPagePublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskPagePublishResponse.class;
    }
}
