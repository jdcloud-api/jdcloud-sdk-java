 ...
 * 工作流-预发布
 */
class UranusTaskPrePublishExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apps/{appName}/uranusTaskPrePublish";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UranusTaskPrePublishResponse.class;
    }
}
