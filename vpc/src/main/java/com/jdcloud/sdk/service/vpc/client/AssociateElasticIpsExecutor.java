 ...
 */
class AssociateElasticIpsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/natGateways/{natGatewayId}:associateElasticIps";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return AssociateElasticIpsResponse.class;
    }
}
