 ...
 */
public class ModifyTrafficMirrorFilterRuleSpec  implements java.io.Serializable {
     ...
     * @param mirrorFilterRuleId
     */
    public ModifyTrafficMirrorFilterRuleSpec mirrorFilterRuleId(String mirrorFilterRuleId) {
        this.mirrorFilterRuleId = mirrorFilterRuleId;
        return this;
    }
     ...
     * @param direction
     */
    public ModifyTrafficMirrorFilterRuleSpec direction(String direction) {
        this.direction = direction;
        return this;
    }
     ...
     * @param protocol
     */
    public ModifyTrafficMirrorFilterRuleSpec protocol(String protocol) {
        this.protocol = protocol;
        return this;
    }
     ...
     * @param action
     */
    public ModifyTrafficMirrorFilterRuleSpec action(String action) {
        this.action = action;
        return this;
    }
     ...
     * @param priority
     */
    public ModifyTrafficMirrorFilterRuleSpec priority(Number priority) {
        this.priority = priority;
        return this;
    }
     ...
     * @param sourceCidr
     */
    public ModifyTrafficMirrorFilterRuleSpec sourceCidr(String sourceCidr) {
        this.sourceCidr = sourceCidr;
        return this;
    }
     ...
     * @param destinationCidr
     */
    public ModifyTrafficMirrorFilterRuleSpec destinationCidr(String destinationCidr) {
        this.destinationCidr = destinationCidr;
        return this;
    }
     ...
     * @param sourcePortStart
     */
    public ModifyTrafficMirrorFilterRuleSpec sourcePortStart(Number sourcePortStart) {
        this.sourcePortStart = sourcePortStart;
        return this;
    }
     ...
     * @param sourcePortEnd
     */
    public ModifyTrafficMirrorFilterRuleSpec sourcePortEnd(Number sourcePortEnd) {
        this.sourcePortEnd = sourcePortEnd;
        return this;
    }
     ...
     * @param destinationPortStart
     */
    public ModifyTrafficMirrorFilterRuleSpec destinationPortStart(Number destinationPortStart) {
        this.destinationPortStart = destinationPortStart;
        return this;
    }
     ...
     * @param destinationPortEnd
     */
    public ModifyTrafficMirrorFilterRuleSpec destinationPortEnd(Number destinationPortEnd) {
        this.destinationPortEnd = destinationPortEnd;
        return this;
    }
