 ...
 * 设置NAT网关已绑定的公网IP状态接口
 */
public class SetElasticIpStatusRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    * @param elasticIpIds
    */
    public SetElasticIpStatusRequest elasticIpIds(List<String> elasticIpIds) {
        this.elasticIpIds = elasticIpIds;
        return this;
    }
     ...
     * @param status
     */
    public SetElasticIpStatusRequest status(String status) {
        this.status = status;
        return this;
    }
     ...
     * @param regionId
     */
    public SetElasticIpStatusRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param natGatewayId
     */
    public SetElasticIpStatusRequest natGatewayId(String natGatewayId) {
        this.natGatewayId = natGatewayId;
        return this;
    }
