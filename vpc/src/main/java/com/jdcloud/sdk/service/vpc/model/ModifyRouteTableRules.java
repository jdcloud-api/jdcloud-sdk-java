 ...
 */
public class ModifyRouteTableRules  implements java.io.Serializable {
    ...
    /**
     * get 规则匹配优先级，取值范围[1,255]。当路由规则子网掩码不同时，路由最长匹配优先；当路由规则子网掩码相同时, 按照优先级匹配转发, 优先级数字越小优先级越高，路由规则子网掩码相同、优先级相同、下一跳不同时，形成等价路由，不同下一跳负载均担。
     *
     * @return
     */
    ...
    /**
     * set 规则匹配优先级，取值范围[1,255]。当路由规则子网掩码不同时，路由最长匹配优先；当路由规则子网掩码相同时, 按照优先级匹配转发, 优先级数字越小优先级越高，路由规则子网掩码相同、优先级相同、下一跳不同时，形成等价路由，不同下一跳负载均担。
     *
     * @param priority
     */
    ...
    /**
     * get 路由表规则前缀, internet类型路由跟其他类型的路由，addressPrefix不允许重复
     *
     * @return
     */
    ...
    /**
     * set 路由表规则前缀, internet类型路由跟其他类型的路由，addressPrefix不允许重复
     *
     * @param addressPrefix
     */
     ...
     * @param ruleId
     */
    public ModifyRouteTableRules ruleId(String ruleId) {
        this.ruleId = ruleId;
        return this;
    }
     ...
     * @param priority
     */
    public ModifyRouteTableRules priority(Number priority) {
        this.priority = priority;
        return this;
    }
     ...
     * @param nextHopType
     */
    public ModifyRouteTableRules nextHopType(String nextHopType) {
        this.nextHopType = nextHopType;
        return this;
    }
     ...
     * @param nextHopId
     */
    public ModifyRouteTableRules nextHopId(String nextHopId) {
        this.nextHopId = nextHopId;
        return this;
    }
