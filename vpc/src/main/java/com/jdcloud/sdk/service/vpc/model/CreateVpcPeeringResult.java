 ...
 * 创建VpcPeering接口
 */
public class CreateVpcPeeringResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param vpcPeering
     */
    public CreateVpcPeeringResult vpcPeering(VpcPeering vpcPeering) {
        this.vpcPeering = vpcPeering;
        return this;
    }
