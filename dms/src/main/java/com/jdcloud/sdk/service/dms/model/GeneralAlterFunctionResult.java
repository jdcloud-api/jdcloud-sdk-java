 ...
 * 生成修改函数sql语句，支持Mysql
 */
public class GeneralAlterFunctionResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dmsSqls
    */
    public GeneralAlterFunctionResult dmsSqls(List<DmsSql> dmsSqls) {
        this.dmsSqls = dmsSqls;
        return this;
    }
