 ...
 * 生产创建事件SQL语句，支持Mysql
 */
public class GeneralCreateEventResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dmsSqls
    */
    public GeneralCreateEventResult dmsSqls(List<DmsSql> dmsSqls) {
        this.dmsSqls = dmsSqls;
        return this;
    }
