 ...
 * 生成删除函数sql语句，支持Mysql
 */
public class GeneralDropFunctionResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dmsSqls
    */
    public GeneralDropFunctionResult dmsSqls(List<DmsSql> dmsSqls) {
        this.dmsSqls = dmsSqls;
        return this;
    }
