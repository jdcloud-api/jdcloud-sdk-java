 ...
 */
public class GeneralCreateProcedureRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param dataSourceId
     */
    public GeneralCreateProcedureRequest dataSourceId(Integer dataSourceId) {
        this.dataSourceId = dataSourceId;
        return this;
    }
     ...
     * @param dbName
     */
    public GeneralCreateProcedureRequest dbName(String dbName) {
        this.dbName = dbName;
        return this;
    }
     ...
     * @param procedureName
     */
    public GeneralCreateProcedureRequest procedureName(String procedureName) {
        this.procedureName = procedureName;
        return this;
    }
     ...
     * @param procedureSecurity
     */
    public GeneralCreateProcedureRequest procedureSecurity(String procedureSecurity) {
        this.procedureSecurity = procedureSecurity;
        return this;
    }
     ...
     * @param dataAccess
     */
    public GeneralCreateProcedureRequest dataAccess(String dataAccess) {
        this.dataAccess = dataAccess;
        return this;
    }
     ...
     * @param deterministic
     */
    public GeneralCreateProcedureRequest deterministic(Boolean deterministic) {
        this.deterministic = deterministic;
        return this;
    }
     ...
     * @param definitionSql
     */
    public GeneralCreateProcedureRequest definitionSql(String definitionSql) {
        this.definitionSql = definitionSql;
        return this;
    }
    ...
    * @param parameters
    */
    public GeneralCreateProcedureRequest parameters(List<Parameter> parameters) {
        this.parameters = parameters;
        return this;
    }
     ...
     * @param definer
     */
    public GeneralCreateProcedureRequest definer(String definer) {
        this.definer = definer;
        return this;
    }
     ...
     * @param comment
     */
    public GeneralCreateProcedureRequest comment(String comment) {
        this.comment = comment;
        return this;
    }
     ...
     * @param regionId
     */
    public GeneralCreateProcedureRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
