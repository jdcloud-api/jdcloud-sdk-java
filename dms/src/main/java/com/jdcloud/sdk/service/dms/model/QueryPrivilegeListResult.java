 ...
 * 用户授权信息列表
 */
public class QueryPrivilegeListResult extends JdcloudResult implements java.io.Serializable {
    ...
    */
     ...
     * @param count
     */
    public QueryPrivilegeListResult count(Integer count) {
        this.count = count;
        return this;
    }
     ...
     * @param isAdmin
     */
    public QueryPrivilegeListResult isAdmin(Boolean isAdmin) {
        this.isAdmin = isAdmin;
        return this;
    }
    ...
    * @param dmsPrivilegeVOList
    */
    public QueryPrivilegeListResult dmsPrivilegeVOList(List<DmsPrivilegeVO> dmsPrivilegeVOList) {
        this.dmsPrivilegeVOList = dmsPrivilegeVOList;
        return this;
    }
