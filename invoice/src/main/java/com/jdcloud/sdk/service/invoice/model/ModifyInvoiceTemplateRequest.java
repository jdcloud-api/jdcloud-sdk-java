 ...
 * 修改发票模版
 */
public class ModifyInvoiceTemplateRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param invoiceType
     */
    public ModifyInvoiceTemplateRequest invoiceType(String invoiceType) {
        this.invoiceType = invoiceType;
        return this;
    }
     ...
     * @param invoiceTitle
     */
    public ModifyInvoiceTemplateRequest invoiceTitle(String invoiceTitle) {
        this.invoiceTitle = invoiceTitle;
        return this;
    }
     ...
     * @param invoiceContent
     */
    public ModifyInvoiceTemplateRequest invoiceContent(String invoiceContent) {
        this.invoiceContent = invoiceContent;
        return this;
    }
     ...
     * @param taxId
     */
    public ModifyInvoiceTemplateRequest taxId(String taxId) {
        this.taxId = taxId;
        return this;
    }
     ...
     * @param company
     */
    public ModifyInvoiceTemplateRequest company(String company) {
        this.company = company;
        return this;
    }
     ...
     * @param phone
     */
    public ModifyInvoiceTemplateRequest phone(String phone) {
        this.phone = phone;
        return this;
    }
     ...
     * @param bank
     */
    public ModifyInvoiceTemplateRequest bank(String bank) {
        this.bank = bank;
        return this;
    }
     ...
     * @param account
     */
    public ModifyInvoiceTemplateRequest account(String account) {
        this.account = account;
        return this;
    }
     ...
     * @param address
     */
    public ModifyInvoiceTemplateRequest address(String address) {
        this.address = address;
        return this;
    }
     ...
     * @param email
     */
    public ModifyInvoiceTemplateRequest email(String email) {
        this.email = email;
        return this;
    }
     ...
     * @param mediumType
     */
    public ModifyInvoiceTemplateRequest mediumType(String mediumType) {
        this.mediumType = mediumType;
        return this;
    }
     ...
     * @param regionId
     */
    public ModifyInvoiceTemplateRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
