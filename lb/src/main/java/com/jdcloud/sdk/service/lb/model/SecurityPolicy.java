 ...
 * securityPolicy
 */
public class SecurityPolicy  implements java.io.Serializable {
    ...
    /**
     * 安全策略类型，SYSTEM：系统安全策略，CUSTOM：自定义安全策略
     */
    private String securityPolicyType;

    /**
     * 关联的监听器ID列表，目前安全策略只支持应用型负载均衡的HTTPS和TLS监听器
     */
...
TLS_AES_128_GCM_SHA256
    ...
    /**
     * get 安全策略类型，SYSTEM：系统安全策略，CUSTOM：自定义安全策略
     *
     * @return
     */
    ...
    /**
     * set 安全策略类型，SYSTEM：系统安全策略，CUSTOM：自定义安全策略
     *
     * @param securityPolicyType
     */
    ...
    /**
    * get 关联的监听器ID列表，目前安全策略只支持应用型负载均衡的HTTPS和TLS监听器
    *
    * @return
    */
    ...
    /**
    * set 关联的监听器ID列表，目前安全策略只支持应用型负载均衡的HTTPS和TLS监听器
    *
    * @param listenerIds
    */
...
TLS_AES_128_GCM_SHA256
    ...
    */
     ...
     * @param securityPolicyId
     */
    public SecurityPolicy securityPolicyId(String securityPolicyId) {
        this.securityPolicyId = securityPolicyId;
        return this;
    }
     ...
     * @param securityPolicyName
     */
    public SecurityPolicy securityPolicyName(String securityPolicyName) {
        this.securityPolicyName = securityPolicyName;
        return this;
    }
     ...
     * @param securityPolicyType
     */
    public SecurityPolicy securityPolicyType(String securityPolicyType) {
        this.securityPolicyType = securityPolicyType;
        return this;
    }
    ...
    * @param listenerIds
    */
    public SecurityPolicy listenerIds(List<String> listenerIds) {
        this.listenerIds = listenerIds;
        return this;
    }
    ...
    * @param protocols
    */
    public SecurityPolicy protocols(List<String> protocols) {
        this.protocols = protocols;
        return this;
    }
...
TLS_AES_128_GCM_SHA256
    ...
    * @param ciphers
    */
    public SecurityPolicy ciphers(List<String> ciphers) {
        this.ciphers = ciphers;
        return this;
    }
     ...
     * @param createdTime
     */
    public SecurityPolicy createdTime(String createdTime) {
        this.createdTime = createdTime;
        return this;
    }
    ...
    /**
     * add item to 关联的监听器ID列表，目前安全策略只支持应用型负载均衡的HTTPS和TLS监听器
     *
     * @param listenerId
     */
