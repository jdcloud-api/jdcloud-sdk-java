 ...
 * 修改一个后端服务的信息
 */
public class UpdateBackendRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param backendName
     */
    public UpdateBackendRequest backendName(String backendName) {
        this.backendName = backendName;
        return this;
    }
     ...
     * @param healthCheckSpec
     */
    public UpdateBackendRequest healthCheckSpec(HealthCheckSpec healthCheckSpec) {
        this.healthCheckSpec = healthCheckSpec;
        return this;
    }
     ...
     * @param algorithm
     */
    public UpdateBackendRequest algorithm(String algorithm) {
        this.algorithm = algorithm;
        return this;
    }
    ...
    * @param targetGroupIds
    */
    public UpdateBackendRequest targetGroupIds(List<String> targetGroupIds) {
        this.targetGroupIds = targetGroupIds;
        return this;
    }
    ...
    * @param agIds
    */
    public UpdateBackendRequest agIds(List<String> agIds) {
        this.agIds = agIds;
        return this;
    }
    ...
    * @param agInfoSpec
    */
    public UpdateBackendRequest agInfoSpec(List<AgInfoSpec> agInfoSpec) {
        this.agInfoSpec = agInfoSpec;
        return this;
    }
     ...
     * @param proxyProtocol
     */
    public UpdateBackendRequest proxyProtocol(Boolean proxyProtocol) {
        this.proxyProtocol = proxyProtocol;
        return this;
    }
     ...
     * @param description
     */
    public UpdateBackendRequest description(String description) {
        this.description = description;
        return this;
    }
     ...
     * @param sessionStickiness
     */
    public UpdateBackendRequest sessionStickiness(Boolean sessionStickiness) {
        this.sessionStickiness = sessionStickiness;
        return this;
    }
     ...
     * @param sessionStickyTimeout
     */
    public UpdateBackendRequest sessionStickyTimeout(Integer sessionStickyTimeout) {
        this.sessionStickyTimeout = sessionStickyTimeout;
        return this;
    }
     ...
     * @param connectionDrainingSeconds
     */
    public UpdateBackendRequest connectionDrainingSeconds(Integer connectionDrainingSeconds) {
        this.connectionDrainingSeconds = connectionDrainingSeconds;
        return this;
    }
     ...
     * @param httpCookieExpireSeconds
     */
    public UpdateBackendRequest httpCookieExpireSeconds(Integer httpCookieExpireSeconds) {
        this.httpCookieExpireSeconds = httpCookieExpireSeconds;
        return this;
    }
     ...
     * @param httpForwardedProtocol
     */
    public UpdateBackendRequest httpForwardedProtocol(Boolean httpForwardedProtocol) {
        this.httpForwardedProtocol = httpForwardedProtocol;
        return this;
    }
     ...
     * @param httpForwardedPort
     */
    public UpdateBackendRequest httpForwardedPort(Boolean httpForwardedPort) {
        this.httpForwardedPort = httpForwardedPort;
        return this;
    }
     ...
     * @param httpForwardedHost
     */
    public UpdateBackendRequest httpForwardedHost(Boolean httpForwardedHost) {
        this.httpForwardedHost = httpForwardedHost;
        return this;
    }
     ...
     * @param closeHealthCheck
     */
    public UpdateBackendRequest closeHealthCheck(Boolean closeHealthCheck) {
        this.closeHealthCheck = closeHealthCheck;
        return this;
    }
     ...
     * @param regionId
     */
    public UpdateBackendRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param backendId
     */
    public UpdateBackendRequest backendId(String backendId) {
        this.backendId = backendId;
        return this;
    }
