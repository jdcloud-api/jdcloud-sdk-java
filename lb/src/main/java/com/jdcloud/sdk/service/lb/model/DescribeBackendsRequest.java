 ...
 * 查询后端服务列表
 */
public class DescribeBackendsRequest extends JdcloudRequest implements java.io.Serializable {
...
protocol - 后端服务的协议【alb】支持Http、Tcp和Udp，【nlb】支持Tcp、Udp，【dnlb】支持Tcp、Udp，默认查询所有，支持单个
    ...
    */
     ...
     * @param pageNumber
     */
    public DescribeBackendsRequest pageNumber(Integer pageNumber) {
        this.pageNumber = pageNumber;
        return this;
    }
     ...
     * @param pageSize
     */
    public DescribeBackendsRequest pageSize(Integer pageSize) {
        this.pageSize = pageSize;
        return this;
    }
...
protocol - 后端服务的协议【alb】支持Http、Tcp和Udp，【nlb】支持Tcp、Udp，【dnlb】支持Tcp、Udp，默认查询所有，支持单个
    ...
    */
     ...
     * @param regionId
     */
    public DescribeBackendsRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
    ...
    /**
     * add item to backendIds - 后端服务Id列表，支持多个
backendNames - 后端服务名字列表，支持多个
loadBalancerId - 负载均衡器Id，支持单个
agId - 可用性组Id，支持单个
loadBalancerType - 负载均衡类型，取值为：alb、nlb、dnlb，默认alb，支持单个
