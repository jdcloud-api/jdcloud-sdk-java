 ...
 * insertHeader
 */
public class InsertHeader  implements java.io.Serializable {
...
2.客户自定义的header值，输入限制：最长128个字符，ASCII码值ch &gt;&#x3D; 32 &amp;&amp; ch &lt; 127范围内的可打印字符，字母区分大小写，开头和结尾不能为空格
     ...
     * @param valueType
     */
    public InsertHeader valueType(Integer valueType) {
        this.valueType = valueType;
        return this;
    }
...
2.部分http标准header：connection、upgrade、content-length、transfer-encoding、keep-alive、te、host、cookie
     ...
     * @param key
     */
    public InsertHeader key(String key) {
        this.key = key;
        return this;
    }
...
2.客户自定义的header值，输入限制：最长128个字符，ASCII码值ch &gt;&#x3D; 32 &amp;&amp; ch &lt; 127范围内的可打印字符，字母区分大小写，开头和结尾不能为空格
     ...
     * @param value
     */
    public InsertHeader value(String value) {
        this.value = value;
        return this;
    }
