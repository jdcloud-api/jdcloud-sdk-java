 ...
 */
class DeRegisterTargetsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/targetGroups/{targetGroupId}:deregisterTargets";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DeRegisterTargetsResponse.class;
    }
}
