 ...
 * addDomainScdn
 */
public class AddDomainScdn  implements java.io.Serializable {
    ...
    */
     ...
     * @param wafInstanceId
     */
    public AddDomainScdn wafInstanceId(String wafInstanceId) {
        this.wafInstanceId = wafInstanceId;
        return this;
    }
     ...
     * @param domain
     */
    public AddDomainScdn domain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    * @param domains
    */
    public AddDomainScdn domains(List<String> domains) {
        this.domains = domains;
        return this;
    }
    ...
    * @param protocols
    */
    public AddDomainScdn protocols(List<String> protocols) {
        this.protocols = protocols;
        return this;
    }
    ...
    * @param sslProtocols
    */
    public AddDomainScdn sslProtocols(List<String> sslProtocols) {
        this.sslProtocols = sslProtocols;
        return this;
    }
     ...
     * @param lbType
     */
    public AddDomainScdn lbType(String lbType) {
        this.lbType = lbType;
        return this;
    }
     ...
     * @param rsConfig
     */
    public AddDomainScdn rsConfig(RsConfig rsConfig) {
        this.rsConfig = rsConfig;
        return this;
    }
     ...
     * @param pureClient
     */
    public AddDomainScdn pureClient(Integer pureClient) {
        this.pureClient = pureClient;
        return this;
    }
     ...
     * @param httpsRedirect
     */
    public AddDomainScdn httpsRedirect(Integer httpsRedirect) {
        this.httpsRedirect = httpsRedirect;
        return this;
    }
     ...
     * @param rsOnlySupportHttp
     */
    public AddDomainScdn rsOnlySupportHttp(Integer rsOnlySupportHttp) {
        this.rsOnlySupportHttp = rsOnlySupportHttp;
        return this;
    }
     ...
     * @param gmCertSupport
     */
    public AddDomainScdn gmCertSupport(Integer gmCertSupport) {
        this.gmCertSupport = gmCertSupport;
        return this;
    }
     ...
     * @param httpVersion
     */
    public AddDomainScdn httpVersion(String httpVersion) {
        this.httpVersion = httpVersion;
        return this;
    }
     ...
     * @param enableKeepalive
     */
    public AddDomainScdn enableKeepalive(Integer enableKeepalive) {
        this.enableKeepalive = enableKeepalive;
        return this;
    }
     ...
     * @param suiteLevel
     */
    public AddDomainScdn suiteLevel(Integer suiteLevel) {
        this.suiteLevel = suiteLevel;
        return this;
    }
    ...
    * @param userSuiteLevel
    */
    public AddDomainScdn userSuiteLevel(List<String> userSuiteLevel) {
        this.userSuiteLevel = userSuiteLevel;
        return this;
    }
     ...
     * @param enableUnderscores
     */
    public AddDomainScdn enableUnderscores(Integer enableUnderscores) {
        this.enableUnderscores = enableUnderscores;
        return this;
    }
     ...
     * @param disableHealthCheck
     */
    public AddDomainScdn disableHealthCheck(Integer disableHealthCheck) {
        this.disableHealthCheck = disableHealthCheck;
        return this;
    }
     ...
     * @param proxyConnectTimeout
     */
    public AddDomainScdn proxyConnectTimeout(Integer proxyConnectTimeout) {
        this.proxyConnectTimeout = proxyConnectTimeout;
        return this;
    }
     ...
     * @param backSource
     */
    public AddDomainScdn backSource(Integer backSource) {
        this.backSource = backSource;
        return this;
    }
