 ...
 * 启动迁移job，开始迁移数据
 */
public class StartMigrationJobRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param regionId
     */
    public StartMigrationJobRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param instanceId
     */
    public StartMigrationJobRequest instanceId(String instanceId) {
        this.instanceId = instanceId;
        return this;
    }
