 ...
 * 关闭实例的访问控制规则总开关
 */
class DisableInstanceAclExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}:disableInstanceAcl";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DisableInstanceAclResponse.class;
    }
}
