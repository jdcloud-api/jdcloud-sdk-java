 ...
 * 打开实例的访问控制规则总开关
 */
class EnableInstanceAclExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}:enableInstanceAcl";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return EnableInstanceAclResponse.class;
    }
}
