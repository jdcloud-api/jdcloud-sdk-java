 ...
 * createAclSpec
 */
public class CreateAclSpec  implements java.io.Serializable {
     ...
     * @param priority
     */
    public CreateAclSpec priority(Integer priority) {
        this.priority = priority;
        return this;
    }
     ...
     * @param sipType
     */
    public CreateAclSpec sipType(Integer sipType) {
        this.sipType = sipType;
        return this;
    }
     ...
     * @param sip
     */
    public CreateAclSpec sip(String sip) {
        this.sip = sip;
        return this;
    }
     ...
     * @param sipIpSetId
     */
    public CreateAclSpec sipIpSetId(String sipIpSetId) {
        this.sipIpSetId = sipIpSetId;
        return this;
    }
     ...
     * @param dipType
     */
    public CreateAclSpec dipType(Integer dipType) {
        this.dipType = dipType;
        return this;
    }
     ...
     * @param dip
     */
    public CreateAclSpec dip(String dip) {
        this.dip = dip;
        return this;
    }
     ...
     * @param dipIpSetId
     */
    public CreateAclSpec dipIpSetId(String dipIpSetId) {
        this.dipIpSetId = dipIpSetId;
        return this;
    }
     ...
     * @param protocol
     */
    public CreateAclSpec protocol(String protocol) {
        this.protocol = protocol;
        return this;
    }
     ...
     * @param portType
     */
    public CreateAclSpec portType(Integer portType) {
        this.portType = portType;
        return this;
    }
     ...
     * @param port
     */
    public CreateAclSpec port(String port) {
        this.port = port;
        return this;
    }
     ...
     * @param portSetId
     */
    public CreateAclSpec portSetId(String portSetId) {
        this.portSetId = portSetId;
        return this;
    }
     ...
     * @param action
     */
    public CreateAclSpec action(Integer action) {
        this.action = action;
        return this;
    }
     ...
     * @param remark
     */
    public CreateAclSpec remark(String remark) {
        this.remark = remark;
        return this;
    }
