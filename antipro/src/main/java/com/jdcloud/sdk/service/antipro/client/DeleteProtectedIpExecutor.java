 ...
 * 删除防护包防护 IP
 */
class DeleteProtectedIpExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}:deleteProtectedIp";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DeleteProtectedIpResponse.class;
    }
}
