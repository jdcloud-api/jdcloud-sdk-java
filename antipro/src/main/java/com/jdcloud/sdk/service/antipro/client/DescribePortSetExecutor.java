 ...
 * 查询实例的端口库
 */
class DescribePortSetExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}/portSets/{portSetId}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribePortSetResponse.class;
    }
}
