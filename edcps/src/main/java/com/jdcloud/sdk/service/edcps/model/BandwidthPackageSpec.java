 ...
 */
public class BandwidthPackageSpec  implements java.io.Serializable {
     ...
     * @param name
     */
    public BandwidthPackageSpec name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param bandwidth
     */
    public BandwidthPackageSpec bandwidth(Integer bandwidth) {
        this.bandwidth = bandwidth;
        return this;
    }
     ...
     * @param extraUplinkBandwidth
     */
    public BandwidthPackageSpec extraUplinkBandwidth(Integer extraUplinkBandwidth) {
        this.extraUplinkBandwidth = extraUplinkBandwidth;
        return this;
    }
     ...
     * @param count
     */
    public BandwidthPackageSpec count(Integer count) {
        this.count = count;
        return this;
    }
     ...
     * @param charge
     */
    public BandwidthPackageSpec charge(ChargeSpec charge) {
        this.charge = charge;
        return this;
    }
