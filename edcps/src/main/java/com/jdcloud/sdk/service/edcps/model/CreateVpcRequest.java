...
import com.jdcloud.sdk.service.edcps.model.VpcSpec;
import com.jdcloud.sdk.service.JdcloudRequest;

/**
 * 创建私有网络
 */
public class CreateVpcRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param vpcSpec
     */
    public void setVpcSpec(VpcSpec vpcSpec) {
        this.vpcSpec = vpcSpec;
    }
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param vpcSpec
     */
    public CreateVpcRequest vpcSpec(VpcSpec vpcSpec) {
        this.vpcSpec = vpcSpec;
        return this;
    }
     ...
     * @param regionId
     */
    public CreateVpcRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
