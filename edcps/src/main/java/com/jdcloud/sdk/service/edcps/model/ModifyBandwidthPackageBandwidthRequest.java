 ...
 */
public class ModifyBandwidthPackageBandwidthRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param clientToken
     */
    public ModifyBandwidthPackageBandwidthRequest clientToken(String clientToken) {
        this.clientToken = clientToken;
        return this;
    }
     ...
     * @param bandwidth
     */
    public ModifyBandwidthPackageBandwidthRequest bandwidth(Integer bandwidth) {
        this.bandwidth = bandwidth;
        return this;
    }
     ...
     * @param extraUplinkBandwidth
     */
    public ModifyBandwidthPackageBandwidthRequest extraUplinkBandwidth(Integer extraUplinkBandwidth) {
        this.extraUplinkBandwidth = extraUplinkBandwidth;
        return this;
    }
     ...
     * @param regionId
     */
    public ModifyBandwidthPackageBandwidthRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param bandwidthPackageId
     */
    public ModifyBandwidthPackageBandwidthRequest bandwidthPackageId(String bandwidthPackageId) {
        this.bandwidthPackageId = bandwidthPackageId;
        return this;
    }
