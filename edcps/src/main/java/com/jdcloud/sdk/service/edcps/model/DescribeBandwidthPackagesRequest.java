...
public class DescribeBandwidthPackagesRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    /**
     * get bandwidthPackageId - 共享带宽ID，精确匹配，支持多个
    ...
    /**
     * set bandwidthPackageId - 共享带宽ID，精确匹配，支持多个
     ...
     * @param name
     */
    public DescribeBandwidthPackagesRequest name(String name) {
        this.name = name;
        return this;
    }
    ...
    /**
     * add item to bandwidthPackageId - 共享带宽ID，精确匹配，支持多个
