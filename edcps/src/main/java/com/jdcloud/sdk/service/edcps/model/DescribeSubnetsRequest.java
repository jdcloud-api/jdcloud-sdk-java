...
public class DescribeSubnetsRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param az
     */
    public DescribeSubnetsRequest az(String az) {
        this.az = az;
        return this;
    }
     ...
     * @param name
     */
    public DescribeSubnetsRequest name(String name) {
        this.name = name;
        return this;
    }
    ...
    /**
     * add item to subnetId - 子网ID，精确匹配，支持多个
