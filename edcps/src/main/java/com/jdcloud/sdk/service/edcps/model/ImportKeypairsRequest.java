 ...
 * 导入密钥对
 */
public class ImportKeypairsRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param clientToken
     */
    public ImportKeypairsRequest clientToken(String clientToken) {
        this.clientToken = clientToken;
        return this;
    }
     ...
     * @param name
     */
    public ImportKeypairsRequest name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param publicKey
     */
    public ImportKeypairsRequest publicKey(String publicKey) {
        this.publicKey = publicKey;
        return this;
    }
     ...
     * @param regionId
     */
    public ImportKeypairsRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
