 ...
 * 查询共享带宽库存
 */
class DescribeBandwidthPackageStockExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/bandwidthPackageStock";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeBandwidthPackageStockResponse.class;
    }
}
