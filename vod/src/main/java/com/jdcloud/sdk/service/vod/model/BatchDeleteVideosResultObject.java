...
public class BatchDeleteVideosResultObject  implements java.io.Serializable {
     ...
     * @param okVideoIds
     */
    public BatchDeleteVideosResultObject okVideoIds(List<String> okVideoIds) {
        this.okVideoIds = okVideoIds;
        return this;
    }
     ...
     * @param notFoundVideoIds
     */
    public BatchDeleteVideosResultObject notFoundVideoIds(List<String> notFoundVideoIds) {
        this.notFoundVideoIds = notFoundVideoIds;
        return this;
    }
     ...
     * @param failedVideoIds
     */
    public BatchDeleteVideosResultObject failedVideoIds(List<String> failedVideoIds) {
        this.failedVideoIds = failedVideoIds;
        return this;
    }
