 ...
 * 添加水印
 */
public class CreateWatermarkRequest extends JdcloudRequest implements java.io.Serializable {
...
默认值为 pixel
     ...
     * @param name
     */
    public CreateWatermarkRequest name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param imgUrl
     */
    public CreateWatermarkRequest imgUrl(String imgUrl) {
        this.imgUrl = imgUrl;
        return this;
    }
...
默认值为 pixel
     ...
     * @param widthRef
     */
    public CreateWatermarkRequest widthRef(String widthRef) {
        this.widthRef = widthRef;
        return this;
    }
...
取值说明：
  ...
  vss: 输出水印高度 &#x3D; height * 输出视频短边
     ...
     * @param heightRef
     */
    public CreateWatermarkRequest heightRef(String heightRef) {
        this.heightRef = heightRef;
        return this;
    }
  ...
  RB - 右下
     ...
     * @param position
     */
    public CreateWatermarkRequest position(String position) {
        this.position = position;
        return this;
    }
