 ...
 * 查询水印响应信息
 */
public class WatermarkObject  implements java.io.Serializable {
...
默认值为 pixel
     ...
     * @param id
     */
    public WatermarkObject id(Long id) {
        this.id = id;
        return this;
    }
     ...
     * @param name
     */
    public WatermarkObject name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param imgUrl
     */
    public WatermarkObject imgUrl(String imgUrl) {
        this.imgUrl = imgUrl;
        return this;
    }
...
当 sizeUnit &#x3D; percent 时，取值范围为 [0, 100] 小数
     ...
     * @param width
     */
    public WatermarkObject width(String width) {
        this.width = width;
        return this;
    }
...
当 sizeUnit &#x3D; percent 时，取值范围为 [0, 100] 小数
     ...
     * @param height
     */
    public WatermarkObject height(String height) {
        this.height = height;
        return this;
    }
...
默认值为 pixel
     ...
     * @param sizeUnit
     */
    public WatermarkObject sizeUnit(String sizeUnit) {
        this.sizeUnit = sizeUnit;
        return this;
    }
     ...
     * @param widthRef
     */
    public WatermarkObject widthRef(String widthRef) {
        this.widthRef = widthRef;
        return this;
    }
...
取值说明：
  ...
  vss: 输出水印高度 &#x3D; height * 输出视频短边
     ...
     * @param heightRef
     */
    public WatermarkObject heightRef(String heightRef) {
        this.heightRef = heightRef;
        return this;
    }
  ...
  RB - 右下
     ...
     * @param position
     */
    public WatermarkObject position(String position) {
        this.position = position;
        return this;
    }
...
当 offsetUnit &#x3D; percent 时，取值范围为 [0, 100] 小数
     ...
     * @param offsetX
     */
    public WatermarkObject offsetX(String offsetX) {
        this.offsetX = offsetX;
        return this;
    }
...
当 offsetUnit &#x3D; percent 时，取值范围为 [0, 100] 小数
     ...
     * @param offsetY
     */
    public WatermarkObject offsetY(String offsetY) {
        this.offsetY = offsetY;
        return this;
    }
...
默认值为 pixel
     ...
     * @param offsetUnit
     */
    public WatermarkObject offsetUnit(String offsetUnit) {
        this.offsetUnit = offsetUnit;
        return this;
    }
     ...
     * @param createTime
     */
    public WatermarkObject createTime(String createTime) {
        this.createTime = createTime;
        return this;
    }
     ...
     * @param updateTime
     */
    public WatermarkObject updateTime(String updateTime) {
        this.updateTime = updateTime;
        return this;
    }
