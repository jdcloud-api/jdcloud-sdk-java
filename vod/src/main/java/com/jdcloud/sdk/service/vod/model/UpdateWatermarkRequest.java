...
默认值为 pixel
     ...
     * @param sizeUnit
     */
    public UpdateWatermarkRequest sizeUnit(String sizeUnit) {
        this.sizeUnit = sizeUnit;
        return this;
    }
     ...
     * @param widthRef
     */
    public UpdateWatermarkRequest widthRef(String widthRef) {
        this.widthRef = widthRef;
        return this;
    }
...
取值说明：
  ...
  vss: 输出水印高度 &#x3D; height * 输出视频短边
     ...
     * @param heightRef
     */
    public UpdateWatermarkRequest heightRef(String heightRef) {
        this.heightRef = heightRef;
        return this;
    }
...
当 offsetUnit &#x3D; percent 时，取值范围为 [0, 100] 小数
     ...
     * @param offsetX
     */
    public UpdateWatermarkRequest offsetX(String offsetX) {
        this.offsetX = offsetX;
        return this;
    }
...
当 offsetUnit &#x3D; percent 时，取值范围为 [0, 100] 小数
     ...
     * @param offsetY
     */
    public UpdateWatermarkRequest offsetY(String offsetY) {
        this.offsetY = offsetY;
        return this;
    }
...
默认值为 pixel
     ...
     * @param offsetUnit
     */
    public UpdateWatermarkRequest offsetUnit(String offsetUnit) {
        this.offsetUnit = offsetUnit;
        return this;
    }
