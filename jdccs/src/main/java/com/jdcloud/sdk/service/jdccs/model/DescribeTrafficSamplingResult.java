...
import com.jdcloud.sdk.service.jdccs.model.TrafficSamplingData;
import com.jdcloud.sdk.service.JdcloudResult;

/**
 * 根据IP网段查询流量采样数据
 */
public class DescribeTrafficSamplingResult extends JdcloudResult implements java.io.Serializable {
    ...
    */
     ...
     * @param data
     */
    public void addData(TrafficSamplingData data) {
        if (this.data == null) {
