 ...
 */
public class DeviceDataRiskOfWeek  implements java.io.Serializable {
     ...
     * @param allDevice
     */
    public DeviceDataRiskOfWeek allDevice(Integer allDevice) {
        this.allDevice = allDevice;
        return this;
    }
     ...
     * @param normal
     */
    public DeviceDataRiskOfWeek normal(Integer normal) {
        this.normal = normal;
        return this;
    }
     ...
     * @param tuoJiGua
     */
    public DeviceDataRiskOfWeek tuoJiGua(Integer tuoJiGua) {
        this.tuoJiGua = tuoJiGua;
        return this;
    }
     ...
     * @param forgery
     */
    public DeviceDataRiskOfWeek forgery(Integer forgery) {
        this.forgery = forgery;
        return this;
    }
     ...
     * @param cloudPhone
     */
    public DeviceDataRiskOfWeek cloudPhone(Integer cloudPhone) {
        this.cloudPhone = cloudPhone;
        return this;
    }
     ...
     * @param root
     */
    public DeviceDataRiskOfWeek root(Integer root) {
        this.root = root;
        return this;
    }
     ...
     * @param hook
     */
    public DeviceDataRiskOfWeek hook(Integer hook) {
        this.hook = hook;
        return this;
    }
     ...
     * @param duoKai
     */
    public DeviceDataRiskOfWeek duoKai(Integer duoKai) {
        this.duoKai = duoKai;
        return this;
    }
     ...
     * @param moNi
     */
    public DeviceDataRiskOfWeek moNi(Integer moNi) {
        this.moNi = moNi;
        return this;
    }
     ...
     * @param start
     */
    public DeviceDataRiskOfWeek start(String start) {
        this.start = start;
        return this;
    }
     ...
     * @param end
     */
    public DeviceDataRiskOfWeek end(String end) {
        this.end = end;
        return this;
    }
