 ...
 * 查询转码流观看人数
 */
public class DescribeLiveTranscodeStreamPlayerUserNumResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param dataList
     */
    public DescribeLiveTranscodeStreamPlayerUserNumResult dataList(List<LiveStreamUserNumResult> dataList) {
        this.dataList = dataList;
        return this;
    }
