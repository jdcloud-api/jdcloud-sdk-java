 ...
 */
public class DescribeLiveStreamBandwidthDataRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    /**
     * get 播放域名，可以通过指定域名查询该域名下产生的带宽数据。
    ...
    /**
     * set 播放域名，可以通过指定域名查询该域名下产生的带宽数据。
    ...
    /**
     * get 流名称，将流名称作为查询条件时须指定域名和AppName。
    ...
    /**
     * set 流名称，将流名称作为查询条件时须指定域名和AppName。
     ...
     * @param domainName
     */
    public DescribeLiveStreamBandwidthDataRequest domainName(String domainName) {
        this.domainName = domainName;
        return this;
    }
     ...
     * @param appName
     */
    public DescribeLiveStreamBandwidthDataRequest appName(String appName) {
        this.appName = appName;
        return this;
    }
     ...
     * @param streamName
     */
    public DescribeLiveStreamBandwidthDataRequest streamName(String streamName) {
        this.streamName = streamName;
        return this;
    }
     ...
     * @param ispName
     */
    public DescribeLiveStreamBandwidthDataRequest ispName(String ispName) {
        this.ispName = ispName;
        return this;
    }
     ...
     * @param locationName
     */
    public DescribeLiveStreamBandwidthDataRequest locationName(String locationName) {
        this.locationName = locationName;
        return this;
    }
     ...
     * @param protocolType
     */
    public DescribeLiveStreamBandwidthDataRequest protocolType(String protocolType) {
        this.protocolType = protocolType;
        return this;
    }
     ...
     * @param period
     */
    public DescribeLiveStreamBandwidthDataRequest period(String period) {
        this.period = period;
        return this;
    }
     ...
     * @param startTime
     */
    public DescribeLiveStreamBandwidthDataRequest startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public DescribeLiveStreamBandwidthDataRequest endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
