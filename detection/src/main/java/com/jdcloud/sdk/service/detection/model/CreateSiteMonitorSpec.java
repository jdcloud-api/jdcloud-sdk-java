 ...
 */
public class CreateSiteMonitorSpec  implements java.io.Serializable {
     ...
     * @param address
     */
    public CreateSiteMonitorSpec address(String address) {
        this.address = address;
        return this;
    }
     ...
     * @param advanceChecked
     */
    public CreateSiteMonitorSpec advanceChecked(String advanceChecked) {
        this.advanceChecked = advanceChecked;
        return this;
    }
     ...
     * @param createdTime
     */
    public CreateSiteMonitorSpec createdTime(Long createdTime) {
        this.createdTime = createdTime;
        return this;
    }
     ...
     * @param cycle
     */
    public CreateSiteMonitorSpec cycle(Long cycle) {
        this.cycle = cycle;
        return this;
    }
     ...
     * @param defaultSource
     */
    public CreateSiteMonitorSpec defaultSource(String defaultSource) {
        this.defaultSource = defaultSource;
        return this;
    }
     ...
     * @param dnsOption
     */
    public CreateSiteMonitorSpec dnsOption(SiteMonitorDnsOption dnsOption) {
        this.dnsOption = dnsOption;
        return this;
    }
     ...
     * @param enabled
     */
    public CreateSiteMonitorSpec enabled(String enabled) {
        this.enabled = enabled;
        return this;
    }
     ...
     * @param hawkeyeId
     */
    public CreateSiteMonitorSpec hawkeyeId(Long hawkeyeId) {
        this.hawkeyeId = hawkeyeId;
        return this;
    }
     ...
     * @param httpOption
     */
    public CreateSiteMonitorSpec httpOption(SiteMonitorHttpOption httpOption) {
        this.httpOption = httpOption;
        return this;
    }
     ...
     * @param id
     */
    public CreateSiteMonitorSpec id(String id) {
        this.id = id;
        return this;
    }
     ...
     * @param isDeleted
     */
    public CreateSiteMonitorSpec isDeleted(String isDeleted) {
        this.isDeleted = isDeleted;
        return this;
    }
     ...
     * @param name
     */
    public CreateSiteMonitorSpec name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param pin
     */
    public CreateSiteMonitorSpec pin(String pin) {
        this.pin = pin;
        return this;
    }
     ...
     * @param pingOption
     */
    public CreateSiteMonitorSpec pingOption(SiteMonitorPingOption pingOption) {
        this.pingOption = pingOption;
        return this;
    }
     ...
     * @param pop3Option
     */
    public CreateSiteMonitorSpec pop3Option(SiteMonitorPop3Option pop3Option) {
        this.pop3Option = pop3Option;
        return this;
    }
     ...
     * @param port
     */
    public CreateSiteMonitorSpec port(String port) {
        this.port = port;
        return this;
    }
     ...
     * @param source
     */
    public CreateSiteMonitorSpec source(List<SiteMonitorSource> source) {
        this.source = source;
        return this;
    }
     ...
     * @param stats
     */
    public CreateSiteMonitorSpec stats(Object stats) {
        this.stats = stats;
        return this;
    }
     ...
     * @param udpOption
     */
    public CreateSiteMonitorSpec udpOption(SiteMonitorUdpOption udpOption) {
        this.udpOption = udpOption;
        return this;
    }
     ...
     * @param updatedTime
     */
    public CreateSiteMonitorSpec updatedTime(Long updatedTime) {
        this.updatedTime = updatedTime;
        return this;
    }
