...
public class SiteMonitor  implements java.io.Serializable {
    ...
    /**
     * get 可选值：HTTP、PING 、TCP 、UDP、DNS、SMTP、POP3和FTP
     *
     * @return
     */
    ...
    /**
     * set 可选值：HTTP、PING 、TCP 、UDP、DNS、SMTP、POP3和FTP
     *
     * @param taskType
     */
     ...
     * @param dnsOption
     */
    public SiteMonitor dnsOption(SiteMonitorDnsOption dnsOption) {
        this.dnsOption = dnsOption;
        return this;
    }
     ...
     * @param pingOption
     */
    public SiteMonitor pingOption(SiteMonitorPingOption pingOption) {
        this.pingOption = pingOption;
        return this;
    }
     ...
     * @param pop3Option
     */
    public SiteMonitor pop3Option(SiteMonitorPop3Option pop3Option) {
        this.pop3Option = pop3Option;
        return this;
    }
