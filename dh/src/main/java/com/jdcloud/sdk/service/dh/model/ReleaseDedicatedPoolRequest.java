...
专有宿主机池中必须没有专有宿主机时才可释放。
 [MFA enabled]
 */
public class ReleaseDedicatedPoolRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param regionId
     */
    public ReleaseDedicatedPoolRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param dedicatedPoolId
     */
    public ReleaseDedicatedPoolRequest dedicatedPoolId(String dedicatedPoolId) {
        this.dedicatedPoolId = dedicatedPoolId;
        return this;
    }
