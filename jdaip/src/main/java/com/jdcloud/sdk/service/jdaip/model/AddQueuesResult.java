 ...
 */
public class AddQueuesResult extends JdcloudResult implements java.io.Serializable {
    ...
    *
    * @param queueIds 
    * @return AddQueuesResult
    */
    public AddQueuesResult queueIds(List<String> queueIds) {
        this.queueIds = queueIds;
        return this;
    }
