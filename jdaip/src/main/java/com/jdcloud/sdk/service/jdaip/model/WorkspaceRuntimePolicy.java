...
/**
 * 工作空间配置notebook关机策略-运行策略。
 */
public class WorkspaceRuntimePolicy  implements java.io.Serializable {
...
- joybuilder-exclusive-queue 专享队列
    ...
    */
     ...
     */
    public WorkspaceRuntimePolicy runtimeHour(Integer runtimeHour) {
        this.runtimeHour = runtimeHour;
        return this;
    }
...
- joybuilder-exclusive-queue 专享队列
    ...
    * @return WorkspaceRuntimePolicy
    */
    public WorkspaceRuntimePolicy queueIds(List<String> queueIds) {
        this.queueIds = queueIds;
        return this;
    }
