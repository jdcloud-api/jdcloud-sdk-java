 ...
 * 查询账单资源汇总数据V2版本
 */
public class DescribeBillSummarysResult extends JdcloudResult implements java.io.Serializable {
    ...
    */
     ...
     * @param pagination
     */
    public DescribeBillSummarysResult pagination(Pagination pagination) {
        this.pagination = pagination;
        return this;
    }
    ...
    * @param result
    */
    public DescribeBillSummarysResult result(List<BillSummaryV2> result) {
        this.result = result;
        return this;
    }
