 ...
 * 查询资源单列表接口，不含已删除资源
 */
public class GetExpiringOrdersRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param id
     */
    public GetExpiringOrdersRequest id(Integer id) {
        this.id = id;
        return this;
    }
     ...
     * @param pin
     */
    public GetExpiringOrdersRequest pin(String pin) {
        this.pin = pin;
        return this;
    }
     ...
     * @param resourceId
     */
    public GetExpiringOrdersRequest resourceId(String resourceId) {
        this.resourceId = resourceId;
        return this;
    }
     ...
     * @param appCode
     */
    public GetExpiringOrdersRequest appCode(String appCode) {
        this.appCode = appCode;
        return this;
    }
     ...
     * @param serviceCodeList
     */
    public GetExpiringOrdersRequest serviceCodeList(List<String> serviceCodeList) {
        this.serviceCodeList = serviceCodeList;
        return this;
    }
     ...
     * @param region
     */
    public GetExpiringOrdersRequest region(String region) {
        this.region = region;
        return this;
    }
     ...
     * @param networkOperator
     */
    public GetExpiringOrdersRequest networkOperator(Integer networkOperator) {
        this.networkOperator = networkOperator;
        return this;
    }
     ...
     * @param billingType
     */
    public GetExpiringOrdersRequest billingType(Integer billingType) {
        this.billingType = billingType;
        return this;
    }
     ...
     * @param resourceIdList
     */
    public GetExpiringOrdersRequest resourceIdList(List<String> resourceIdList) {
        this.resourceIdList = resourceIdList;
        return this;
    }
     ...
     * @param expireInDays
     */
    public GetExpiringOrdersRequest expireInDays(Integer expireInDays) {
        this.expireInDays = expireInDays;
        return this;
    }
     ...
     * @param isOnTrial
     */
    public GetExpiringOrdersRequest isOnTrial(Integer isOnTrial) {
        this.isOnTrial = isOnTrial;
        return this;
    }
     ...
     * @param site
     */
    public GetExpiringOrdersRequest site(Integer site) {
        this.site = site;
        return this;
    }
     ...
     * @param status
     */
    public GetExpiringOrdersRequest status(Integer status) {
        this.status = status;
        return this;
    }
     ...
     * @param billingStatus
     */
    public GetExpiringOrdersRequest billingStatus(Integer billingStatus) {
        this.billingStatus = billingStatus;
        return this;
    }
     ...
     * @param expiringInDays
     */
    public GetExpiringOrdersRequest expiringInDays(Integer expiringInDays) {
        this.expiringInDays = expiringInDays;
        return this;
    }
     ...
     * @param billingTypeList
     */
    public GetExpiringOrdersRequest billingTypeList(List<Number> billingTypeList) {
        this.billingTypeList = billingTypeList;
        return this;
    }
     ...
     * @param transactionNos
     */
    public GetExpiringOrdersRequest transactionNos(List<String> transactionNos) {
        this.transactionNos = transactionNos;
        return this;
    }
     ...
     * @param opTypes
     */
    public GetExpiringOrdersRequest opTypes(List<Number> opTypes) {
        this.opTypes = opTypes;
        return this;
    }
     ...
     * @param startTime
     */
    public GetExpiringOrdersRequest startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public GetExpiringOrdersRequest endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     * @param serviceCode
     */
    public GetExpiringOrdersRequest serviceCode(String serviceCode) {
        this.serviceCode = serviceCode;
        return this;
    }
     ...
     * @param statusList
     */
    public GetExpiringOrdersRequest statusList(List<Number> statusList) {
        this.statusList = statusList;
        return this;
    }
     ...
     * @param excludeResources
     */
    public GetExpiringOrdersRequest excludeResources(List<String> excludeResources) {
        this.excludeResources = excludeResources;
        return this;
    }
     ...
     * @param orderByClaus
     */
    public GetExpiringOrdersRequest orderByClaus(String orderByClaus) {
        this.orderByClaus = orderByClaus;
        return this;
    }
     ...
     * @param node
     */
    public GetExpiringOrdersRequest node(String node) {
        this.node = node;
        return this;
    }
     ...
     * @param departmentId
     */
    public GetExpiringOrdersRequest departmentId(Integer departmentId) {
        this.departmentId = departmentId;
        return this;
    }
     ...
     * @param pinList
     */
    public GetExpiringOrdersRequest pinList(List<String> pinList) {
        this.pinList = pinList;
        return this;
    }
     ...
     * @param isSpecial
     */
    public GetExpiringOrdersRequest isSpecial(Integer isSpecial) {
        this.isSpecial = isSpecial;
        return this;
    }
     ...
     * @param nodeCode
     */
    public GetExpiringOrdersRequest nodeCode(String nodeCode) {
        this.nodeCode = nodeCode;
        return this;
    }
     ...
     * @param timeout
     */
    public GetExpiringOrdersRequest timeout(Integer timeout) {
        this.timeout = timeout;
        return this;
    }
     ...
     * @param pageIndex
     */
    public GetExpiringOrdersRequest pageIndex(Integer pageIndex) {
        this.pageIndex = pageIndex;
        return this;
    }
     ...
     * @param pageSize
     */
    public GetExpiringOrdersRequest pageSize(Integer pageSize) {
        this.pageSize = pageSize;
        return this;
    }
     ...
     * @param offset
     */
    public GetExpiringOrdersRequest offset(Integer offset) {
        this.offset = offset;
        return this;
    }
     ...
     * @param regionId
     */
    public GetExpiringOrdersRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
