 ...
 */
public class ResourceOrderRenewNewVo  implements java.io.Serializable {
    ...
    private List<ResourceTagVo> tag;
    /**
     * 绑定资源
     */
    
    private List<ResourceOrderRenewNewVo> bindResources;
    ...
    * @return
    */
    public List<ResourceTagVo> getTag() {
        return tag;
    }
    ...
    * @param tag
    */
    public void setTag(List<ResourceTagVo> tag) {
        this.tag = tag;
    }
    ...
    * @return
    */
    public List<ResourceOrderRenewNewVo> getBindResources() {
    ...
    * @param bindResources
    */
    public void setBindResources(List<ResourceOrderRenewNewVo> bindResources) {
     ...
     * @param id
     */
    public ResourceOrderRenewNewVo id(Integer id) {
        this.id = id;
        return this;
    }
     ...
     * @param transactionNo
     */
    public ResourceOrderRenewNewVo transactionNo(String transactionNo) {
        this.transactionNo = transactionNo;
        return this;
    }
     ...
     * @param resourceId
     */
    public ResourceOrderRenewNewVo resourceId(String resourceId) {
        this.resourceId = resourceId;
        return this;
    }
     ...
     * @param billingType
     */
    public ResourceOrderRenewNewVo billingType(Integer billingType) {
        this.billingType = billingType;
        return this;
    }
     ...
     * @param timeUnit
     */
    public ResourceOrderRenewNewVo timeUnit(Integer timeUnit) {
        this.timeUnit = timeUnit;
        return this;
    }
     ...
     * @param timeSpan
     */
    public ResourceOrderRenewNewVo timeSpan(Integer timeSpan) {
        this.timeSpan = timeSpan;
        return this;
    }
     ...
     * @param status
     */
    public ResourceOrderRenewNewVo status(Integer status) {
        this.status = status;
        return this;
    }
     ...
     * @param billingStatus
     */
    public ResourceOrderRenewNewVo billingStatus(Integer billingStatus) {
        this.billingStatus = billingStatus;
        return this;
    }
     ...
     * @param networkOperator
     */
    public ResourceOrderRenewNewVo networkOperator(Integer networkOperator) {
        this.networkOperator = networkOperator;
        return this;
    }
     ...
     * @param pin
     */
    public ResourceOrderRenewNewVo pin(String pin) {
        this.pin = pin;
        return this;
    }
     ...
     * @param appCode
     */
    public ResourceOrderRenewNewVo appCode(String appCode) {
        this.appCode = appCode;
        return this;
    }
     ...
     * @param serviceCode
     */
    public ResourceOrderRenewNewVo serviceCode(String serviceCode) {
        this.serviceCode = serviceCode;
        return this;
    }
     ...
     * @param serviceName
     */
    public ResourceOrderRenewNewVo serviceName(String serviceName) {
        this.serviceName = serviceName;
        return this;
    }
     ...
     * @param site
     */
    public ResourceOrderRenewNewVo site(Integer site) {
        this.site = site;
        return this;
    }
     ...
     * @param region
     */
    public ResourceOrderRenewNewVo region(String region) {
        this.region = region;
        return this;
    }
     ...
     * @param regionName
     */
    public ResourceOrderRenewNewVo regionName(String regionName) {
        this.regionName = regionName;
        return this;
    }
    ...
    * @param formula
    */
    public ResourceOrderRenewNewVo formula(List<Formula> formula) {
        this.formula = formula;
        return this;
    }
     ...
     * @param isOnTrial
     */
    public ResourceOrderRenewNewVo isOnTrial(Integer isOnTrial) {
        this.isOnTrial = isOnTrial;
        return this;
    }
     ...
     * @param startTime
     */
    public ResourceOrderRenewNewVo startTime(String startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public ResourceOrderRenewNewVo endTime(String endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     * @param createTime
     */
    public ResourceOrderRenewNewVo createTime(String createTime) {
        this.createTime = createTime;
        return this;
    }
     ...
     * @param payTime
     */
    public ResourceOrderRenewNewVo payTime(String payTime) {
        this.payTime = payTime;
        return this;
    }
     ...
     * @param formulaStr
     */
    public ResourceOrderRenewNewVo formulaStr(String formulaStr) {
        this.formulaStr = formulaStr;
        return this;
    }
     ...
     * @param chargeMode
     */
    public ResourceOrderRenewNewVo chargeMode(Integer chargeMode) {
        this.chargeMode = chargeMode;
        return this;
    }
     ...
     * @param chargeDuration
     */
    public ResourceOrderRenewNewVo chargeDuration(Integer chargeDuration) {
        this.chargeDuration = chargeDuration;
        return this;
    }
     ...
     * @param chargeUnit
     */
    public ResourceOrderRenewNewVo chargeUnit(Integer chargeUnit) {
        this.chargeUnit = chargeUnit;
        return this;
    }
     ...
     * @param aeStatus
     */
    public ResourceOrderRenewNewVo aeStatus(Integer aeStatus) {
        this.aeStatus = aeStatus;
        return this;
    }
     ...
     * @param releasingTime
     */
    public ResourceOrderRenewNewVo releasingTime(String releasingTime) {
        this.releasingTime = releasingTime;
        return this;
    }
     ...
     * @param sourceId
     */
    public ResourceOrderRenewNewVo sourceId(String sourceId) {
        this.sourceId = sourceId;
        return this;
    }
     ...
     * @param billingStartTime
     */
    public ResourceOrderRenewNewVo billingStartTime(String billingStartTime) {
        this.billingStartTime = billingStartTime;
        return this;
    }
     ...
     * @param priceMap
     */
    public ResourceOrderRenewNewVo priceMap(Object priceMap) {
        this.priceMap = priceMap;
        return this;
    }
     ...
     * @param priceSnapshot
     */
    public ResourceOrderRenewNewVo priceSnapshot(String priceSnapshot) {
        this.priceSnapshot = priceSnapshot;
        return this;
    }
     ...
     * @param price
     */
    public ResourceOrderRenewNewVo price(Number price) {
        this.price = price;
        return this;
    }
     ...
     * @param discountedPrice
     */
    public ResourceOrderRenewNewVo discountedPrice(Number discountedPrice) {
        this.discountedPrice = discountedPrice;
        return this;
    }
     ...
     * @param expiringDays
     */
    public ResourceOrderRenewNewVo expiringDays(Integer expiringDays) {
        this.expiringDays = expiringDays;
        return this;
    }
     ...
     * @param billingCategoryDescription
     */
    public ResourceOrderRenewNewVo billingCategoryDescription(String billingCategoryDescription) {
        this.billingCategoryDescription = billingCategoryDescription;
        return this;
    }
     ...
     * @param description
     */
    public ResourceOrderRenewNewVo description(String description) {
        this.description = description;
        return this;
    }
     ...
     * @param refundNo
     */
    public ResourceOrderRenewNewVo refundNo(String refundNo) {
        this.refundNo = refundNo;
        return this;
    }
     ...
     * @param billingTypeName
     */
    public ResourceOrderRenewNewVo billingTypeName(String billingTypeName) {
        this.billingTypeName = billingTypeName;
        return this;
    }
     ...
     * @param favorableInfo
     */
    public ResourceOrderRenewNewVo favorableInfo(String favorableInfo) {
        this.favorableInfo = favorableInfo;
        return this;
    }
     ...
     * @param resourceName
     */
    public ResourceOrderRenewNewVo resourceName(String resourceName) {
        this.resourceName = resourceName;
        return this;
    }
     ...
     * @param processType
     */
    public ResourceOrderRenewNewVo processType(Integer processType) {
        this.processType = processType;
        return this;
    }
     ...
     * @param applicant
     */
    public ResourceOrderRenewNewVo applicant(String applicant) {
        this.applicant = applicant;
        return this;
    }
     ...
     * @param billingMode
     */
    public ResourceOrderRenewNewVo billingMode(Integer billingMode) {
        this.billingMode = billingMode;
        return this;
    }
     ...
     * @param operateTime
     */
    public ResourceOrderRenewNewVo operateTime(String operateTime) {
        this.operateTime = operateTime;
        return this;
    }
     ...
     * @param arrearsType
     */
    public ResourceOrderRenewNewVo arrearsType(Integer arrearsType) {
        this.arrearsType = arrearsType;
        return this;
    }
     ...
     * @param recycleBinReleasingTime
     */
    public ResourceOrderRenewNewVo recycleBinReleasingTime(String recycleBinReleasingTime) {
        this.recycleBinReleasingTime = recycleBinReleasingTime;
        return this;
    }
     ...
     * @param remark
     */
    public ResourceOrderRenewNewVo remark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    * @param tag
    */
    public ResourceOrderRenewNewVo tag(List<ResourceTagVo> tag) {
        this.tag = tag;
        return this;
    }
    ...
    * @param bindResources
    */
    public ResourceOrderRenewNewVo bindResources(List<ResourceOrderRenewNewVo> bindResources) {
        this.bindResources = bindResources;
        return this;
    }
     ...
     * @param tag
     */
    public void addTag(ResourceTagVo tag) {
        if (this.tag == null) {
     ...
     * @param bindResource
     */
    public void addBindResource(ResourceOrderRenewNewVo bindResource) {
