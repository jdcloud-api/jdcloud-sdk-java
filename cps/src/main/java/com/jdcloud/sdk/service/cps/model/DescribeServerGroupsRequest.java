 ...
 * 查询虚拟服务器组列表
 */
public class DescribeServerGroupsRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param name
     */
    public DescribeServerGroupsRequest name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param filters
     */
    public DescribeServerGroupsRequest filters(List<Filter> filters) {
        this.filters = filters;
        return this;
    }
     ...
     * @param regionId
     */
    public DescribeServerGroupsRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
