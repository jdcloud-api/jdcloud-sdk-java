...
- 可调用接口（describeOS）获取云物理服务器支持的操作系统列表
 [MFA enabled]
 */
class ReinstallInstanceExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}:reinstallInstance";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ReinstallInstanceResponse.class;
    }
}
