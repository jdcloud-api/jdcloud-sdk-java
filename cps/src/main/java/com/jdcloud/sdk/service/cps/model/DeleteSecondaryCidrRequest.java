 ...
 * 删除次要CIDR
 */
public class DeleteSecondaryCidrRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param clientToken
     */
    public DeleteSecondaryCidrRequest clientToken(String clientToken) {
        this.clientToken = clientToken;
        return this;
    }
     ...
     * @param regionId
     */
    public DeleteSecondaryCidrRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param secondaryCidrId
     */
    public DeleteSecondaryCidrRequest secondaryCidrId(String secondaryCidrId) {
        this.secondaryCidrId = secondaryCidrId;
        return this;
    }
