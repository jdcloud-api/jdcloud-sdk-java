 ...
 * 解绑弹性公网IP
 */
public class DisassociateElasticIpLBRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param clientToken
     */
    public DisassociateElasticIpLBRequest clientToken(String clientToken) {
        this.clientToken = clientToken;
        return this;
    }
     ...
     * @param elasticIpId
     */
    public DisassociateElasticIpLBRequest elasticIpId(String elasticIpId) {
        this.elasticIpId = elasticIpId;
        return this;
    }
     ...
     * @param regionId
     */
    public DisassociateElasticIpLBRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param loadBalancerId
     */
    public DisassociateElasticIpLBRequest loadBalancerId(String loadBalancerId) {
        this.loadBalancerId = loadBalancerId;
        return this;
    }
