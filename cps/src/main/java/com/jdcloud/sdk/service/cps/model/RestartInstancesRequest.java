 ...
 */
public class RestartInstancesRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param clientToken
     */
    public RestartInstancesRequest clientToken(String clientToken) {
        this.clientToken = clientToken;
        return this;
    }
     ...
     * @param instanceIds
     */
    public RestartInstancesRequest instanceIds(List<String> instanceIds) {
        this.instanceIds = instanceIds;
        return this;
    }
     ...
     * @param regionId
     */
    public RestartInstancesRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
