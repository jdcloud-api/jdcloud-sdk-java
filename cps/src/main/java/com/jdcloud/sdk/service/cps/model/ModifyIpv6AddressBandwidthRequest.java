 ...
 */
public class ModifyIpv6AddressBandwidthRequest extends JdcloudRequest implements java.io.Serializable {
...
如果多个请求使用了相同的clientToken，只会执行第一个请求，之后的请求直接返回第一个请求的结果&lt;br/&gt;
     ...
     * @param clientToken
     */
    public ModifyIpv6AddressBandwidthRequest clientToken(String clientToken) {
        this.clientToken = clientToken;
        return this;
    }
     ...
     * @param regionId
     */
    public ModifyIpv6AddressBandwidthRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param ipv6AddressId
     */
    public ModifyIpv6AddressBandwidthRequest ipv6AddressId(String ipv6AddressId) {
        this.ipv6AddressId = ipv6AddressId;
        return this;
    }
