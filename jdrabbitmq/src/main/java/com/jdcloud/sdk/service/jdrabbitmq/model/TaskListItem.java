...
error - 执行出错。 中间态, 允许重试
     ...
     * set 任务的开始时间(包括变配, 创建, 重启等任务), 时间格式 2022-07-04T09:55:20Z
     *
     * @param taskStartTime 任务的开始时间(包括变配, 创建, 重启等任务), 时间格式 2022-07-04T09:55:20Z
     * @return TaskListItem
     */
     ...
     * set 任务类型(包括但不限于创建、变配、重启 等任务), 用于前端展示使用
     *
     * @param taskType 任务类型(包括但不限于创建、变配、重启 等任务), 用于前端展示使用
     * @return TaskListItem
     */
     ...
     * set 任务类型, 是数字枚举类型, 用于查询过滤条件
     *
     * @param taskOpType 任务类型, 是数字枚举类型, 用于查询过滤条件
     * @return TaskListItem
     */
...
error - 执行出错。 中间态, 允许重试
     ...
     * set 0-100 正整数，任务进度条
     *
     * @param taskProgress 0-100 正整数，任务进度条
     * @return TaskListItem
     */
     ...
     * set 任务的持续运行时间，单位为s（秒）；如果任务成功则返回0
     *
     * @param taskTimeConsuming 任务的持续运行时间，单位为s（秒）；如果任务成功则返回0
     * @return TaskListItem
     */
     ...
     * set 标志任务的持续运行时间(taskTimeConsuming)是否还会继续增加。
     *
     * @param isTaskTimeConsumeContinueIncrease 标志任务的持续运行时间(taskTimeConsuming)是否还会继续增加。
     * @return TaskListItem
     */
     ...
     * set taskStatus&#x3D;&#x3D;error时, 展示错误信息
     *
     * @param taskErrorInfo taskStatus&#x3D;&#x3D;error时, 展示错误信息
     * @return TaskListItem
     */
     ...
     * set 任务的结束时间（包括变配、创建、重启等任务），时间格式 2022-07-04T09:55:20Z
     *
     * @param taskEndTime 任务的结束时间（包括变配、创建、重启等任务），时间格式 2022-07-04T09:55:20Z
     * @return TaskListItem
     */
     ...
     * set 任务是否可以中断, 任务状态从 executing &#x3D;&gt; fail, error &#x3D;&gt; fail, init &#x3D;&gt; fail
     *
     * @param canInterruptTask 任务是否可以中断, 任务状态从 executing &#x3D;&gt; fail, error &#x3D;&gt; fail, init &#x3D;&gt; fail
     * @return TaskListItem
     */
     ...
     * set 任务是否可以重试, 任务状态从 error &#x3D;&gt; executing
     *
     * @param canRetryTask 任务是否可以重试, 任务状态从 error &#x3D;&gt; executing
     * @return TaskListItem
     */
