...
public class Instance  implements java.io.Serializable {
    ...
    */
    ...
    /**
     * get 调用监控时的groupCode,用来区分不同监控指标的实例
     *
     * @return
     */
    ...
    /**
     * set 调用监控时的groupCode,用来区分不同监控指标的实例
     *
     * @param groupCode
     */
     ...
     * set 实例状态，running：运行，error：错误，creating：创建中，changing：变配，stop：停止
     *
     * @param instanceStatus 实例状态，running：运行，error：错误，creating：创建中，changing：变配，stop：停止
     * @return Instance
     */
     ...
     * set 创建时间，遵循ISO8601标准，使用UTC时间，格式为：YYYY-MM-DDTHH:mm:ssZ
     *
     * @param createTime 创建时间，遵循ISO8601标准，使用UTC时间，格式为：YYYY-MM-DDTHH:mm:ssZ
     * @return Instance
     */
    ...
    */
     ...
     * set 调用监控时的groupCode,用来区分不同监控指标的实例
     *
     * @param groupCode 调用监控时的groupCode,用来区分不同监控指标的实例
     * @return Instance
     */
    public Instance groupCode(String groupCode) {
        this.groupCode = groupCode;
        return this;
    }
