...
public class InstanceSpec  implements java.io.Serializable {
    ...
    /**
     * get rabbitmq版本，[1.0.1,0.10.2,2.4,2.6.0]
     *
     * @return
     */
    ...
    /**
     * set rabbitmq版本，[1.0.1,0.10.2,2.4,2.6.0]
     *
    ...
    /**
     * get rabbitmq集群名称，不可为空，只支持大小写字母、数字、英文下划线或者中划线，以字母开头且不能超过32位
     *
     * @return
     */
    ...
    /**
     * set rabbitmq集群名称，不可为空，只支持大小写字母、数字、英文下划线或者中划线，以字母开头且不能超过32位
     *
     * @param instanceName
     */
    ...
    */
     ...
     * set 支持的cpu架构类型, 创建时选择，不选默认创建x86架构的实例
     *
     * @param cpuArch 支持的cpu架构类型, 创建时选择，不选默认创建x86架构的实例
     * @return InstanceSpec
     */
