 ...
 * 停止流水线的一次执行
 */
class StopPipelineInstanceExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/pipeline/{uuid}/instance/{instanceUuid}:stop";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return StopPipelineInstanceResponse.class;
    }
}
