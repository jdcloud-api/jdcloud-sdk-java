 ...
 * 查询流水线执行结果及状态信息
 */
class GetPipelineInstanceExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/pipeline/{uuid}/instance/{instanceUuid}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return GetPipelineInstanceResponse.class;
    }
}
