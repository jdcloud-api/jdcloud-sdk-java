 ...
 * 操作提供商
 */
class GetOperationProvidersExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/options/operationProviders";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return GetOperationProvidersResponse.class;
    }
}
