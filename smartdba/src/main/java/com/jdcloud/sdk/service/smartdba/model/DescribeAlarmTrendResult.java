 ...
 * 获取告警数量，用于趋势展示
 */
public class DescribeAlarmTrendResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param itemData
     */
    public DescribeAlarmTrendResult itemData(List<DataPoint> itemData) {
        this.itemData = itemData;
        return this;
    }
     ...
     * @param metricInfo
     */
    public DescribeAlarmTrendResult metricInfo(Metric metricInfo) {
        this.metricInfo = metricInfo;
        return this;
    }
