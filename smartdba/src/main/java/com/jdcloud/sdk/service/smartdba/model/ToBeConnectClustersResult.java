 ...
 * 获取待接入的mysql实例
 */
public class ToBeConnectClustersResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param totalCount
     */
    public ToBeConnectClustersResult totalCount(Integer totalCount) {
        this.totalCount = totalCount;
        return this;
    }
     ...
     * @param data
     */
    public ToBeConnectClustersResult data(List<InstancesInfo> data) {
        this.data = data;
        return this;
    }
