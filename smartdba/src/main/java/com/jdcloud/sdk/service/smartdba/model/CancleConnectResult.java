 ...
 * 取消实例接入
 */
public class CancleConnectResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param totalCount
     */
    public CancleConnectResult totalCount(Integer totalCount) {
        this.totalCount = totalCount;
        return this;
    }
     ...
     * @param data
     */
    public CancleConnectResult data(List<InstancesInfo> data) {
        this.data = data;
        return this;
    }
