 ...
 * 查询支持自定义的监控指标
 */
public class DescribeSupportMetricsResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param sys
     */
    public DescribeSupportMetricsResult sys(List<SupportMetric> sys) {
        this.sys = sys;
        return this;
    }
     ...
     * @param server
     */
    public DescribeSupportMetricsResult server(List<SupportMetric> server) {
        this.server = server;
        return this;
    }
