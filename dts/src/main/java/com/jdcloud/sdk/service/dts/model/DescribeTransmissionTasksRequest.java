 ...
 * 查询数据传输任务信息
 */
public class DescribeTransmissionTasksRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    * @param tagFilters
    */
    public DescribeTransmissionTasksRequest tagFilters(List<TagFilter> tagFilters) {
        this.tagFilters = tagFilters;
        return this;
    }
    ...
    * @param filters
    */
    public DescribeTransmissionTasksRequest filters(List<Filter> filters) {
        this.filters = filters;
        return this;
    }
    ...
    * @param sorts
    */
    public DescribeTransmissionTasksRequest sorts(List<Sort> sorts) {
        this.sorts = sorts;
        return this;
    }
     ...
     * @param regionId
     */
    public DescribeTransmissionTasksRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
