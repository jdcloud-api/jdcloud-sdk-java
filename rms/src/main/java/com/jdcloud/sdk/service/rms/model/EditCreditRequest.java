 ...
 * 修改富媒体短信资质接口
 */
public class EditCreditRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param signId
     */
    public EditCreditRequest signId(String signId) {
        this.signId = signId;
        return this;
    }
     ...
     * @param appId
     */
    public EditCreditRequest appId(String appId) {
        this.appId = appId;
        return this;
    }
     ...
     * @param name
     */
    public EditCreditRequest name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param description
     */
    public EditCreditRequest description(String description) {
        this.description = description;
        return this;
    }
     ...
     * @param businessLicense
     */
    public EditCreditRequest businessLicense(String businessLicense) {
        this.businessLicense = businessLicense;
        return this;
    }
     ...
     * @param businessLicenseName
     */
    public EditCreditRequest businessLicenseName(String businessLicenseName) {
        this.businessLicenseName = businessLicenseName;
        return this;
    }
     ...
     * @param signedAuthorization
     */
    public EditCreditRequest signedAuthorization(String signedAuthorization) {
        this.signedAuthorization = signedAuthorization;
        return this;
    }
     ...
     * @param signedAuthorizationName
     */
    public EditCreditRequest signedAuthorizationName(String signedAuthorizationName) {
        this.signedAuthorizationName = signedAuthorizationName;
        return this;
    }
     ...
     * @param informationSecurity
     */
    public EditCreditRequest informationSecurity(String informationSecurity) {
        this.informationSecurity = informationSecurity;
        return this;
    }
     ...
     * @param informationSecurityName
     */
    public EditCreditRequest informationSecurityName(String informationSecurityName) {
        this.informationSecurityName = informationSecurityName;
        return this;
    }
     ...
     * @param membershipCertificate
     */
    public EditCreditRequest membershipCertificate(String membershipCertificate) {
        this.membershipCertificate = membershipCertificate;
        return this;
    }
     ...
     * @param membershipCertificateName
     */
    public EditCreditRequest membershipCertificateName(String membershipCertificateName) {
        this.membershipCertificateName = membershipCertificateName;
        return this;
    }
     ...
     * @param otherCertificate
     */
    public EditCreditRequest otherCertificate(String otherCertificate) {
        this.otherCertificate = otherCertificate;
        return this;
    }
     ...
     * @param otherCertificateName
     */
    public EditCreditRequest otherCertificateName(String otherCertificateName) {
        this.otherCertificateName = otherCertificateName;
        return this;
    }
     ...
     * @param regionId
     */
    public EditCreditRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
