 ...
 * 查询绑定部署详情
 */
public class QueryBindGroupPolicyResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param bindGroups
     */
    public QueryBindGroupPolicyResult bindGroups(List<BindGroups> bindGroups) {
        this.bindGroups = bindGroups;
        return this;
    }
