 ...
 * backendConfig
 */
public class BackendConfig  implements java.io.Serializable {
     ...
     * @param backendConfigId
     */
    public BackendConfig backendConfigId(String backendConfigId) {
        this.backendConfigId = backendConfigId;
        return this;
    }
     ...
     * @param baseGroupId
     */
    public BackendConfig baseGroupId(String baseGroupId) {
        this.baseGroupId = baseGroupId;
        return this;
    }
     ...
     * @param environment
     */
    public BackendConfig environment(String environment) {
        this.environment = environment;
        return this;
    }
     ...
     * @param backendUrl
     */
    public BackendConfig backendUrl(String backendUrl) {
        this.backendUrl = backendUrl;
        return this;
    }
     ...
     * @param backendServiceType
     */
    public BackendConfig backendServiceType(String backendServiceType) {
        this.backendServiceType = backendServiceType;
        return this;
    }
     ...
     * @param headerParams
     */
    public BackendConfig headerParams(List<SimpleParameter> headerParams) {
        this.headerParams = headerParams;
        return this;
    }
     ...
     * @param queryParams
     */
    public BackendConfig queryParams(List<SimpleParameter> queryParams) {
        this.queryParams = queryParams;
        return this;
    }
     ...
     * @param description
     */
    public BackendConfig description(String description) {
        this.description = description;
        return this;
    }
     ...
     * @param createTime
     */
    public BackendConfig createTime(Long createTime) {
        this.createTime = createTime;
        return this;
    }
     ...
     * @param sort
     */
    public BackendConfig sort(Integer sort) {
        this.sort = sort;
        return this;
    }
     ...
     * @param userSort
     */
    public BackendConfig userSort(Integer userSort) {
        this.userSort = userSort;
        return this;
    }
     ...
     * @param jdsfId
     */
    public BackendConfig jdsfId(String jdsfId) {
        this.jdsfId = jdsfId;
        return this;
    }
     ...
     * @param jdsfParam
     */
    public BackendConfig jdsfParam(String jdsfParam) {
        this.jdsfParam = jdsfParam;
        return this;
    }
     ...
     * @param jdsfRegion
     */
    public BackendConfig jdsfRegion(String jdsfRegion) {
        this.jdsfRegion = jdsfRegion;
        return this;
    }
     ...
     * @param jdsfPin
     */
    public BackendConfig jdsfPin(String jdsfPin) {
        this.jdsfPin = jdsfPin;
        return this;
    }
