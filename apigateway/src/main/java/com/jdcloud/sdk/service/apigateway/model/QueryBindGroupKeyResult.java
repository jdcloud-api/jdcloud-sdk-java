 ...
 * 查询绑定分组详情
 */
public class QueryBindGroupKeyResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param bindGroups
     */
    public QueryBindGroupKeyResult bindGroups(List<BindGroups> bindGroups) {
        this.bindGroups = bindGroups;
        return this;
    }
