 ...
 * 查询可绑定部署列表
 */
public class QueryAuthGroupListResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param bindGroups
     */
    public QueryAuthGroupListResult bindGroups(List<BindGroups> bindGroups) {
        this.bindGroups = bindGroups;
        return this;
    }
