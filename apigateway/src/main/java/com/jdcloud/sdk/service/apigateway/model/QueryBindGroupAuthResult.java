 ...
 * 查询已绑定详情
 */
public class QueryBindGroupAuthResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param bindGroups
     */
    public QueryBindGroupAuthResult bindGroups(List<BindGroups> bindGroups) {
        this.bindGroups = bindGroups;
        return this;
    }
