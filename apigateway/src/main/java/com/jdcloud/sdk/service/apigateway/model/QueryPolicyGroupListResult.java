 ...
 * 查询可绑定部署列表
 */
public class QueryPolicyGroupListResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param bindGroups
     */
    public QueryPolicyGroupListResult bindGroups(List<BindGroups> bindGroups) {
        this.bindGroups = bindGroups;
        return this;
    }
