 ...
 * 绑定
 */
public class BindGroupPolicyResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param bindGroups
     */
    public BindGroupPolicyResult bindGroups(List<BindGroups> bindGroups) {
        this.bindGroups = bindGroups;
        return this;
    }
