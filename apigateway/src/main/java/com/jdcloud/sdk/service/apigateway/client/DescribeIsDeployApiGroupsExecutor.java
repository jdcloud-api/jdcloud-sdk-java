 ...
 * 查询分组
 */
class DescribeIsDeployApiGroupsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/apiGroups:isDeploy";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeIsDeployApiGroupsResponse.class;
    }
}
