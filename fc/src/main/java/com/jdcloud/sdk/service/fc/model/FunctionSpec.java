...
public class FunctionSpec  implements java.io.Serializable {
    ...
    */
     ...
     * @param functionName
     */
    public FunctionSpec functionName(String functionName) {
        this.functionName = functionName;
        return this;
    }
     ...
     * @param code
     */
    public FunctionSpec code(Code code) {
        this.code = code;
        return this;
    }
     ...
     * @param timeout
     */
    public FunctionSpec timeout(Integer timeout) {
        this.timeout = timeout;
        return this;
    }
     ...
     * @param handler
     */
    public FunctionSpec handler(String handler) {
        this.handler = handler;
        return this;
    }
    ...
    * @param envs
    */
    public FunctionSpec envs(List<Environment> envs) {
        this.envs = envs;
        return this;
    }
     ...
     * @param cpu
     */
    public FunctionSpec cpu(Number cpu) {
        this.cpu = cpu;
        return this;
    }
     ...
     * @param memorySize
     */
    public FunctionSpec memorySize(Integer memorySize) {
        this.memorySize = memorySize;
        return this;
    }
     ...
     * @param diskSize
     */
    public FunctionSpec diskSize(Integer diskSize) {
        this.diskSize = diskSize;
        return this;
    }
