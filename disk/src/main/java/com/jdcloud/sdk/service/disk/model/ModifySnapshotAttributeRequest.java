 ...
 * 修改快照的名字或描述信息
 */
public class ModifySnapshotAttributeRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param name
     */
    public ModifySnapshotAttributeRequest name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param regionId
     */
    public ModifySnapshotAttributeRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
