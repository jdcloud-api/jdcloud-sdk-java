 ...
 * 读取指定ID的运行结果和运行状态
 */
class GetTaskInfoHistoryByIdExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/task_infos/{task}/history";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return GetTaskInfoHistoryByIdResponse.class;
    }
}
