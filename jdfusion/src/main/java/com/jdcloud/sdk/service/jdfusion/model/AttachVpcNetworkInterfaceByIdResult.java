 ...
 * 网卡挂载虚拟机
 */
public class AttachVpcNetworkInterfaceByIdResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param task
     */
    public AttachVpcNetworkInterfaceByIdResult task(ResourceTFInfo task) {
        this.task = task;
        return this;
    }
