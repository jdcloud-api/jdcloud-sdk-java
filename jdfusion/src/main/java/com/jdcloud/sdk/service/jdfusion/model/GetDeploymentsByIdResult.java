 ...
 * 查询部署信息
 */
public class GetDeploymentsByIdResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param deployment
     */
    public GetDeploymentsByIdResult deployment(DeploymentInfo deployment) {
        this.deployment = deployment;
        return this;
    }
