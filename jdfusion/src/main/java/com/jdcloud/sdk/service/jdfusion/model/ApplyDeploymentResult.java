 ...
 * 应用部署
 */
public class ApplyDeploymentResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param deployment
     */
    public ApplyDeploymentResult deployment(DeploymentInfo deployment) {
        this.deployment = deployment;
        return this;
    }
