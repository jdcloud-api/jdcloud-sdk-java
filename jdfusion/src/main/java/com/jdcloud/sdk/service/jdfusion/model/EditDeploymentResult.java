 ...
 * 修改部署信息
 */
public class EditDeploymentResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param deployment
     */
    public EditDeploymentResult deployment(DeploymentInfo deployment) {
        this.deployment = deployment;
        return this;
    }
