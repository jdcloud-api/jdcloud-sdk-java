 ...
 * 创建部署信息
 */
public class CreateDeploymentResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param deployment
     */
    public CreateDeploymentResult deployment(DeploymentInfo deployment) {
        this.deployment = deployment;
        return this;
    }
