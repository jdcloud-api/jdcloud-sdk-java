 ...
 * 克隆部署信息
 */
public class CloneDeploymentResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param deployment
     */
    public CloneDeploymentResult deployment(DeploymentInfo deployment) {
        this.deployment = deployment;
        return this;
    }
