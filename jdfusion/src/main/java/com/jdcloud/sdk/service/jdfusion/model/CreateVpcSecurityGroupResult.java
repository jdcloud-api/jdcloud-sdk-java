 ...
 * 根据云提供商创建安全组
 */
public class CreateVpcSecurityGroupResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param task
     */
    public CreateVpcSecurityGroupResult task(ResourceTFInfo task) {
        this.task = task;
        return this;
    }
