 ...
 * 根据云提供商创建网卡
 */
public class CreateVpcNetworkInterfaceResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param task
     */
    public CreateVpcNetworkInterfaceResult task(ResourceTFInfo task) {
        this.task = task;
        return this;
    }
