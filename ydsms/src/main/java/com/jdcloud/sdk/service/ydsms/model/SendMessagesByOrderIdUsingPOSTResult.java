 ...
 * 根据订单号发送短信
 */
public class SendMessagesByOrderIdUsingPOSTResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param mtResVO
     */
    public SendMessagesByOrderIdUsingPOSTResult mtResVO(MtResVO mtResVO) {
        this.mtResVO = mtResVO;
        return this;
    }
