 ...
 * 根据加密pin发送短信
 */
public class SendMessagesByEncPinUsingPOSTResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param mtResVO
     */
    public SendMessagesByEncPinUsingPOSTResult mtResVO(MtResVO mtResVO) {
        this.mtResVO = mtResVO;
        return this;
    }
