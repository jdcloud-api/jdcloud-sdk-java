 ...
 * 添加敏感数据分类
 */
public class AddCategoryRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param categorySpec
     */
    public AddCategoryRequest categorySpec(CategorySpec categorySpec) {
        this.categorySpec = categorySpec;
        return this;
    }
