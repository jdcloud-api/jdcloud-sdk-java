 ...
 * flowLogSpec
 */
public class FlowLogSpec  implements java.io.Serializable {
...
当flowLogType &#x3D; PORT时，值需取 templateUID &#x3D; eniflowlogs 的日志主题ID
     ...
     * @param flowLogName
     */
    public FlowLogSpec flowLogName(String flowLogName) {
        this.flowLogName = flowLogName;
        return this;
    }
     ...
     * @param description
     */
    public FlowLogSpec description(String description) {
        this.description = description;
        return this;
    }
...
PORT：采集资源可为云主机、弹性网卡
     ...
     * @param flowLogType
     */
    public FlowLogSpec flowLogType(String flowLogType) {
        this.flowLogType = flowLogType;
        return this;
    }
    ...
    * @param collectResources
    */
    public FlowLogSpec collectResources(List<CollectResourceSpec> collectResources) {
        this.collectResources = collectResources;
        return this;
    }
...
REJECT：记录指定资源被安全组或网络ACL拒绝的流量     
     ...
     * @param collectTrafficType
     */
    public FlowLogSpec collectTrafficType(String collectTrafficType) {
        this.collectTrafficType = collectTrafficType;
        return this;
    }
     ...
     * @param collectInterval
     */
    public FlowLogSpec collectInterval(Integer collectInterval) {
        this.collectInterval = collectInterval;
        return this;
    }
     ...
     * @param storageType
     */
    public FlowLogSpec storageType(String storageType) {
        this.storageType = storageType;
        return this;
    }
     ...
     * @param storageRegionId
     */
    public FlowLogSpec storageRegionId(String storageRegionId) {
        this.storageRegionId = storageRegionId;
        return this;
    }
...
当flowLogType &#x3D; PORT时，值需取 templateUID &#x3D; eniflowlogs 的日志主题ID
     ...
     * @param storageId
     */
    public FlowLogSpec storageId(String storageId) {
        this.storageId = storageId;
        return this;
    }
