 ...
 */
class DescribeInstanceAclExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}:describeInstanceAcl";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeInstanceAclResponse.class;
    }
}
