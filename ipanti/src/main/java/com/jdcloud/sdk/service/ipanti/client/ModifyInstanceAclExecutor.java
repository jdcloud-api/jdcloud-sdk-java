 ...
 */
class ModifyInstanceAclExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}:modifyInstanceAcl";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ModifyInstanceAclResponse.class;
    }
}
