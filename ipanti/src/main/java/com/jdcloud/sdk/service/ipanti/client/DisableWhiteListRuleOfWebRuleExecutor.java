 ...
 */
class DisableWhiteListRuleOfWebRuleExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}/webWhiteListRules/{webWhiteListRuleId}:disable";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DisableWhiteListRuleOfWebRuleResponse.class;
    }
}
