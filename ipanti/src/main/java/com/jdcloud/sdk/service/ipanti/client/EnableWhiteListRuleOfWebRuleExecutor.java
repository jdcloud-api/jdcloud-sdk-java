 ...
 */
class EnableWhiteListRuleOfWebRuleExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}/webWhiteListRules/{webWhiteListRuleId}:enable";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return EnableWhiteListRuleOfWebRuleResponse.class;
    }
}
