 ...
 */
class DescribeWebRuleRSGeoAreasExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/describeWebRuleRSGeoAreas";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeWebRuleRSGeoAreasResponse.class;
    }
}
