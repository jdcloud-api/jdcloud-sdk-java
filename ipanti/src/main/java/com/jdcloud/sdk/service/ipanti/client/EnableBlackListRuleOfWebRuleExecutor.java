 ...
 */
class EnableBlackListRuleOfWebRuleExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}/webBlackListRules/{webBlackListRuleId}:enable";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return EnableBlackListRuleOfWebRuleResponse.class;
    }
}
