 ...
 * 批量添加非网站类规则
 */
class CreateForwardRulesExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}:createForwardRules";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return CreateForwardRulesResponse.class;
    }
}
