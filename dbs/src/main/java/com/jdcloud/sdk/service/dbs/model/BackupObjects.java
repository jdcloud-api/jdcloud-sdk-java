 ...
 * backupObjects
 */
public class BackupObjects  implements java.io.Serializable {
     ...
     * @param database
     */
    public BackupObjects database(String database) {
        this.database = database;
        return this;
    }
     ...
     * @param objects
     */
    public BackupObjects objects(List<String> objects) {
        this.objects = objects;
        return this;
    }
