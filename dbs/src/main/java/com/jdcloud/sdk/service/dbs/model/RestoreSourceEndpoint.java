 ...
 */
public class RestoreSourceEndpoint  implements java.io.Serializable {
    ...
    /**
     * get 源数据库的端口，仅初始化时可设置，设置完成并开始备份后，不可修改
     *
     * @return
     */
    ...
    /**
     * set 源数据库的端口，仅初始化时可设置，设置完成并开始备份后，不可修改
     *
     * @param port
     */
     ...
     * @param backupAgentId
     */
    public RestoreSourceEndpoint backupAgentId(String backupAgentId) {
        this.backupAgentId = backupAgentId;
        return this;
    }
     ...
     * @param networkType
     */
    public RestoreSourceEndpoint networkType(String networkType) {
        this.networkType = networkType;
        return this;
    }
     ...
     * @param port
     */
    public RestoreSourceEndpoint port(Integer port) {
        this.port = port;
        return this;
    }
     ...
     * @param accountName
     */
    public RestoreSourceEndpoint accountName(String accountName) {
        this.accountName = accountName;
        return this;
    }
     ...
     * @param password
     */
    public RestoreSourceEndpoint password(String password) {
        this.password = password;
        return this;
    }
     ...
     * @param engineRelatedConfig
     */
    public RestoreSourceEndpoint engineRelatedConfig(EngineRelatedConfig engineRelatedConfig) {
        this.engineRelatedConfig = engineRelatedConfig;
        return this;
    }
