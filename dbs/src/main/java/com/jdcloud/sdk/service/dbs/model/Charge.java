...
public class Charge  implements java.io.Serializable {
    ...
    /**
     * 计费模式枚举值prepaid_by_duration表示预付费，postpaid_by_usage表示按用量后付费，postpaid_by_duration表示按配置后付费，默认为postpaid_by_duration
     */
    private String chargeMode;

    /**
     * 计费状态，取值为 normal表示正常，overdue表示预付费已到期，arrear表示欠费
     */
    ...
    /**
     * get 计费模式枚举值prepaid_by_duration表示预付费，postpaid_by_usage表示按用量后付费，postpaid_by_duration表示按配置后付费，默认为postpaid_by_duration
     *
     * @return
     */
    ...
    /**
     * set 计费模式枚举值prepaid_by_duration表示预付费，postpaid_by_usage表示按用量后付费，postpaid_by_duration表示按配置后付费，默认为postpaid_by_duration
     *
     * @param chargeMode
     */
    ...
    /**
     * get 计费状态，取值为 normal表示正常，overdue表示预付费已到期，arrear表示欠费
     *
     * @return
     */
    ...
    /**
     * set 计费状态，取值为 normal表示正常，overdue表示预付费已到期，arrear表示欠费
     *
     * @param chargeStatus
     */
