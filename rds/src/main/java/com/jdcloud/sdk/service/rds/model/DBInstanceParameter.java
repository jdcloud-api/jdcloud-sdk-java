 ...
 * dBInstanceParameter
 */
public class DBInstanceParameter  implements java.io.Serializable {
     ...
     * @param name
     */
    public DBInstanceParameter name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param description
     */
    public DBInstanceParameter description(String description) {
        this.description = description;
        return this;
    }
     ...
     * @param configureValue
     */
    public DBInstanceParameter configureValue(String configureValue) {
        this.configureValue = configureValue;
        return this;
    }
     ...
     * @param runningValue
     */
    public DBInstanceParameter runningValue(String runningValue) {
        this.runningValue = runningValue;
        return this;
    }
     ...
     * @param range
     */
    public DBInstanceParameter range(String range) {
        this.range = range;
        return this;
    }
     ...
     * @param needRestart
     */
    public DBInstanceParameter needRestart(String needRestart) {
        this.needRestart = needRestart;
        return this;
    }
