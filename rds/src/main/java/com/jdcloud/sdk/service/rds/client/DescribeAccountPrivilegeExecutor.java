 ...
 */
class DescribeAccountPrivilegeExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/instances/{instanceId}/accounts/{accountName}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeAccountPrivilegeResponse.class;
    }
}
