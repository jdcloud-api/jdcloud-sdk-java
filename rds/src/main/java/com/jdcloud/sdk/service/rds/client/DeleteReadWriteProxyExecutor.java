 ...
 */
class DeleteReadWriteProxyExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/readWriteProxy/{readWriteProxyId}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DeleteReadWriteProxyResponse.class;
    }
}
