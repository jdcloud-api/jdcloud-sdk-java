 ...
 */
public class ModifyInstanceAzRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param regionId
     */
    public ModifyInstanceAzRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param instanceId
     */
    public ModifyInstanceAzRequest instanceId(String instanceId) {
        this.instanceId = instanceId;
        return this;
    }
    ...
    /**
     * add item to 新可用区ID。 如果是单机实例，只需输入一个可用区；如果是主备实例，则必须输入两个可用区ID：第一个为主节点所在可用区，第二个为备节点所在可用区。主备两个可用区可以相同，也可以不同
     *
     * @param newAzId
     */
    public void addNewAzId(String newAzId) {
        if (this.newAzId == null) {
            this.newAzId = new ArrayList<>();
        }
