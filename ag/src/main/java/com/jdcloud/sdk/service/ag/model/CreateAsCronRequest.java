 ...
 */
public class CreateAsCronRequest extends JdcloudRequest implements java.io.Serializable {
...
- 时间必须大于&#x60;launchTime&#x60;
    ...
    /**
     * 定时任务触发操作失败后，在此时间内重试，单位为秒，默认为600，取值范围：[&#x60;0&#x60; ~ &#x60;1800&#x60;]
     */
...
- 时间必须大于&#x60;launchTime&#x60;
    ...
    /**
     * get 定时任务触发操作失败后，在此时间内重试，单位为秒，默认为600，取值范围：[&#x60;0&#x60; ~ &#x60;1800&#x60;]
     *
     * @return
     */
    ...
    /**
     * set 定时任务触发操作失败后，在此时间内重试，单位为秒，默认为600，取值范围：[&#x60;0&#x60; ~ &#x60;1800&#x60;]
     *
     ...
     * @param agId
     */
    public CreateAsCronRequest agId(String agId) {
        this.agId = agId;
        return this;
    }
     ...
     * @param name
     */
    public CreateAsCronRequest name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param description
     */
    public CreateAsCronRequest description(String description) {
        this.description = description;
        return this;
    }
...
- 当指定参数&#x60;asRuleId&#x60;时，不允许指定参数&#x60;minSize&#x60;,&#x60;maxSize&#x60;,&#x60;desiredCapacity&#x60;
     ...
     * @param asRuleId
     */
    public CreateAsCronRequest asRuleId(String asRuleId) {
        this.asRuleId = asRuleId;
        return this;
    }
...
- 如果没有指定参数&#x60;asRuleId&#x60;，则参数&#x60;minSize&#x60;,&#x60;maxSize&#x60;,&#x60;desiredCapacity&#x60;三者至少填写一个
     ...
     * @param minSize
     */
    public CreateAsCronRequest minSize(Integer minSize) {
        this.minSize = minSize;
        return this;
    }
...
- 如果没有指定参数&#x60;asRuleId&#x60;，则参数&#x60;minSize&#x60;,&#x60;maxSize&#x60;,&#x60;desiredCapacity&#x60;三者至少填写一个
     ...
     * @param maxSize
     */
    public CreateAsCronRequest maxSize(Integer maxSize) {
        this.maxSize = maxSize;
        return this;
    }
...
- 如果没有指定参数&#x60;asRuleId&#x60;，则参数&#x60;minSize&#x60;,&#x60;maxSize&#x60;,&#x60;desiredCapacity&#x60;三者至少填写一个
     ...
     * @param desiredCapacity
     */
    public CreateAsCronRequest desiredCapacity(Integer desiredCapacity) {
        this.desiredCapacity = desiredCapacity;
        return this;
    }
...
- 时间必须小于&#x60;repeatEndTime&#x60;
     ...
     * @param launchTime
     */
    public CreateAsCronRequest launchTime(String launchTime) {
        this.launchTime = launchTime;
        return this;
    }
...
- Cron：按照指定的Cron表达式执行定时任务
     ...
     * @param repeatType
     */
    public CreateAsCronRequest repeatType(String repeatType) {
        this.repeatType = repeatType;
        return this;
    }
...
示例：0 10 * * *  表示：每天10点执行
     ...
     * @param repeatValue
     */
    public CreateAsCronRequest repeatValue(String repeatValue) {
        this.repeatValue = repeatValue;
        return this;
    }
...
- 时间必须大于&#x60;launchTime&#x60;
     ...
     * @param repeatEndTime
     */
    public CreateAsCronRequest repeatEndTime(String repeatEndTime) {
        this.repeatEndTime = repeatEndTime;
        return this;
    }
     ...
     * @param launchExpirationTime
     */
    public CreateAsCronRequest launchExpirationTime(Integer launchExpirationTime) {
        this.launchExpirationTime = launchExpirationTime;
        return this;
    }
     ...
     * @param regionId
     */
    public CreateAsCronRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
