 ...
 * 简单规则相关参数
 */
public class UpdateSimpleAsRuleSpec  implements java.io.Serializable {
...
- &#x60;Total&#x60;：将当前伸缩组的实例数量调整到指定数量
     ...
     * @param adjustmentType
     */
    public UpdateSimpleAsRuleSpec adjustmentType(String adjustmentType) {
        this.adjustmentType = adjustmentType;
        return this;
    }
...
- &#x60;adjustmentType&#x60;为&#x60;Total&#x60;时，取值范围：[&#x60;0&#x60; ~ &#x60;100000&#x60;]
     ...
     * @param adjustmentValue
     */
    public UpdateSimpleAsRuleSpec adjustmentValue(Integer adjustmentValue) {
        this.adjustmentValue = adjustmentValue;
        return this;
    }
