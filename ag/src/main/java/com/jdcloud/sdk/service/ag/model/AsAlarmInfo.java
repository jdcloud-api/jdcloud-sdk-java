 ...
 * 告警任务信息
 */
public class AsAlarmInfo  implements java.io.Serializable {
...
- 自定义监控取值范围：[&#x60;avg&#x60;]
    ...
    private List<AsRuleInfoByAsAlarm> asRules;
    /**
     * 创建时间
     */
...
- 自定义监控取值范围：[&#x60;avg&#x60;]
    ...
    * @return
    */
    public List<AsRuleInfoByAsAlarm> getAsRules() {
        return asRules;
    }
    ...
    * @param asRules
    */
    public void setAsRules(List<AsRuleInfoByAsAlarm> asRules) {
...
- &#x60;Alarm&#x60;：告警中
     ...
     * @param agId
     */
    public AsAlarmInfo agId(String agId) {
        this.agId = agId;
        return this;
    }
     ...
     * @param asAlarmId
     */
    public AsAlarmInfo asAlarmId(String asAlarmId) {
        this.asAlarmId = asAlarmId;
        return this;
    }
     ...
     * @param region
     */
    public AsAlarmInfo region(String region) {
        this.region = region;
        return this;
    }
     ...
     * @param name
     */
    public AsAlarmInfo name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param description
     */
    public AsAlarmInfo description(String description) {
        this.description = description;
        return this;
    }
     ...
     * @param metricType
     */
    public AsAlarmInfo metricType(String metricType) {
        this.metricType = metricType;
        return this;
    }
...
- &#x60;vm.network.bytes.outgoing&#x60;: &#x60;网络出速率(host)&#x60;
     ...
     * @param metricName
     */
    public AsAlarmInfo metricName(String metricName) {
        this.metricName = metricName;
        return this;
    }
     ...
     * @param namespace
     */
    public AsAlarmInfo namespace(String namespace) {
        this.namespace = namespace;
        return this;
    }
     ...
     * @param period
     */
    public AsAlarmInfo period(Integer period) {
        this.period = period;
        return this;
    }
...
- 自定义监控取值范围：[&#x60;avg&#x60;]
     ...
     * @param statistic
     */
    public AsAlarmInfo statistic(String statistic) {
        this.statistic = statistic;
        return this;
    }
     ...
     * @param threshold
     */
    public AsAlarmInfo threshold(Double threshold) {
        this.threshold = threshold;
        return this;
    }
     ...
     * @param comparison
     */
    public AsAlarmInfo comparison(String comparison) {
        this.comparison = comparison;
        return this;
    }
     ...
     * @param hitCount
     */
    public AsAlarmInfo hitCount(Integer hitCount) {
        this.hitCount = hitCount;
        return this;
    }
    ...
    * @param asRules
    */
    public AsAlarmInfo asRules(List<AsRuleInfoByAsAlarm> asRules) {
        this.asRules = asRules;
        return this;
    }
     ...
     * @param createTime
     */
    public AsAlarmInfo createTime(String createTime) {
        this.createTime = createTime;
        return this;
    }
     ...
     * @param updateTime
     */
    public AsAlarmInfo updateTime(String updateTime) {
        this.updateTime = updateTime;
        return this;
    }
...
- &#x60;Alarm&#x60;：告警中
     ...
     * @param state
     */
    public AsAlarmInfo state(String state) {
        this.state = state;
        return this;
    }
    ...
    /**
     * add item to 关联的伸缩规则列表
     *
     * @param asRule
     */
    public void addAsRule(AsRuleInfoByAsAlarm asRule) {
