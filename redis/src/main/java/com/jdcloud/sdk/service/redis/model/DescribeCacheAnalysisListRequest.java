 ...
 * 查询缓存分析任务列表
 */
public class DescribeCacheAnalysisListRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    /**
     * get 格式:yyyy-MM-dd,表示查询某一天的缓存分析列表
     *
     * @return
     */
    ...
    /**
     * set 格式:yyyy-MM-dd,表示查询某一天的缓存分析列表
     *
     * @param date
     */
     ...
     * @param date
     */
    public DescribeCacheAnalysisListRequest date(String date) {
        this.date = date;
        return this;
    }
     ...
     * @param regionId
     */
    public DescribeCacheAnalysisListRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param cacheInstanceId
     */
    public DescribeCacheAnalysisListRequest cacheInstanceId(String cacheInstanceId) {
        this.cacheInstanceId = cacheInstanceId;
        return this;
    }
