 ...
 */
class DescribeConfigCenterTokenAndCipherExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/configCenter";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeConfigCenterTokenAndCipherResponse.class;
    }
}
