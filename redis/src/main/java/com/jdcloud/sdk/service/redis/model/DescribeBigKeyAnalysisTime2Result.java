 ...
 * 获取大key自动缓存分析时间
 */
public class DescribeBigKeyAnalysisTime2Result extends JdcloudResult implements java.io.Serializable {
     ...
     * @param time
     */
    public DescribeBigKeyAnalysisTime2Result time(String time) {
        this.time = time;
        return this;
    }
