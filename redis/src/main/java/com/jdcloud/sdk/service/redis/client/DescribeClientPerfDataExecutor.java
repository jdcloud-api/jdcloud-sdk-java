 ...
 */
class DescribeClientPerfDataExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/clientPerfData";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeClientPerfDataResponse.class;
    }
}
