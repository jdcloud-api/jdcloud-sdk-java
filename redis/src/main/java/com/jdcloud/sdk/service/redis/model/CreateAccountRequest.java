...
public class CreateAccountRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    /**
     * 账号权限，默认为读写权限。支持RoleReadOnly（只读权限）、RoleReadWrite（读写权限）
     */
    ...
    /**
     * get 账号权限，默认为读写权限。支持RoleReadOnly（只读权限）、RoleReadWrite（读写权限）
     *
     * @return
     */
    ...
    /**
     * set 账号权限，默认为读写权限。支持RoleReadOnly（只读权限）、RoleReadWrite（读写权限）
     *
     ...
     * @param accountPrivilege
     */
    public CreateAccountRequest accountPrivilege(String accountPrivilege) {
        this.accountPrivilege = accountPrivilege;
        return this;
    }
     ...
     * @param accountDescription
     */
    public CreateAccountRequest accountDescription(String accountDescription) {
        this.accountDescription = accountDescription;
        return this;
    }
     ...
     * @param cacheInstanceId
     */
    public CreateAccountRequest cacheInstanceId(String cacheInstanceId) {
        this.cacheInstanceId = cacheInstanceId;
        return this;
    }
