 ...
 */
class DescribeResizeModeIpTimeInfoExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/describeResizeModeIpTimeInfo";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeResizeModeIpTimeInfoResponse.class;
    }
}
