 ...
 */
class DescribeClientDetailUseR2MJavaClientExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/clientDetail";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeClientDetailUseR2MJavaClientResponse.class;
    }
}
