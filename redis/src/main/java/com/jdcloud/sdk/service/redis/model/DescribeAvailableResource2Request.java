 ...
 * 查询支持的规格列表
 */
public class DescribeAvailableResource2Request extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param regionId
     */
    public DescribeAvailableResource2Request regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
