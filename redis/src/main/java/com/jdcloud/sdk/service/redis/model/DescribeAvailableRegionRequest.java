 ...
 * 查询支持的地域列表
 */
public class DescribeAvailableRegionRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param regionId
     */
    public DescribeAvailableRegionRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
