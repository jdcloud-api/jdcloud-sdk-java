 ...
 */
class DescribeCacheAnalysisResultExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/cacheAnalysis/{taskId}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeCacheAnalysisResultResponse.class;
    }
}
