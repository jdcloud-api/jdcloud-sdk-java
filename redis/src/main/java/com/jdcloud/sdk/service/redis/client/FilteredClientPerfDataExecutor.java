 ...
 */
class FilteredClientPerfDataExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/filteredClientPerfData";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return FilteredClientPerfDataResponse.class;
    }
}
