 ...
 * 查询当前客户端IP列表
 */
class DescribeClientListExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/clientList";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeClientListResponse.class;
    }
}
