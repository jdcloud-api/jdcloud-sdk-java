 ...
 * 查询支持的规格列表
 */
public class DescribeAvailableResourceRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param regionId
     */
    public DescribeAvailableResourceRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
