 ...
 * 查询缓存Redis实例的规格配置信息
 */
public class DescribeSpecConfigRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param regionId
     */
    public DescribeSpecConfigRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
