...
import com.jdcloud.sdk.service.redis.model.DisableCommands;
import com.jdcloud.sdk.service.JdcloudRequest;

/**
 * 禁用redis命令
 */
public class SetDisableCommandsRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param regionId
     */
    public SetDisableCommandsRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param cacheInstanceId
     */
    public SetDisableCommandsRequest cacheInstanceId(String cacheInstanceId) {
        this.cacheInstanceId = cacheInstanceId;
        return this;
    }
     ...
     * add item to 禁用命令列表
     *
     * @param disableCommand
     */
    public void addDisableCommand(DisableCommands disableCommand) {
        if (this.disableCommands == null) {
