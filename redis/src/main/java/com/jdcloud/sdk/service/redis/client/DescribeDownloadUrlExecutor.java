 ...
 */
class DescribeDownloadUrlExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/backup:describeDownloadUrl";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeDownloadUrlResponse.class;
    }
}
