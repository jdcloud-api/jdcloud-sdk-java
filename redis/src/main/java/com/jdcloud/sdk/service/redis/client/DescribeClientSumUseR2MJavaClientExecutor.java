 ...
 */
class DescribeClientSumUseR2MJavaClientExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/regions/{regionId}/cacheInstance/{cacheInstanceId}/clientSum";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return DescribeClientSumUseR2MJavaClientResponse.class;
    }
}
