 ...
 * 根据模型ID查看物模型完整信息
 */
public class DiscribeThingModelResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param thingModelRespTO
     */
    public DiscribeThingModelResult thingModelRespTO(ThingModelRespTO thingModelRespTO) {
        this.thingModelRespTO = thingModelRespTO;
        return this;
    }
