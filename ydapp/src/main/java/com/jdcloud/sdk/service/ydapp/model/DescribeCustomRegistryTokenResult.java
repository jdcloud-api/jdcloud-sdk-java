...
public class DescribeCustomRegistryTokenResult extends JdcloudResult implements java.io.Serializable {
     ...
     *
     * @param authorizationToken token - 令牌base64编码后的字符串，E.g.，eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...

     * @return DescribeCustomRegistryTokenResult
     */
     ...
     *
     * @param loginCmdLine docker login 命令base64编码后的字符串，E.g.，docker login registry.jdcloud.com -u username -p password
     ...
     *
     * @param registryUri 镜像注册表地址，E.g.，registry.jdcloud.com
     ...
     *
     * @param username 镜像注册表登陆用户名，E.g.，registry-user
