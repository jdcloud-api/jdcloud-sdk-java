 ...
 * 添加合作产品
 */
public class AddCoProductRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param cooperationId
     */
    public AddCoProductRequest cooperationId(String cooperationId) {
        this.cooperationId = cooperationId;
        return this;
    }
     ...
     * @param productName
     */
    public AddCoProductRequest productName(String productName) {
        this.productName = productName;
        return this;
    }
     ...
     * @param name
     */
    public AddCoProductRequest name(String name) {
        this.name = name;
        return this;
    }
     ...
     * @param productType
     */
    public AddCoProductRequest productType(Integer productType) {
        this.productType = productType;
        return this;
    }
     ...
     * @param productMode
     */
    public AddCoProductRequest productMode(Integer productMode) {
        this.productMode = productMode;
        return this;
    }
     ...
     * @param productDesc
     */
    public AddCoProductRequest productDesc(String productDesc) {
        this.productDesc = productDesc;
        return this;
    }
     ...
     * @param targetCustomer
     */
    public AddCoProductRequest targetCustomer(String targetCustomer) {
        this.targetCustomer = targetCustomer;
        return this;
    }
     ...
     * @param marketSize
     */
    public AddCoProductRequest marketSize(String marketSize) {
        this.marketSize = marketSize;
        return this;
    }
     ...
     * @param comparableProduct
     */
    public AddCoProductRequest comparableProduct(String comparableProduct) {
        this.comparableProduct = comparableProduct;
        return this;
    }
     ...
     * @param sellingForm
     */
    public AddCoProductRequest sellingForm(Integer sellingForm) {
        this.sellingForm = sellingForm;
        return this;
    }
     ...
     * @param sellingMode
     */
    public AddCoProductRequest sellingMode(String sellingMode) {
        this.sellingMode = sellingMode;
        return this;
    }
     ...
     * @param pricing
     */
    public AddCoProductRequest pricing(String pricing) {
        this.pricing = pricing;
        return this;
    }
     ...
     * @param productStatus
     */
    public AddCoProductRequest productStatus(Integer productStatus) {
        this.productStatus = productStatus;
        return this;
    }
     ...
     * @param incomeForecast
     */
    public AddCoProductRequest incomeForecast(String incomeForecast) {
        this.incomeForecast = incomeForecast;
        return this;
    }
     ...
     * @param costStructure
     */
    public AddCoProductRequest costStructure(String costStructure) {
        this.costStructure = costStructure;
        return this;
    }
     ...
     * @param grossMarginForecast
     */
    public AddCoProductRequest grossMarginForecast(String grossMarginForecast) {
        this.grossMarginForecast = grossMarginForecast;
        return this;
    }
     ...
     * @param pricingStrategy
     */
    public AddCoProductRequest pricingStrategy(Integer pricingStrategy) {
        this.pricingStrategy = pricingStrategy;
        return this;
    }
     ...
     * @param settlementMode
     */
    public AddCoProductRequest settlementMode(Integer settlementMode) {
        this.settlementMode = settlementMode;
        return this;
    }
     ...
     * @param settlementCycle
     */
    public AddCoProductRequest settlementCycle(Integer settlementCycle) {
        this.settlementCycle = settlementCycle;
        return this;
    }
     ...
     * @param riskSuggestion
     */
    public AddCoProductRequest riskSuggestion(String riskSuggestion) {
        this.riskSuggestion = riskSuggestion;
        return this;
    }
     ...
     * @param erp
     */
    public AddCoProductRequest erp(String erp) {
        this.erp = erp;
        return this;
    }
     ...
     * @param uuid
     */
    public AddCoProductRequest uuid(String uuid) {
        this.uuid = uuid;
        return this;
    }
     ...
     * @param regionId
     */
    public AddCoProductRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
