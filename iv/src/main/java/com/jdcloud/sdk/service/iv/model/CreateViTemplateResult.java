 ...
 * 创建视频审查模板
 */
public class CreateViTemplateResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param templateId
     */
    public CreateViTemplateResult templateId(String templateId) {
        this.templateId = templateId;
        return this;
    }
     ...
     * @param templateName
     */
    public CreateViTemplateResult templateName(String templateName) {
        this.templateName = templateName;
        return this;
    }
     ...
     * @param shotInterval
     */
    public CreateViTemplateResult shotInterval(Integer shotInterval) {
        this.shotInterval = shotInterval;
        return this;
    }
     ...
     * @param shotIntervalType
     */
    public CreateViTemplateResult shotIntervalType(String shotIntervalType) {
        this.shotIntervalType = shotIntervalType;
        return this;
    }
     ...
     * @param shotFormat
     */
    public CreateViTemplateResult shotFormat(String shotFormat) {
        this.shotFormat = shotFormat;
        return this;
    }
     ...
     * @param shotFrameType
     */
    public CreateViTemplateResult shotFrameType(String shotFrameType) {
        this.shotFrameType = shotFrameType;
        return this;
    }
     ...
     * @param shotWidth
     */
    public CreateViTemplateResult shotWidth(Integer shotWidth) {
        this.shotWidth = shotWidth;
        return this;
    }
     ...
     * @param shotHeight
     */
    public CreateViTemplateResult shotHeight(Integer shotHeight) {
        this.shotHeight = shotHeight;
        return this;
    }
     ...
     * @param shotFillType
     */
    public CreateViTemplateResult shotFillType(String shotFillType) {
        this.shotFillType = shotFillType;
        return this;
    }
     ...
     * @param inspectItems
     */
    public CreateViTemplateResult inspectItems(String inspectItems) {
        this.inspectItems = inspectItems;
        return this;
    }
     ...
     * @param createTime
     */
    public CreateViTemplateResult createTime(String createTime) {
        this.createTime = createTime;
        return this;
    }
     ...
     * @param updateTime
     */
    public CreateViTemplateResult updateTime(String updateTime) {
        this.updateTime = updateTime;
        return this;
    }
