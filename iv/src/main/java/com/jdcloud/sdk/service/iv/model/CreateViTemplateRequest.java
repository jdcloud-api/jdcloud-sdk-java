 ...
 * 创建视频审查模板
 */
public class CreateViTemplateRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param templateName
     */
    public CreateViTemplateRequest templateName(String templateName) {
        this.templateName = templateName;
        return this;
    }
     ...
     * @param shotInterval
     */
    public CreateViTemplateRequest shotInterval(Integer shotInterval) {
        this.shotInterval = shotInterval;
        return this;
    }
     ...
     * @param shotIntervalType
     */
    public CreateViTemplateRequest shotIntervalType(String shotIntervalType) {
        this.shotIntervalType = shotIntervalType;
        return this;
    }
     ...
     * @param shotFormat
     */
    public CreateViTemplateRequest shotFormat(String shotFormat) {
        this.shotFormat = shotFormat;
        return this;
    }
     ...
     * @param shotFrameType
     */
    public CreateViTemplateRequest shotFrameType(String shotFrameType) {
        this.shotFrameType = shotFrameType;
        return this;
    }
     ...
     * @param shotWidth
     */
    public CreateViTemplateRequest shotWidth(Integer shotWidth) {
        this.shotWidth = shotWidth;
        return this;
    }
     ...
     * @param shotHeight
     */
    public CreateViTemplateRequest shotHeight(Integer shotHeight) {
        this.shotHeight = shotHeight;
        return this;
    }
     ...
     * @param shotFillType
     */
    public CreateViTemplateRequest shotFillType(String shotFillType) {
        this.shotFillType = shotFillType;
        return this;
    }
     ...
     * @param inspectItems
     */
    public CreateViTemplateRequest inspectItems(String inspectItems) {
        this.inspectItems = inspectItems;
        return this;
    }
