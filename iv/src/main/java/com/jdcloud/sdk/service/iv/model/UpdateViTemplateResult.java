 ...
 * 修改视频审查模板
 */
public class UpdateViTemplateResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param templateId
     */
    public UpdateViTemplateResult templateId(String templateId) {
        this.templateId = templateId;
        return this;
    }
     ...
     * @param templateName
     */
    public UpdateViTemplateResult templateName(String templateName) {
        this.templateName = templateName;
        return this;
    }
     ...
     * @param shotInterval
     */
    public UpdateViTemplateResult shotInterval(Integer shotInterval) {
        this.shotInterval = shotInterval;
        return this;
    }
     ...
     * @param shotIntervalType
     */
    public UpdateViTemplateResult shotIntervalType(String shotIntervalType) {
        this.shotIntervalType = shotIntervalType;
        return this;
    }
     ...
     * @param shotFormat
     */
    public UpdateViTemplateResult shotFormat(String shotFormat) {
        this.shotFormat = shotFormat;
        return this;
    }
     ...
     * @param shotFrameType
     */
    public UpdateViTemplateResult shotFrameType(String shotFrameType) {
        this.shotFrameType = shotFrameType;
        return this;
    }
     ...
     * @param shotWidth
     */
    public UpdateViTemplateResult shotWidth(Integer shotWidth) {
        this.shotWidth = shotWidth;
        return this;
    }
     ...
     * @param shotHeight
     */
    public UpdateViTemplateResult shotHeight(Integer shotHeight) {
        this.shotHeight = shotHeight;
        return this;
    }
     ...
     * @param shotFillType
     */
    public UpdateViTemplateResult shotFillType(String shotFillType) {
        this.shotFillType = shotFillType;
        return this;
    }
     ...
     * @param inspectItems
     */
    public UpdateViTemplateResult inspectItems(String inspectItems) {
        this.inspectItems = inspectItems;
        return this;
    }
     ...
     * @param createTime
     */
    public UpdateViTemplateResult createTime(String createTime) {
        this.createTime = createTime;
        return this;
    }
     ...
     * @param updateTime
     */
    public UpdateViTemplateResult updateTime(String updateTime) {
        this.updateTime = updateTime;
        return this;
    }
