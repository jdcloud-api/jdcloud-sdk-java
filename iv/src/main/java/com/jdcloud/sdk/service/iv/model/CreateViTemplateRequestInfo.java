 ...
 * 创建模板请求信息
 */
public class CreateViTemplateRequestInfo  implements java.io.Serializable {
     ...
     * @param templateName
     */
    public CreateViTemplateRequestInfo templateName(String templateName) {
        this.templateName = templateName;
        return this;
    }
     ...
     * @param shotInterval
     */
    public CreateViTemplateRequestInfo shotInterval(Integer shotInterval) {
        this.shotInterval = shotInterval;
        return this;
    }
     ...
     * @param shotIntervalType
     */
    public CreateViTemplateRequestInfo shotIntervalType(String shotIntervalType) {
        this.shotIntervalType = shotIntervalType;
        return this;
    }
     ...
     * @param shotFormat
     */
    public CreateViTemplateRequestInfo shotFormat(String shotFormat) {
        this.shotFormat = shotFormat;
        return this;
    }
     ...
     * @param shotFrameType
     */
    public CreateViTemplateRequestInfo shotFrameType(String shotFrameType) {
        this.shotFrameType = shotFrameType;
        return this;
    }
     ...
     * @param shotWidth
     */
    public CreateViTemplateRequestInfo shotWidth(Integer shotWidth) {
        this.shotWidth = shotWidth;
        return this;
    }
     ...
     * @param shotHeight
     */
    public CreateViTemplateRequestInfo shotHeight(Integer shotHeight) {
        this.shotHeight = shotHeight;
        return this;
    }
     ...
     * @param shotFillType
     */
    public CreateViTemplateRequestInfo shotFillType(String shotFillType) {
        this.shotFillType = shotFillType;
        return this;
    }
     ...
     * @param inspectItems
     */
    public CreateViTemplateRequestInfo inspectItems(String inspectItems) {
        this.inspectItems = inspectItems;
        return this;
    }
