 ...
 * 物联网卡开启流量操作
 */
public class OpenIotFlowResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param status
     */
    public OpenIotFlowResult status(String status) {
        this.status = status;
        return this;
    }
     ...
     * @param message
     */
    public OpenIotFlowResult message(String message) {
        this.message = message;
        return this;
    }
     ...
     * @param result
     */
    public OpenIotFlowResult result(List<OperationIotCardResp> result) {
        this.result = result;
        return this;
    }
