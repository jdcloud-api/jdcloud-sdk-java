 ...
 * 物联网卡开机操作
 */
public class OpenIotCardResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param status
     */
    public OpenIotCardResult status(String status) {
        this.status = status;
        return this;
    }
     ...
     * @param message
     */
    public OpenIotCardResult message(String message) {
        this.message = message;
        return this;
    }
     ...
     * @param result
     */
    public OpenIotCardResult result(List<OperationIotCardResp> result) {
        this.result = result;
        return this;
    }
