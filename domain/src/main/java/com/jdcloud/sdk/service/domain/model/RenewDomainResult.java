 ...
 */
public class RenewDomainResult extends JdcloudResult implements java.io.Serializable {

    private static final long serialVersionUID = 1L;

    /**
     * 域名续费返回结果，后续需要调用订单支付接口
     */
    private DomainOrder data;


    /**
     * get 域名续费返回结果，后续需要调用订单支付接口
     *
     * @return
     */
     ...
     * @param data
     */
    public RenewDomainResult data(DomainOrder data) {
        this.data = data;
        return this;
    }
