 ...
 * 获取满足条件的日志详情
 */
public class LogDetailPublicRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param searchId
     */
    public LogDetailPublicRequest searchId(String searchId) {
        this.searchId = searchId;
        return this;
    }
     ...
     * @param logType
     */
    public LogDetailPublicRequest logType(String logType) {
        this.logType = logType;
        return this;
    }
    ...
    * @param ip
    */
    public LogDetailPublicRequest ip(List<String> ip) {
        this.ip = ip;
        return this;
    }
    ...
    * @param podName
    */
    public LogDetailPublicRequest podName(List<String> podName) {
        this.podName = podName;
        return this;
    }
     ...
     * @param namespace
     */
    public LogDetailPublicRequest namespace(String namespace) {
        this.namespace = namespace;
        return this;
    }
     ...
     * @param cluster
     */
    public LogDetailPublicRequest cluster(String cluster) {
        this.cluster = cluster;
        return this;
    }
     ...
     * @param containerName
     */
    public LogDetailPublicRequest containerName(String containerName) {
        this.containerName = containerName;
        return this;
    }
    ...
    * @param filePath
    */
    public LogDetailPublicRequest filePath(List<String> filePath) {
        this.filePath = filePath;
        return this;
    }
     ...
     * @param startTime
     */
    public LogDetailPublicRequest startTime(Long startTime) {
        this.startTime = startTime;
        return this;
    }
     ...
     * @param endTime
     */
    public LogDetailPublicRequest endTime(Long endTime) {
        this.endTime = endTime;
        return this;
    }
     ...
     * @param direction
     */
    public LogDetailPublicRequest direction(String direction) {
        this.direction = direction;
        return this;
    }
     ...
     * @param limit
     */
    public LogDetailPublicRequest limit(Integer limit) {
        this.limit = limit;
        return this;
    }
     ...
     * @param step
     */
    public LogDetailPublicRequest step(Float step) {
        this.step = step;
        return this;
    }
    ...
    * @param streamFilter
    */
    public LogDetailPublicRequest streamFilter(List<StreamFilter> streamFilter) {
        this.streamFilter = streamFilter;
        return this;
    }
     ...
     * @param lineFilter
     */
    public LogDetailPublicRequest lineFilter(LineFilter lineFilter) {
        this.lineFilter = lineFilter;
        return this;
    }
     ...
     * @param fmtFilter
     */
    public LogDetailPublicRequest fmtFilter(FormatFilter fmtFilter) {
        this.fmtFilter = fmtFilter;
        return this;
    }
     ...
     * @param product
     */
    public LogDetailPublicRequest product(String product) {
        this.product = product;
        return this;
    }
     ...
     * @param instance
     */
    public LogDetailPublicRequest instance(String instance) {
        this.instance = instance;
        return this;
    }
