 ...
 * 创建日志下载任务
 */
public class CreateLogDownloadTaskResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param downloadTaskUID
     */
    public CreateLogDownloadTaskResult downloadTaskUID(String downloadTaskUID) {
        this.downloadTaskUID = downloadTaskUID;
        return this;
    }
