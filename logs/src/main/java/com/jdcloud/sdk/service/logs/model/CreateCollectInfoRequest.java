...
public class CreateCollectInfoRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param binlogSpec
     */
    public CreateCollectInfoRequest binlogSpec(BinlogSpec binlogSpec) {
        this.binlogSpec = binlogSpec;
        return this;
    }
     ...
     * @param k8sSpec
     */
    public CreateCollectInfoRequest k8sSpec(K8sSpec k8sSpec) {
        this.k8sSpec = k8sSpec;
        return this;
    }
    ...
    */
     ...
     * @param name
     */
    public CreateCollectInfoRequest name(String name) {
        this.name = name;
        return this;
    }
