 ...
 * 创建日志的解析配置。
 */
public class CreateParserRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    * @param indexToken
    */
    public CreateParserRequest indexToken(List<String> indexToken) {
        this.indexToken = indexToken;
        return this;
    }
    ...
    * @param parserFields
    */
    public CreateParserRequest parserFields(List<ParserField> parserFields) {
        this.parserFields = parserFields;
        return this;
    }
     ...
     * @param parserMode
     */
    public CreateParserRequest parserMode(String parserMode) {
        this.parserMode = parserMode;
        return this;
    }
     ...
     * @param parserPattern
     */
    public CreateParserRequest parserPattern(String parserPattern) {
        this.parserPattern = parserPattern;
        return this;
    }
     ...
     * @param parserSample
     */
    public CreateParserRequest parserSample(String parserSample) {
        this.parserSample = parserSample;
        return this;
    }
    ...
    * @param pipelines
    */
    public CreateParserRequest pipelines(List<PipelineSpec> pipelines) {
        this.pipelines = pipelines;
        return this;
    }
     ...
     * @param reserveOriginContent
     */
    public CreateParserRequest reserveOriginContent(Boolean reserveOriginContent) {
        this.reserveOriginContent = reserveOriginContent;
        return this;
    }
     ...
     * @param regionId
     */
    public CreateParserRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param logtopicUID
     */
    public CreateParserRequest logtopicUID(String logtopicUID) {
        this.logtopicUID = logtopicUID;
        return this;
    }
