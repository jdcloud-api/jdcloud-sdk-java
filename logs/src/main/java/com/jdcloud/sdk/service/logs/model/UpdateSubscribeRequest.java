 ...
 * 更新日志消费
 */
public class UpdateSubscribeRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param status
     */
    public UpdateSubscribeRequest status(Long status) {
        this.status = status;
        return this;
    }
     ...
     * @param regionId
     */
    public UpdateSubscribeRequest regionId(String regionId) {
        this.regionId = regionId;
        return this;
    }
     ...
     * @param logsetUID
     */
    public UpdateSubscribeRequest logsetUID(String logsetUID) {
        this.logsetUID = logsetUID;
        return this;
    }
     ...
     * @param logtopicUID
     */
    public UpdateSubscribeRequest logtopicUID(String logtopicUID) {
        this.logtopicUID = logtopicUID;
        return this;
    }
