 ...
 */
public class ZoneTrafficDateHistogramResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param data
     */
    public ZoneTrafficDateHistogramResult data(SimpleDateHistogram data) {
        this.data = data;
        return this;
    }
