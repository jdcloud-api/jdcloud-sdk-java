 ...
 */
class ChangeWebSocketsSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$websockets";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeWebSocketsSettingResponse.class;
    }
}
