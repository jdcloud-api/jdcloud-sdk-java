 ...
 * 获取单个规则组
 */
class RuleGroupDetailsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/firewall$$waf$$packages/{package_identifier}/groups/{identifier}";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return RuleGroupDetailsResponse.class;
    }
}
