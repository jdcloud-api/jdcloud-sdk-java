 ...
 * 获取有关单个防火墙包的信息
 */
public class FirewallPackageDetailsResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param data
     */
    public FirewallPackageDetailsResult data(WAFRulePackage data) {
        this.data = data;
        return this;
    }
