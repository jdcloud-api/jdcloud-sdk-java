 ...
 */
public class ZoneRequestMultiDateHistogramResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public ZoneRequestMultiDateHistogramResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public ZoneRequestMultiDateHistogramResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public ZoneRequestMultiDateHistogramResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public ZoneRequestMultiDateHistogramResult util(String util) {
        this.util = util;
        return this;
    }
