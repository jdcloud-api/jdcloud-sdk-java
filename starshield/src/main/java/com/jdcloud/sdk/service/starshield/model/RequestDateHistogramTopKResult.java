 ...
 */
public class RequestDateHistogramTopKResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public RequestDateHistogramTopKResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public RequestDateHistogramTopKResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public RequestDateHistogramTopKResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public RequestDateHistogramTopKResult util(String util) {
        this.util = util;
        return this;
    }
