 ...
 * 自动优化移动设备上网站访问者的图像加载
 */
public class ChangeMirageSettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param value
     */
    public ChangeMirageSettingRequest value(String value) {
        this.value = value;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public ChangeMirageSettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
