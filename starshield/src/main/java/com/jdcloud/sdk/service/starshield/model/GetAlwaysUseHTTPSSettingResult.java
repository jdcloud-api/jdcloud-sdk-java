 ...
 */
public class GetAlwaysUseHTTPSSettingResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param data
     */
    public GetAlwaysUseHTTPSSettingResult data(ZoneSetting data) {
        this.data = data;
        return this;
    }
