 ...
 * 为该域启用加密TLS 1.3功能。
 */
public class ChangeTLS1_3SettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param value
     */
    public ChangeTLS1_3SettingRequest value(String value) {
        this.value = value;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public ChangeTLS1_3SettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
