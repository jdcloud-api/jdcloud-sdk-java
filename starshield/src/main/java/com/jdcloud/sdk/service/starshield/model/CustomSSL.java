 ...
 * customSSL
 */
public class CustomSSL  implements java.io.Serializable {
     ...
     * keyless_server
     */
    private Keyless_server keyless_server;
...
force：强制捆绑会验证证书链，但不以其他方式修改证书链。
     ...
     * @return
     */
    public Keyless_server getKeyless_server() {
        return keyless_server;
    }

    /**
     * set keyless_server
     *
     * @param keyless_server
     */
...
force：强制捆绑会验证证书链，但不以其他方式修改证书链。
     ...
     * @param priority
     */
    public CustomSSL priority(Number priority) {
        this.priority = priority;
        return this;
    }
     ...
     * @param keyless_server
     */
    public CustomSSL keyless_server(Keyless_server keyless_server) {
        this.keyless_server = keyless_server;
        return this;
    }
     ...
     * @param expires_on
     */
    public CustomSSL expires_on(String expires_on) {
        this.expires_on = expires_on;
        return this;
    }
    ...
    */
     ...
     * @param zone_id
     */
    public CustomSSL zone_id(String zone_id) {
        this.zone_id = zone_id;
        return this;
    }
...
inactive            未激活
     ...
     * @param status
     */
    public CustomSSL status(String status) {
        this.status = status;
        return this;
    }
     ...
     * @param geo_restrictions
     */
    public CustomSSL geo_restrictions(Geo_restrictions geo_restrictions) {
        this.geo_restrictions = geo_restrictions;
        return this;
    }
     ...
     * @param modified_on
     */
    public CustomSSL modified_on(String modified_on) {
        this.modified_on = modified_on;
        return this;
    }
     ...
     * @param signature
     */
    public CustomSSL signature(String signature) {
        this.signature = signature;
        return this;
    }
     ...
     * @param issuer
     */
    public CustomSSL issuer(String issuer) {
        this.issuer = issuer;
        return this;
    }
     ...
     * @param uploaded_on
     */
    public CustomSSL uploaded_on(String uploaded_on) {
        this.uploaded_on = uploaded_on;
        return this;
    }
...
force：强制捆绑会验证证书链，但不以其他方式修改证书链。
     ...
     * @param bundle_method
     */
    public CustomSSL bundle_method(String bundle_method) {
        this.bundle_method = bundle_method;
        return this;
    }
