 ...
 */
class ChangeEnableErrorPagesOnSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$origin_error_page_pass_thru";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeEnableErrorPagesOnSettingResponse.class;
    }
}
