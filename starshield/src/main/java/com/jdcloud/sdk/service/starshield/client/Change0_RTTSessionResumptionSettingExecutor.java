 ...
 * 开启/关闭 0-RTT
 */
class Change0_RTTSessionResumptionSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$0rtt";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return Change0_RTTSessionResumptionSettingResponse.class;
    }
}
