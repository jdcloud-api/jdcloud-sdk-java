 ...
 * 为该域启用自动HTTPS重写功能。
 */
public class ChangeAutomaticHTTPSRewritesSettingResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param data
     */
    public ChangeAutomaticHTTPSRewritesSettingResult data(ZoneSetting data) {
        this.data = data;
        return this;
    }
