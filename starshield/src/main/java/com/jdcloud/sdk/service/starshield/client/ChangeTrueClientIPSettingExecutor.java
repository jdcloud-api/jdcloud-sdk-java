 ...
 */
class ChangeTrueClientIPSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$true_client_ip_header";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeTrueClientIPSettingResponse.class;
    }
}
