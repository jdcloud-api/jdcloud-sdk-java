 ...
 * 域名Spectrum应用带宽统计.
 */
public class ZoneBandwidthDateHistogram4PaResult extends JdcloudResult implements java.io.Serializable {
...
如果是流量，数据点的单位是Byte
    ...
    */
     ...
     * @param sum
     */
    public ZoneBandwidthDateHistogram4PaResult sum(Double sum) {
        this.sum = sum;
        return this;
    }
     ...
     * @param max
     */
    public ZoneBandwidthDateHistogram4PaResult max(Double max) {
        this.max = max;
        return this;
    }
     ...
     * @param maxTimestamp
     */
    public ZoneBandwidthDateHistogram4PaResult maxTimestamp(Number maxTimestamp) {
        this.maxTimestamp = maxTimestamp;
        return this;
    }
...
如果是流量，数据点的单位是Byte
    ...
    * @param dataSeries
    */
    public ZoneBandwidthDateHistogram4PaResult dataSeries(List<Double> dataSeries) {
        this.dataSeries = dataSeries;
        return this;
    }
    ...
    * @param timeSeries
    */
    public ZoneBandwidthDateHistogram4PaResult timeSeries(List<Number> timeSeries) {
        this.timeSeries = timeSeries;
        return this;
    }
