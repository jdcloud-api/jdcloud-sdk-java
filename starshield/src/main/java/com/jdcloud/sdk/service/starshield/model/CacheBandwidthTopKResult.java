...
public class CacheBandwidthTopKResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param countries
    */
    public CacheBandwidthTopKResult countries(List<Item> countries) {
        this.countries = countries;
        return this;
    }
    ...
    * @param topCountries
    */
    public CacheBandwidthTopKResult topCountries(List<Item> topCountries) {
        this.topCountries = topCountries;
        return this;
    }
    ...
    * @param topDeviceTypes
    */
    public CacheBandwidthTopKResult topDeviceTypes(List<Item> topDeviceTypes) {
        this.topDeviceTypes = topDeviceTypes;
        return this;
    }
    ...
    * @param topHosts
    */
    public CacheBandwidthTopKResult topHosts(List<Item> topHosts) {
        this.topHosts = topHosts;
        return this;
    }
    ...
    * @param topPaths
    */
    public CacheBandwidthTopKResult topPaths(List<Item> topPaths) {
        this.topPaths = topPaths;
        return this;
    }
    ...
    * @param topContentTypes
    */
    public CacheBandwidthTopKResult topContentTypes(List<Item> topContentTypes) {
        this.topContentTypes = topContentTypes;
        return this;
    }
    ...
    * @param topStatusCodes
    */
    public CacheBandwidthTopKResult topStatusCodes(List<Item> topStatusCodes) {
        this.topStatusCodes = topStatusCodes;
        return this;
    }
    ...
    * @param topIPs
    */
    public CacheBandwidthTopKResult topIPs(List<Item> topIPs) {
        this.topIPs = topIPs;
        return this;
    }
    ...
    * @param topUserAgents
    */
    public CacheBandwidthTopKResult topUserAgents(List<Item> topUserAgents) {
        this.topUserAgents = topUserAgents;
        return this;
    }
    ...
    * @param topHttpMethods
    */
    public CacheBandwidthTopKResult topHttpMethods(List<Item> topHttpMethods) {
        this.topHttpMethods = topHttpMethods;
        return this;
    }
    ...
    * @param topASNs
    */
    public CacheBandwidthTopKResult topASNs(List<Item> topASNs) {
        this.topASNs = topASNs;
        return this;
    }
    ...
    * @param topFirewallRuleIds
    */
    public CacheBandwidthTopKResult topFirewallRuleIds(List<Item> topFirewallRuleIds) {
        this.topFirewallRuleIds = topFirewallRuleIds;
        return this;
    }
    ...
    * @param topFirewallRules
    */
    public CacheBandwidthTopKResult topFirewallRules(List<Item> topFirewallRules) {
        this.topFirewallRules = topFirewallRules;
        return this;
    }
    ...
    * @param topWafRuleIds
    */
    public CacheBandwidthTopKResult topWafRuleIds(List<Item> topWafRuleIds) {
        this.topWafRuleIds = topWafRuleIds;
        return this;
    }
    ...
    * @param topWafRules
    */
    public CacheBandwidthTopKResult topWafRules(List<Item> topWafRules) {
        this.topWafRules = topWafRules;
        return this;
    }
