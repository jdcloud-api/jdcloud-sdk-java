 ...
 * 变更上传文件的最大值
 */
public class ChangeMaxUploadSettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param value
     */
    public ChangeMaxUploadSettingRequest value(Number value) {
        this.value = value;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public ChangeMaxUploadSettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
