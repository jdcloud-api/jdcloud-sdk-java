 ...
 * 按响应带宽统计，返回日期直方图。
 */
public class CacheDateHistogramBandwidthResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public CacheDateHistogramBandwidthResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public CacheDateHistogramBandwidthResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public CacheDateHistogramBandwidthResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public CacheDateHistogramBandwidthResult util(String util) {
        this.util = util;
        return this;
    }
