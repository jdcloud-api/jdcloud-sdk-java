 ...
 * 星盾域的安全标头。
 */
class GetSecurityHeaderHSTSSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$security_header";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return GetSecurityHeaderHSTSSettingResponse.class;
    }
}
