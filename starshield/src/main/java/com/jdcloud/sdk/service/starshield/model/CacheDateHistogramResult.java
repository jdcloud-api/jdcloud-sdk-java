 ...
 * 按请求次数统计，返回日期直方图.
 */
public class CacheDateHistogramResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public CacheDateHistogramResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public CacheDateHistogramResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public CacheDateHistogramResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public CacheDateHistogramResult util(String util) {
        this.util = util;
        return this;
    }
