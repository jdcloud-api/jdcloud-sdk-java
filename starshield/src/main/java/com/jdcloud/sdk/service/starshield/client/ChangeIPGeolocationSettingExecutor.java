 ...
 */
class ChangeIPGeolocationSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$ip_geolocation";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeIPGeolocationSettingResponse.class;
    }
}
