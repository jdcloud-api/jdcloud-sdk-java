 ...
 */
class ChangePrefetchPreloadSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$prefetch_preload";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangePrefetchPreloadSettingResponse.class;
    }
}
