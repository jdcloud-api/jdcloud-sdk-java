 ...
 */
class ListAvailablePageRuleSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/pagerules$$settings";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ListAvailablePageRuleSettingResponse.class;
    }
}
