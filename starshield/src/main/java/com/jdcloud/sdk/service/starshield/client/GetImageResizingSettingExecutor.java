 ...
 */
class GetImageResizingSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$image_resizing";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return GetImageResizingSettingResponse.class;
    }
}
