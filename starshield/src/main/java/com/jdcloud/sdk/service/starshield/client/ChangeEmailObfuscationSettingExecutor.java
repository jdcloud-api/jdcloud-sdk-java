 ...
 */
class ChangeEmailObfuscationSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$email_obfuscation";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeEmailObfuscationSettingResponse.class;
    }
}
