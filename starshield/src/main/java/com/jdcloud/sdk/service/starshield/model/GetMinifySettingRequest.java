 ...
 * 获取你的网站自动最小化资产的配置
 */
public class GetMinifySettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param zone_identifier
     */
    public GetMinifySettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
