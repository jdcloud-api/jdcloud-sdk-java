 ...
 */
class ChangePrivacyPassSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$privacy_pass";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangePrivacyPassSettingResponse.class;
    }
}
