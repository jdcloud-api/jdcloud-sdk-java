 ...
 * 在所有启用星盾的子域上启用 IPv6。
 */
public class ChangeIPv6SettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param value
     */
    public ChangeIPv6SettingRequest value(String value) {
        this.value = value;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public ChangeIPv6SettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
