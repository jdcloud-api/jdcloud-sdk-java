 ...
 * 开启/关闭HTTP3
 */
public class ChangeHTTP3SettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param value
     */
    public ChangeHTTP3SettingRequest value(String value) {
        this.value = value;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public ChangeHTTP3SettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
