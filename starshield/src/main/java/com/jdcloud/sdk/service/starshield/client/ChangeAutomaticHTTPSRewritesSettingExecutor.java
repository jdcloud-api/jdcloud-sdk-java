 ...
 * 为该域启用自动HTTPS重写功能。
 */
class ChangeAutomaticHTTPSRewritesSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$automatic_https_rewrites";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeAutomaticHTTPSRewritesSettingResponse.class;
    }
}
