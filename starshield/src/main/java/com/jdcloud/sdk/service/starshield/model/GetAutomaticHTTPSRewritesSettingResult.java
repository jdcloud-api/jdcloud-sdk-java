 ...
 * 为该域启用自动HTTPS重写功能。
 */
public class GetAutomaticHTTPSRewritesSettingResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param data
     */
    public GetAutomaticHTTPSRewritesSettingResult data(ZoneSetting data) {
        this.data = data;
        return this;
    }
