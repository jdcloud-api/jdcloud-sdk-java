 ...
 * 搜索、列出和排序包中包含的规则组
 */
class ListRuleGroupsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/firewall$$waf$$packages/{package_identifier}/groups";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ListRuleGroupsResponse.class;
    }
}
