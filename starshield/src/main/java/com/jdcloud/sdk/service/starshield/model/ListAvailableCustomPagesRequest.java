 ...
 * 域可以使用的可用自定义页面列表
 */
public class ListAvailableCustomPagesRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param zone_identifier
     */
    public ListAvailableCustomPagesRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
