 ...
 * 为该域启用加密TLS 1.3功能。
 */
public class GetZoneEnableTLS1_3SettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param zone_identifier
     */
    public GetZoneEnableTLS1_3SettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
