 ...
 * 在所有启用星盾的子域上启用 IPv6。
 */
public class GetIPv6SettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param zone_identifier
     */
    public GetIPv6SettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
