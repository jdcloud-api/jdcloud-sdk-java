...
import com.jdcloud.sdk.service.starshield.model.Value_0_0;
 ...
 * 为你的网站自动最小化某些资产
 */
public class ChangeMinifySettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param value
     */
    public ChangeMinifySettingRequest value(Value_0_0 value) {
        this.value = value;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public ChangeMinifySettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
