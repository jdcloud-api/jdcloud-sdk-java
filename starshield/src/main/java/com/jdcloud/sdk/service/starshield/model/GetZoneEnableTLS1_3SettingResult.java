 ...
 * 为该域启用加密TLS 1.3功能。
 */
public class GetZoneEnableTLS1_3SettingResult extends JdcloudResult implements java.io.Serializable {
     ...
     * @param data
     */
    public GetZoneEnableTLS1_3SettingResult data(ZoneSetting data) {
        this.data = data;
        return this;
    }
