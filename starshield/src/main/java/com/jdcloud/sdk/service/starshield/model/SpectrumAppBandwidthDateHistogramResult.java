 ...
 * Spectrum应用带宽统计.
 */
public class SpectrumAppBandwidthDateHistogramResult extends JdcloudResult implements java.io.Serializable {
...
如果是流量，数据点的单位是Byte
    ...
    */
     ...
     * @param sum
     */
    public SpectrumAppBandwidthDateHistogramResult sum(Double sum) {
        this.sum = sum;
        return this;
    }
     ...
     * @param max
     */
    public SpectrumAppBandwidthDateHistogramResult max(Double max) {
        this.max = max;
        return this;
    }
     ...
     * @param maxTimestamp
     */
    public SpectrumAppBandwidthDateHistogramResult maxTimestamp(Number maxTimestamp) {
        this.maxTimestamp = maxTimestamp;
        return this;
    }
...
如果是流量，数据点的单位是Byte
    ...
    * @param dataSeries
    */
    public SpectrumAppBandwidthDateHistogramResult dataSeries(List<Double> dataSeries) {
        this.dataSeries = dataSeries;
        return this;
    }
    ...
    * @param timeSeries
    */
    public SpectrumAppBandwidthDateHistogramResult timeSeries(List<Number> timeSeries) {
        this.timeSeries = timeSeries;
        return this;
    }
