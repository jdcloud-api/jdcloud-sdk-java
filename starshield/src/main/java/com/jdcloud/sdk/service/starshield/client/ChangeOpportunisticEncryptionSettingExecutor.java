 ...
 * 为当前域启用随机加密
 */
class ChangeOpportunisticEncryptionSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$opportunistic_encryption";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeOpportunisticEncryptionSettingResponse.class;
    }
}
