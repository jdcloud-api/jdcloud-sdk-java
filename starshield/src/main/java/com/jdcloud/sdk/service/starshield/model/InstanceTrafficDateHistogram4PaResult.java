 ...
 * 实例Spectrum应用流量统计.
 */
public class InstanceTrafficDateHistogram4PaResult extends JdcloudResult implements java.io.Serializable {
...
如果是流量，数据点的单位是Byte
    ...
    */
     ...
     * @param sum
     */
    public InstanceTrafficDateHistogram4PaResult sum(Double sum) {
        this.sum = sum;
        return this;
    }
     ...
     * @param max
     */
    public InstanceTrafficDateHistogram4PaResult max(Double max) {
        this.max = max;
        return this;
    }
     ...
     * @param maxTimestamp
     */
    public InstanceTrafficDateHistogram4PaResult maxTimestamp(Number maxTimestamp) {
        this.maxTimestamp = maxTimestamp;
        return this;
    }
...
如果是流量，数据点的单位是Byte
    ...
    * @param dataSeries
    */
    public InstanceTrafficDateHistogram4PaResult dataSeries(List<Double> dataSeries) {
        this.dataSeries = dataSeries;
        return this;
    }
    ...
    * @param timeSeries
    */
    public InstanceTrafficDateHistogram4PaResult timeSeries(List<Number> timeSeries) {
        this.timeSeries = timeSeries;
        return this;
    }
