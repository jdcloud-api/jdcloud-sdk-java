 ...
 */
class ChangeMobileRedirectSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$mobile_redirect";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeMobileRedirectSettingResponse.class;
    }
}
