 ...
 */
public class BandwidthTopKRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param zoneName
     */
    public BandwidthTopKRequest zoneName(String zoneName) {
        this.zoneName = zoneName;
        return this;
    }
     ...
     * @param since
     */
    public BandwidthTopKRequest since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param until
     */
    public BandwidthTopKRequest until(String until) {
        this.until = until;
        return this;
    }
     ...
     * @param topK
     */
    public BandwidthTopKRequest topK(Integer topK) {
        this.topK = topK;
        return this;
    }
    ...
    * @param filters
    */
    public BandwidthTopKRequest filters(List<AnalyticsReportingFilter> filters) {
        this.filters = filters;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public BandwidthTopKRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
