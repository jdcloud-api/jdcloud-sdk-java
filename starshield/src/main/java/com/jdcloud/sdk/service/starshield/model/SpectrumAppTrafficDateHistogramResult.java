 ...
 * Spectrum应用流量统计.
 */
public class SpectrumAppTrafficDateHistogramResult extends JdcloudResult implements java.io.Serializable {
...
如果是流量，数据点的单位是Byte
    ...
    */
     ...
     * @param sum
     */
    public SpectrumAppTrafficDateHistogramResult sum(Double sum) {
        this.sum = sum;
        return this;
    }
     ...
     * @param max
     */
    public SpectrumAppTrafficDateHistogramResult max(Double max) {
        this.max = max;
        return this;
    }
     ...
     * @param maxTimestamp
     */
    public SpectrumAppTrafficDateHistogramResult maxTimestamp(Number maxTimestamp) {
        this.maxTimestamp = maxTimestamp;
        return this;
    }
...
如果是流量，数据点的单位是Byte
    ...
    * @param dataSeries
    */
    public SpectrumAppTrafficDateHistogramResult dataSeries(List<Double> dataSeries) {
        this.dataSeries = dataSeries;
        return this;
    }
    ...
    * @param timeSeries
    */
    public SpectrumAppTrafficDateHistogramResult timeSeries(List<Number> timeSeries) {
        this.timeSeries = timeSeries;
        return this;
    }
