 ...
 * 获取域的通用SSL证书设置
 */
class UniversalSSLSettingsDetailsExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/ssl$$universal$$settings";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return UniversalSSLSettingsDetailsResponse.class;
    }
}
