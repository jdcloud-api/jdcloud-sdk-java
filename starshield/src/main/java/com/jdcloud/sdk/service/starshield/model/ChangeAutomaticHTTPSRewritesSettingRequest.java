 ...
 * 为该域启用自动HTTPS重写功能。
 */
public class ChangeAutomaticHTTPSRewritesSettingRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param value
     */
    public ChangeAutomaticHTTPSRewritesSettingRequest value(String value) {
        this.value = value;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public ChangeAutomaticHTTPSRewritesSettingRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
