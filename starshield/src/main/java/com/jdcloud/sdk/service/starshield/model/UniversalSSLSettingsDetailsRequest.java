 ...
 * 获取域的通用SSL证书设置
 */
public class UniversalSSLSettingsDetailsRequest extends JdcloudRequest implements java.io.Serializable {
     ...
     * @param zone_identifier
     */
    public UniversalSSLSettingsDetailsRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
