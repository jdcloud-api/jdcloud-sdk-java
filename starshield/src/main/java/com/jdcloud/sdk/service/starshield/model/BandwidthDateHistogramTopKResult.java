 ...
 */
public class BandwidthDateHistogramTopKResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public BandwidthDateHistogramTopKResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public BandwidthDateHistogramTopKResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public BandwidthDateHistogramTopKResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public BandwidthDateHistogramTopKResult util(String util) {
        this.util = util;
        return this;
    }
