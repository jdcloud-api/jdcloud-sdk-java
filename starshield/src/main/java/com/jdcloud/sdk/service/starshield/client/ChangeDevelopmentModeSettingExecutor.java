 ...
 */
class ChangeDevelopmentModeSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$development_mode";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeDevelopmentModeSettingResponse.class;
    }
}
