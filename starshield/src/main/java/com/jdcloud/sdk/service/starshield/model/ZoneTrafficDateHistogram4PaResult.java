 ...
 * 域名Spectrum应用流量统计.
 */
public class ZoneTrafficDateHistogram4PaResult extends JdcloudResult implements java.io.Serializable {
...
如果是流量，数据点的单位是Byte
    ...
    */
     ...
     * @param sum
     */
    public ZoneTrafficDateHistogram4PaResult sum(Double sum) {
        this.sum = sum;
        return this;
    }
     ...
     * @param max
     */
    public ZoneTrafficDateHistogram4PaResult max(Double max) {
        this.max = max;
        return this;
    }
     ...
     * @param maxTimestamp
     */
    public ZoneTrafficDateHistogram4PaResult maxTimestamp(Number maxTimestamp) {
        this.maxTimestamp = maxTimestamp;
        return this;
    }
...
如果是流量，数据点的单位是Byte
    ...
    * @param dataSeries
    */
    public ZoneTrafficDateHistogram4PaResult dataSeries(List<Double> dataSeries) {
        this.dataSeries = dataSeries;
        return this;
    }
    ...
    * @param timeSeries
    */
    public ZoneTrafficDateHistogram4PaResult timeSeries(List<Number> timeSeries) {
        this.timeSeries = timeSeries;
        return this;
    }
