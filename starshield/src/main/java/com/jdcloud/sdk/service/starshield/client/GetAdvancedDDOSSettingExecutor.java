 ...
 */
class GetAdvancedDDOSSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$advanced_ddos";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return GetAdvancedDDOSSettingResponse.class;
    }
}
