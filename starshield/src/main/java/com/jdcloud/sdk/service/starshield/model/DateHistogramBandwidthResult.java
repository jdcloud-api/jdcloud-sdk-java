 ...
 * 按响应带宽统计，返回日期直方图.
 */
public class DateHistogramBandwidthResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public DateHistogramBandwidthResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public DateHistogramBandwidthResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public DateHistogramBandwidthResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public DateHistogramBandwidthResult util(String util) {
        this.util = util;
        return this;
    }
