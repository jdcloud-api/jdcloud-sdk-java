 ...
 */
public class ZoneBandwidthMultiDateHistogramResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public ZoneBandwidthMultiDateHistogramResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public ZoneBandwidthMultiDateHistogramResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public ZoneBandwidthMultiDateHistogramResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public ZoneBandwidthMultiDateHistogramResult util(String util) {
        this.util = util;
        return this;
    }
