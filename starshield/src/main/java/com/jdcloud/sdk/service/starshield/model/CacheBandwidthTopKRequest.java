 ...
 */
public class CacheBandwidthTopKRequest extends JdcloudRequest implements java.io.Serializable {
    ...
    */
     ...
     * @param zoneName
     */
    public CacheBandwidthTopKRequest zoneName(String zoneName) {
        this.zoneName = zoneName;
        return this;
    }
     ...
     * @param since
     */
    public CacheBandwidthTopKRequest since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param until
     */
    public CacheBandwidthTopKRequest until(String until) {
        this.until = until;
        return this;
    }
     ...
     * @param topK
     */
    public CacheBandwidthTopKRequest topK(Integer topK) {
        this.topK = topK;
        return this;
    }
    ...
    * @param filters
    */
    public CacheBandwidthTopKRequest filters(List<AnalyticsReportingFilter> filters) {
        this.filters = filters;
        return this;
    }
     ...
     * @param zone_identifier
     */
    public CacheBandwidthTopKRequest zone_identifier(String zone_identifier) {
        this.zone_identifier = zone_identifier;
        return this;
    }
