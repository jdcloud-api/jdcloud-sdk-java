 ...
 */
class ChangeTLSClientAuthSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$tls_client_auth";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeTLSClientAuthSettingResponse.class;
    }
}
