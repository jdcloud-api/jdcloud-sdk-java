 ...
 */
class ChangeCacheLevelSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$cache_level";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeCacheLevelSettingResponse.class;
    }
}
