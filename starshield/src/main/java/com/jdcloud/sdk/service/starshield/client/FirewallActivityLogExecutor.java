 ...
 * 活动日志.
 */
class FirewallActivityLogExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/analytics$$firewallActivityLog";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return FirewallActivityLogResponse.class;
    }
}
