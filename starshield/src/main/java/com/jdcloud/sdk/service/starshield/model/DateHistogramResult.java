 ...
 * 按请求次数统计，返回日期直方图.
 */
public class DateHistogramResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public DateHistogramResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public DateHistogramResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public DateHistogramResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public DateHistogramResult util(String util) {
        this.util = util;
        return this;
    }
