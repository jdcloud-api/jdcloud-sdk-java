 ...
 */
class CacheBandwidthTopKExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/analytics$$cacheBandwidthTopK";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return CacheBandwidthTopKResponse.class;
    }
}
