 ...
 */
public class InstanceTrafficMultiDateHistogramResult extends JdcloudResult implements java.io.Serializable {
    ...
    * @param dateHistograms
    */
    public InstanceTrafficMultiDateHistogramResult dateHistograms(List<DateHistogram> dateHistograms) {
        this.dateHistograms = dateHistograms;
        return this;
    }
    ...
    * @param timeScope
    */
    public InstanceTrafficMultiDateHistogramResult timeScope(List<Number> timeScope) {
        this.timeScope = timeScope;
        return this;
    }
     ...
     * @param since
     */
    public InstanceTrafficMultiDateHistogramResult since(String since) {
        this.since = since;
        return this;
    }
     ...
     * @param util
     */
    public InstanceTrafficMultiDateHistogramResult util(String util) {
        this.util = util;
        return this;
    }
