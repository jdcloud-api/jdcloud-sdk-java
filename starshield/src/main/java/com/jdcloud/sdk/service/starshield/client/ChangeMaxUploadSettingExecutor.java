 ...
 * 变更上传文件的最大值
 */
class ChangeMaxUploadSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$max_upload";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeMaxUploadSettingResponse.class;
    }
}
