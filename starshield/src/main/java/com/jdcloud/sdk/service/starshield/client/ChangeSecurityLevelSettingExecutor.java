 ...
 */
class ChangeSecurityLevelSettingExecutor extends JdcloudExecutor {
    ...
    @Override
    public String url() {
        return "/zones/{zone_identifier}/settings$$security_level";
    }

    @Override
    public Class<? extends JdcloudResponse> returnType() {
        return ChangeSecurityLevelSettingResponse.class;
    }
}
