...
import com.jdcloud.sdk.service.function.model.InvokeRequest;
import com.jdcloud.sdk.service.function.model.InvokeResponse;
import com.jdcloud.sdk.service.function.client.InvokeExecutor;
...
import com.jdcloud.sdk.service.function.model.AsyncInvokeRequest;
import com.jdcloud.sdk.service.function.model.AsyncInvokeResponse;
import com.jdcloud.sdk.service.function.client.AsyncInvokeExecutor;
...
public class FunctionClient extends JdcloudClient {
     ...
     * @throws JdcloudSdkException
     */
    public InvokeResponse invoke(InvokeRequest request) throws JdcloudSdkException {
        return new InvokeExecutor().client(this).execute(request);
    }
     ...
     * @throws JdcloudSdkException
     */
    public AsyncInvokeResponse asyncInvoke(AsyncInvokeRequest request) throws JdcloudSdkException {
        return new AsyncInvokeExecutor().client(this).execute(request);
    }
